...
"""category manager tag command."""

from googlecloudsdk.calliope import arg_parsers
from googlecloudsdk.calliope import base
from googlecloudsdk.command_lib.category_manager import tag_lib


@base.Hidden
@base.ReleaseTracks(base.ReleaseTrack.ALPHA)
class Tag(base.Command):
  """Tag a data asset with taxonomy annotations.

  For example:

    gcloud alpha category-manager tag path1,path2,path3 taxonomy::annotation
