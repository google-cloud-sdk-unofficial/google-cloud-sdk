...
class Create(base.CreateCommand):
  ...
  detailed_help = {
      ...
      'EXAMPLES':
          ...
          type A, routing-policy-data "us-centra1=1.2.3.4,2.3.4.5;us-west1=3.4.5.6,9.8.7.6"
          and ttl 60 in my_zone.

          $ {command} foo.bar.com. --routing-policy-data="us-centra1=1.2.3.4,2.3.4.5;us-west1=3.4.5.6,9.8.7.6"
           --routing-policy-type=GEO --type=A --ttl=60 --zone=my_zone --location=us-east1-a
