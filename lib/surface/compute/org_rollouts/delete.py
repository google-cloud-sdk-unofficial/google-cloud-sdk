...
"""Delete organization rollout command."""
...
class Delete(base.DeleteCommand):
  """Delete Google Compute Engine organization rollouts."""

  detailed_help = {
      'brief': 'Delete an organization rollout.',
      'DESCRIPTION': 'Delete an organization rollout.',
      'EXAMPLES': (
          r"""
    To delete an organization rollout named 'my-org-rollout' in organization '123456789', run:
  ...
  def Args(parser):
    org_rollout_resource_spec = concepts.ResourceSpec(
        ...
        rollout=concepts.ResourceParameterAttributeConfig(
            name='name', help_text='Name of the organization rollout to delete.'
        ),
    )
    presentation_spec = presentation_specs.ResourcePresentationSpec(
        'name',
        org_rollout_resource_spec,
        'Name of the organization rollout to delete.',
        required=True,
    )
  ...
  def Run(self, args):
    ...
    request = messages.ComputeOrganizationRolloutsDeleteRequest(
