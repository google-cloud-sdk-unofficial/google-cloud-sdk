...
"""Describe organization rollout command."""
...
class Describe(base.DescribeCommand):
  """Describe a Google Compute Engine organization rollout."""

  detailed_help = {
      'brief': 'Describe an organization rollout.',
      'DESCRIPTION': 'Describe an organization rollout.',
      'EXAMPLES': (
          r"""
    To describe an organization rollout named 'my-org-rollout' in organization '123456789', run:
  ...
  def Args(parser):
    org_rollout_resource_spec = concepts.ResourceSpec(
        ...
        rollout=concepts.ResourceParameterAttributeConfig(
            name='name',
            help_text='Name of the organization rollout to describe.',
        ),
    )
    presentation_spec = presentation_specs.ResourcePresentationSpec(
        'name',
        org_rollout_resource_spec,
        'Name of the organization rollout to describe.',
        required=True,
    )
  ...
  def Run(self, args):
    ...
    request = messages.ComputeOrganizationRolloutsGetRequest(
