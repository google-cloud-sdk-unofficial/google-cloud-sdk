...
def _CommonArgs(
  ...
  instances_flags.AddIpv6NetworkTierArgs(
      ...
      support_standard_tier=(
          release_track in [base.ReleaseTrack.ALPHA, base.ReleaseTrack.BETA]
      ),
  )
...
def _RunCreate(
  ...
  Args:
      ...
      support_confidential_compute_type_cca: Indicate if confidential compute
        type 'CCA' is supported.
      support_confidential_compute_type_bmsai: Indicate if confidential compute
        type 'BMSAI' is supported.
  ...
  if support_expose_host_topology and args.IsKnownAndSpecified(
