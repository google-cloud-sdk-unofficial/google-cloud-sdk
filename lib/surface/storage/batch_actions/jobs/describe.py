...
"""Implementation of describe command for batch actions."""
...
from googlecloudsdk.command_lib.storage.batch_actions.jobs import resource_args
...
class Describe(base.DescribeCommand):
  """Describe a batch-actions job."""

  detailed_help = {
      "DESCRIPTION": """
      Describe the batch-actions job.
      """,
      "EXAMPLES": """
