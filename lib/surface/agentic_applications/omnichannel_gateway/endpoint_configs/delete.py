...
"""Command for omnichannel-gateway endpoint-configs delete."""
...
class Delete(base.DeleteCommand):
  """Delete an omnichannel endpoint configuration."""
  ...
  def Args(parser):
    ...
    parser.add_argument(
        'endpoint_config_id',
        help='ID of the endpoint configuration to delete.',
    )
    ...
    parser.add_argument(
        '--etag',
        help=(
            'Strict concurrency token matching the current etag of the config.'
        ),
    )
  ...
  def Run(self, args):
    """Run endpoint-configs delete command."""
    ...
    operation = client.Request(
        ...
        url,
        params=params,
        error_msg='Failed to delete endpoint config',
    )
    ...
    return agentic_utils.WaitForOperation(
        operation,
        client.session,
        'Waiting for omnichannel endpoint configuration to be deleted',
    )
