...
"""Command to create App Lifecycle Manager Flags from a manifest file."""
...
class Push(base.Command):
  """Create App Lifecycle Manager Flags from a JSON manifest file."""
  ...
  @staticmethod
  def Args(parser):
    """Register flags for gcloud app-lifecycle-manager flags push: --file, --unit-kind."""
    parser.add_argument(
        '--file',
  ...
  def Run(self, args):
    """Execute the gcloud app-lifecycle-manager flags push command."""
