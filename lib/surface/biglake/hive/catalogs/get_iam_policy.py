...
"""Command to get the IAM policy for a BigLake Hive catalog."""
...
class GetIamPolicy(base.ListCommand):
  ...
  detailed_help = {
      'DESCRIPTION': 'Gets the IAM policy for a BigLake Hive catalog.',
      'EXAMPLES': """\
  ...
  def Args(parser):
    flags.AddCatalogResourceArg(
        parser, 'to get the IAM policy for', catalog_type='Hive'
    )
