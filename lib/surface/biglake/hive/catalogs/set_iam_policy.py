...
"""Command to set the IAM policy for a BigLake Hive catalog."""
...
class SetIamPolicy(base.Command):
  """Set the IAM policy for a BigLake Hive catalog."""
  ...
  @staticmethod
  def Args(parser):
    flags.AddCatalogResourceArg(
        parser, 'to set the IAM policy for', catalog_type='Hive'
    )
