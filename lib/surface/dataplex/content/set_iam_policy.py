...
class SetIamPolicy(base.Command):
  """Sets IAM policy to a content."""

  detailed_help = {
      'EXAMPLES':
          """\
          To Set an IAM policy binding to a content, run:

            $ {command} projects/{project_id}/locations/{location}/lakes/{lake_id}/content/{content_id} policy.json
  ...
  @staticmethod
  def Args(parser):
    resource_args.AddContentResourceArg(parser, 'to set IAM policy to.')
