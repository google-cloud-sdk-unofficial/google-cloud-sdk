...
"""`gcloud dataplex entries modify` command."""
...
class Modify(base.UpdateCommand):
  """Modify a Dataplex Entry."""

  detailed_help = {
      'DESCRIPTION': 'Modify specified fields in a given Dataplex Entry.',
      'EXAMPLES': """\
          To modify fully qualified name (FQN) of an entry, run:

            $ {command} entry1 --project=test-project --location=us-central1 --entry-group entry-group1 --fully-qualified-name='custom:a.b.c'

          To modify description of an entry, run:
