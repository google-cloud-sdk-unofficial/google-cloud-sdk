...
"""`gcloud dataplex task set-iam-policy-binding` command."""
...
class SetIamPolicy(base.Command):
  """Set an IAM policy binding for a Dataplex Task."""

  detailed_help = {
      'EXAMPLES':
          """\
          To set an IAM policy of a task, run:

            $ {command} projects/test-project/locations/us-central1/lakes/test-lake/tasks/test-task policy.json
