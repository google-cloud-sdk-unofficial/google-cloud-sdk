...
class SetIamPolicy(base.Command):
  """Set an IAM policy binding for a Dataplex Environment."""

  detailed_help = {
      'EXAMPLES':
          """\
          To set an IAM policy of an environment, run:

            $ {command} projects/test-project/locations/us-central1/lakes/test-lake/environments/test-environment policy.json
