...
"""Delete submission rule command from a WildFire Analysis profile."""
...
DETAILED_HELP = {
    'DESCRIPTION': """
          Delete a WildFire submission rule from a WildFire Analysis Security Profile.
        """,
    'EXAMPLES': """
          To delete a submission rule from a WildFire Analysis Security Profile named
...
If ANY_FILE is specified, no other types can be specified.""".format(
  ...
  def Run(self, args):
    ...
    response = client.DeleteSubmissionRule(
