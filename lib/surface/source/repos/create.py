...
_ERROR_FORMAT = (u'ResponseError: status=[{status_description}], '
                 u'code=[{status_code}], message=[{message}]. '
                 u'{details.message?\ndetails:\n{?}}')
_LINK_FORMAT = (u'\nenable at: '
                u'https://console.cloud.google.com/apis/library/'
                u'sourcerepo.googleapis.com/?project={project}')
_BILLING_URL = u'https://cloud.google.com/source-repositories/docs/pricing'
