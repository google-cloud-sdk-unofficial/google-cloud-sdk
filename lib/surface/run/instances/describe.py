...
"""Command for obtaining details about instances."""
...
class Describe(base.DescribeCommand):
  ...
  def CommonArgs(parser):
    ...
    parser.display_info.AddFormat(instance_printer.INSTANCE_PRINTER_FORMAT)
    resource_printer.RegisterFormatter(
  ...
  def Run(self, args):
    """Show details about a instance execution."""
    ...
    if not instance:
      raise exceptions.ArgumentError(
          'Cannot find instance [{}].'.format(instance_ref.Name())
      )
    return instance
