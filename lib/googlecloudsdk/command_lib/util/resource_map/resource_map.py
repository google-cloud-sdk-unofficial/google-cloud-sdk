...
"""Default Resource map for universally common resource metadata."""
...
_RESOURCE_MAP_PATH = os.path.join(
    os.path.dirname(__file__), ('resource_map.yaml'))
_RESOURCE_SCHEMA_PATH = os.path.join(
    os.path.dirname(__file__), ('resource_map_schema.yaml'))


class ResourceMap(ResourceMapBase):
