...
class TagsClient(object):
  ...
  def ParseCreateTagArgsIntoRequest(self, args, request):
    ...
    arg_utils.SetFieldInMessage(
        request,
        'googleCloudDatacatalogV1beta1Tag.template',
        tag_template_ref.RelativeName())
    arg_utils.SetFieldInMessage(
        request,
        'googleCloudDatacatalogV1beta1Tag.fields',
  ...
  def _ProcessTagFromFile(self, tag_template_ref, tag_file):
    ...
    for field_id, field_value in six.iteritems(tag):
      ...
      additional_properties.append(
          self.messages.GoogleCloudDatacatalogV1beta1Tag.FieldsValue
          .AdditionalProperty(
              key=field_id,
    ...
    return self.messages.GoogleCloudDatacatalogV1beta1Tag.FieldsValue(
  ...
  def _MakeTagField(self, field_type, field_value):
    ...
    if field_type == 'double':
      ...
      value.enumValue = (
          self.messages.GoogleCloudDatacatalogV1beta1TagFieldEnumValue(
