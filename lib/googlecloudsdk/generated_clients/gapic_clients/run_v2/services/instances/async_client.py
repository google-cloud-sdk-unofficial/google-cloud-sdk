...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.services.instances import pagers
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import condition
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import container_status
...
class InstancesAsyncClient:
    ...
    build_path = staticmethod(InstancesClient.build_path)
    parse_build_path = staticmethod(InstancesClient.parse_build_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, InstancesTransport, Callable[..., InstancesTransport]]] = "grpc_asyncio",
    ...
    async def create_instance(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            instance (:class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Instance`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Instance` A Cloud Run Instance represents a single group of containers running in a
                   region.
    ...
    async def update_instance(self,
            request: Optional[Union[gcr_instance.UpdateInstanceRequest, dict]] = None,
            *,
            instance: Optional[gcr_instance.Instance] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_instance():
                ...
                request = run_v2.UpdateInstanceRequest(
                    instance=instance,
                )
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.UpdateInstanceRequest, dict]]):
                The request object. Request message for updating an
                Instance.
            instance (:class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Instance`):
                Required. The Instance to be updated.
                This corresponds to the ``instance`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcr_instance.UpdateInstanceRequest):
            request = gcr_instance.UpdateInstanceRequest(request)
        ...
        routing_param_regex = re.compile('^projects/[^/]+/locations/(?P<location>[^/]+)(?:/.*)?$')
        regex_match = routing_param_regex.match(request.instance.name)
        if regex_match and regex_match.group("location"):
            header_params["location"] = regex_match.group("location")
    ...
    async def get_instance(self,
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Instance:
    ...
    async def list_instances(self,
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListInstancesRequest, dict]]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.instances.pagers.ListInstancesAsyncPager:
    ...
    async def stop_instance(self,
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.StopInstanceRequest, dict]]):
    ...
    async def start_instance(self,
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.StartInstanceRequest, dict]]):
    ...
    async def restart_instance(self,
            request: Optional[Union[instance.RestartInstanceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_restart_instance():
                ...
                # Initialize request argument(s)
                request = run_v2.RestartInstanceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.RestartInstanceRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, instance.RestartInstanceRequest):
            request = instance.RestartInstanceRequest(request)
    ...
    async def get_iam_policy(self,
        ...
        effect for the given Instance. This result does not
    ...
    async def set_iam_policy(self,
        ...
        Instance. Overwrites any existing policy.
