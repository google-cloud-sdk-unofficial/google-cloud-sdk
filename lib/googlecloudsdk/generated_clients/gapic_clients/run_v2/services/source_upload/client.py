...
from .transports.grpc import SourceUploadGrpcTransport
from .transports.grpc_asyncio import SourceUploadGrpcAsyncIOTransport
from .transports.rest import SourceUploadRestTransport


class SourceUploadClientMeta(type):
    """Metaclass for the SourceUpload client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SourceUploadTransport]]
    _transport_registry["grpc"] = SourceUploadGrpcTransport
    _transport_registry["grpc_asyncio"] = SourceUploadGrpcAsyncIOTransport
    _transport_registry["rest"] = SourceUploadRestTransport
...
class SourceUploadClient(metaclass=SourceUploadClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SourceUploadClient: The constructed client.
        """
    ...
    def transport(self) -> SourceUploadTransport:
        ...
        Returns:
            SourceUploadTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SourceUploadClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SourceUploadClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SourceUploadClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SourceUploadTransport, Callable[..., SourceUploadTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the source upload client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SourceUploadClient._read_environment_variables()
        self._client_cert_source = SourceUploadClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SourceUploadClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SourceUploadTransport)
        if transport_provided:
            # transport is a SourceUploadTransport instance.
            ...
            self._transport = cast(SourceUploadTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            SourceUploadClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SourceUploadTransport], Callable[..., SourceUploadTransport]] = (
                SourceUploadClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., SourceUploadTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.run_v2.SourceUploadClient`.",
                    extra = {
    ...
    def upload_source(self,
        ...
        .. code-block:: python
            ...
            def sample_upload_source():
                # Create a client
                client = run_v2.SourceUploadClient()
                ...
                # Make the request
                response = client.upload_source(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.UploadSourceRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.upload_source]
    ...
    def __enter__(self) -> "SourceUploadClient":
        return self
