...
from .base import SourceUploadTransport, DEFAULT_CLIENT_INFO
from .grpc import SourceUploadGrpcTransport
...
class SourceUploadGrpcAsyncIOTransport(SourceUploadTransport):
    """gRPC AsyncIO backend transport for SourceUpload.
    ...
    def upload_source(self) -> Callable[
        ...
        Returns:
            Callable[[~.UploadSourceRequest],
                    Awaitable[~.UploadSourceResponse]]:
        ...
        if 'upload_source' not in self._stubs:
            self._stubs['upload_source'] = self._logged_channel.unary_unary(
                '/google.cloud.run.v2.SourceUpload/UploadSource',
                request_serializer=source_upload.UploadSourceRequest.serialize,
                response_deserializer=source_upload.UploadSourceResponse.deserialize,
            )
        return self._stubs['upload_source']

    def _prep_wrapped_messages(self, client_info):
        """ Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.upload_source: self._wrap_method(
                self.upload_source,
...
__all__ = (
    'SourceUploadGrpcAsyncIOTransport',
)
