...
class SemanticGovernancePolicyEngine(proto.Message):
    ...
    Attributes:
        ...
        state (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.SemanticGovernancePolicyEngine.State):
            Output only. The state of the
            SemanticGovernancePolicyEngine.
        gateway_configs (MutableMapping[str, googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.GatewayConfig]):
...
class UpdateSemanticGovernancePolicyEngineOperationMetadata(proto.Message):
    r"""Details of
    [SemanticGovernancePolicyEngineService.UpdateSemanticGovernancePolicyEngine][google.cloud.aiplatform.v1beta1.SemanticGovernancePolicyEngineService.UpdateSemanticGovernancePolicyEngine]
    operation.
...
class GatewayConfig(proto.Message):
    ...
    Attributes:
        ...
        dns_zone_name (str):
            ...
            the DNS record.
        state (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.GatewayConfig.State):
