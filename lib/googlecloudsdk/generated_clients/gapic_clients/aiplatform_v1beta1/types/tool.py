...
class Tool(proto.Message):
    ...
    Attributes:
        ...
        exa_ai_search (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tool.ExaAiSearch):
    ...
    class GoogleSearch(proto.Message):
        ...
        Attributes:
            ...
            search_types (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tool.GoogleSearch.SearchTypes):
        ...
        class SearchTypes(proto.Message):
            ...
            Attributes:
                web_search (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tool.GoogleSearch.WebSearch):
                    Optional. Setting this field enables web
                    search. Only text results are returned.
                image_search (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tool.GoogleSearch.ImageSearch):
    ...
    class CodeExecution(proto.Message):
        ...
        See also
        [ExecutableCode][google.cloud.aiplatform.v1beta1.ExecutableCode] and
...
class FunctionDeclaration(proto.Message):
    ...
    Attributes:
        ...
        behavior (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.FunctionDeclaration.Behavior):
...
class FunctionCall(proto.Message):
    ...
    [FunctionDeclaration.name][google.cloud.aiplatform.v1beta1.FunctionDeclaration.name]
    ...
    Attributes:
        ...
        args (google.protobuf.struct_pb2.Struct):
            ...
            format. See
            [FunctionDeclaration.parameters][google.cloud.aiplatform.v1beta1.FunctionDeclaration.parameters]
...
class FunctionResponse(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            [FunctionDeclaration.name][google.cloud.aiplatform.v1beta1.FunctionDeclaration.name]
            and
            [FunctionCall.name][google.cloud.aiplatform.v1beta1.FunctionCall.name].
        ...
        scheduling (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.FunctionResponse.Scheduling):
...
class CodeExecutionResult(proto.Message):
    ...
    [ExecutableCode][google.cloud.aiplatform.v1beta1.ExecutableCode].
