...
class PredictionServiceAsyncClient:
    ...
    async def get_response(self,
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.GetResponseRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_response(self,
        ...
        Args:
            request (Optional[Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.DeleteResponseRequest, dict]]):
                The request object. Request message for
