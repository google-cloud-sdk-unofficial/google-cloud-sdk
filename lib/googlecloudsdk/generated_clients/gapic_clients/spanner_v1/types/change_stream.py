...
class ChangeStreamRecord(proto.Message):
    ...
    Attributes:
        data_change_record (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord):
            Data change record describing a data change
            for a change stream partition.

            This field is a member of `oneof`_ ``record``.
        heartbeat_record (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.HeartbeatRecord):
            Heartbeat record describing a heartbeat for a
            change stream partition.

            This field is a member of `oneof`_ ``record``.
        partition_start_record (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.PartitionStartRecord):
            Partition start record describing a new
            change stream partition.

            This field is a member of `oneof`_ ``record``.
        partition_end_record (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.PartitionEndRecord):
            Partition end record describing a terminated
            change stream partition.

            This field is a member of `oneof`_ ``record``.
        partition_event_record (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.PartitionEventRecord):
    ...
    class DataChangeRecord(proto.Message):
        ...
        Attributes:
            ...
            column_metadata (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.ColumnMetadata]):
                ...
                listed below.
            mods (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.Mod]):
                Describes the changes that were made.
            mod_type (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.ModType):
                Describes the type of change.
            value_capture_type (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.ValueCaptureType):
        ...
        class Mod(proto.Message):
            ...
            Attributes:
                keys (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.ModValue]):
                    Returns the value of the primary key of the
                    modified row.
                old_values (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.ModValue]):
                ...
                new_values (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.DataChangeRecord.ModValue]):
    ...
    class PartitionEventRecord(proto.Message):
        ...
        Attributes:
            ...
            move_in_events (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.PartitionEventRecord.MoveInEvent]):
            ...
            move_out_events (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.ChangeStreamRecord.PartitionEventRecord.MoveOutEvent]):
