...
class GoogleMaps(proto.Message):
    ...
    Attributes:
        enable_widget (bool):
            ...
            response.
        grounding_types (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GoogleMaps.GroundingTypes):
    ...
    class GroundingTypes(proto.Message):
        ...
        Attributes:
            places (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GoogleMaps.Places):
                Optional. Enables grounding with Google Maps Places. This is
                the default grounding type when no ``GroundingTypes`` are
                specified.
            routing (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GoogleMaps.Routing):
