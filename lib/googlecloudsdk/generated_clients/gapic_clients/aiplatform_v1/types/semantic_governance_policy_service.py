...
class SemanticGovernancePolicy(proto.Message):
    ...
    Attributes:
        ...
        mcp_tools (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SemanticGovernancePolicy.McpTool]):
...
class ListSemanticGovernancePoliciesResponse(proto.Message):
    ...
    Attributes:
        semantic_governance_policies (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SemanticGovernancePolicy]):
            The list of SemanticGovernancePolicies.
        next_page_token (str):
            A token to retrieve the next page of results. Pass to
            [ListSemanticGovernancePoliciesRequest.page_token][google.cloud.aiplatform.v1.ListSemanticGovernancePoliciesRequest.page_token]
            to obtain that page.
    """
...
class CreateSemanticGovernancePolicyOperationMetadata(proto.Message):
    ...
    [SemanticGovernancePolicyService.CreateSemanticGovernancePolicy][google.cloud.aiplatform.v1.SemanticGovernancePolicyService.CreateSemanticGovernancePolicy].
...
class UpdateSemanticGovernancePolicyOperationMetadata(proto.Message):
    r"""Runtime operation metadata for
    [SemanticGovernancePolicyService.UpdateSemanticGovernancePolicy][google.cloud.aiplatform.v1.SemanticGovernancePolicyService.UpdateSemanticGovernancePolicy].
...
class DeleteSemanticGovernancePolicyOperationMetadata(proto.Message):
    r"""Runtime operation metadata for
    [SemanticGovernancePolicyService.DeleteSemanticGovernancePolicy][google.cloud.aiplatform.v1.SemanticGovernancePolicyService.DeleteSemanticGovernancePolicy].
