...
class SemanticGovernancePolicyEngineServiceClient(metaclass=SemanticGovernancePolicyEngineServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1.SemanticGovernancePolicyEngineServiceClient`.",
                    extra = {
    ...
    def get_semantic_governance_policy_engine(self,
        ...
        .. code-block:: python
            ...
            def sample_get_semantic_governance_policy_engine():
                # Create a client
                client = aiplatform_v1.SemanticGovernancePolicyEngineServiceClient()
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GetSemanticGovernancePolicyEngineRequest, dict]):
    ...
    def update_semantic_governance_policy_engine(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.UpdateSemanticGovernancePolicyEngineRequest, dict]):
                The request object. Request message for
    ...
    def deprovision_semantic_governance_policy_engine(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.DeprovisionSemanticGovernancePolicyEngineRequest, dict]):
                The request object. Request message for
