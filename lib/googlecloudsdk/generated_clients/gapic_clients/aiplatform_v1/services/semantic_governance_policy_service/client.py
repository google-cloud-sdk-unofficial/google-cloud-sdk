...
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.services.semantic_governance_policy_service import pagers
...
from .transports.grpc import SemanticGovernancePolicyServiceGrpcTransport
from .transports.grpc_asyncio import SemanticGovernancePolicyServiceGrpcAsyncIOTransport
from .transports.rest import SemanticGovernancePolicyServiceRestTransport


class SemanticGovernancePolicyServiceClientMeta(type):
    """Metaclass for the SemanticGovernancePolicyService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[SemanticGovernancePolicyServiceTransport]:
...
class SemanticGovernancePolicyServiceClient(metaclass=SemanticGovernancePolicyServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SemanticGovernancePolicyServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SemanticGovernancePolicyServiceTransport:
        ...
        Returns:
            SemanticGovernancePolicyServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def semantic_governance_policy_path(project: str,location: str,semantic_governance_policy: str,) -> str:
        """Returns a fully-qualified semantic_governance_policy string."""
        return "projects/{project}/locations/{location}/semanticGovernancePolicies/{semantic_governance_policy}".format(project=project, location=location, semantic_governance_policy=semantic_governance_policy, )

    @staticmethod
    def parse_semantic_governance_policy_path(path: str) -> Dict[str,str]:
        """Parses a semantic_governance_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/semanticGovernancePolicies/(?P<semantic_governance_policy>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SemanticGovernancePolicyServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SemanticGovernancePolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SemanticGovernancePolicyServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SemanticGovernancePolicyServiceTransport, Callable[..., SemanticGovernancePolicyServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the semantic governance policy service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SemanticGovernancePolicyServiceClient._read_environment_variables()
        self._client_cert_source = SemanticGovernancePolicyServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SemanticGovernancePolicyServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SemanticGovernancePolicyServiceTransport)
        if transport_provided:
            # transport is a SemanticGovernancePolicyServiceTransport instance.
            ...
            self._transport = cast(SemanticGovernancePolicyServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            SemanticGovernancePolicyServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SemanticGovernancePolicyServiceTransport], Callable[..., SemanticGovernancePolicyServiceTransport]] = (
                SemanticGovernancePolicyServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., SemanticGovernancePolicyServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1.SemanticGovernancePolicyServiceClient`.",
                    extra = {
    ...
    def create_semantic_governance_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_create_semantic_governance_policy():
                # Create a client
                client = aiplatform_v1.SemanticGovernancePolicyServiceClient()

                # Initialize request argument(s)
                semantic_governance_policy = aiplatform_v1.SemanticGovernancePolicy()
                ...
                request = aiplatform_v1.CreateSemanticGovernancePolicyRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.CreateSemanticGovernancePolicyRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            semantic_governance_policy (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SemanticGovernancePolicy):
                Required. The
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SemanticGovernancePolicy` Represents a governance policy applied to a specific Agent and optionally
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_semantic_governance_policy]
    ...
    def get_semantic_governance_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_get_semantic_governance_policy():
                # Create a client
                client = aiplatform_v1.SemanticGovernancePolicyServiceClient()

                # Initialize request argument(s)
                request = aiplatform_v1.GetSemanticGovernancePolicyRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_semantic_governance_policy(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GetSemanticGovernancePolicyRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SemanticGovernancePolicy:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_semantic_governance_policy]
    ...
    def list_semantic_governance_policies(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListSemanticGovernancePoliciesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_semantic_governance_policies():
                # Create a client
                client = aiplatform_v1.SemanticGovernancePolicyServiceClient()

                # Initialize request argument(s)
                request = aiplatform_v1.ListSemanticGovernancePoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ListSemanticGovernancePoliciesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.services.semantic_governance_policy_service.pagers.ListSemanticGovernancePoliciesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_semantic_governance_policies]
        ...
        response = pagers.ListSemanticGovernancePoliciesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_semantic_governance_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_update_semantic_governance_policy():
                # Create a client
                client = aiplatform_v1.SemanticGovernancePolicyServiceClient()
                ...
                request = aiplatform_v1.UpdateSemanticGovernancePolicyRequest(
                    semantic_governance_policy=semantic_governance_policy,
                )
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.UpdateSemanticGovernancePolicyRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_semantic_governance_policy]
    ...
    def delete_semantic_governance_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_semantic_governance_policy():
                # Create a client
                client = aiplatform_v1.SemanticGovernancePolicyServiceClient()

                # Initialize request argument(s)
                request = aiplatform_v1.DeleteSemanticGovernancePolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.DeleteSemanticGovernancePolicyRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_semantic_governance_policy]
    ...
    def __enter__(self) -> "SemanticGovernancePolicyServiceClient":
        return self
