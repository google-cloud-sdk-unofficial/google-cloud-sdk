...
class PredictionServiceClient(metaclass=PredictionServiceClientMeta):
    ...
    def get_response(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GetResponseRequest, dict]):
                The request object. Request message for
    ...
    def delete_response(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.DeleteResponseRequest, dict]):
                The request object. Request message for
