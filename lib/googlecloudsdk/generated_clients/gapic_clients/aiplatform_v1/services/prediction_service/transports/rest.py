    ...
    class _DeleteResponse(_BasePredictionServiceRestTransport._BaseDeleteResponse, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.PredictionServiceClient.DeleteResponse",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.PredictionServiceClient.delete_response",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "DeleteResponse",
                        "metadata": http_response["headers"],
    ...
    class _GetResponse(_BasePredictionServiceRestTransport._BaseGetResponse, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.PredictionServiceClient.GetResponse",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "GetResponse",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.PredictionServiceClient.get_response",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "GetResponse",
                        "metadata": http_response["headers"],
