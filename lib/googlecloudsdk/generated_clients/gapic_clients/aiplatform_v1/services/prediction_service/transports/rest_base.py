...
class _BasePredictionServiceRestTransport(PredictionServiceTransport):
    ...
    class _BaseInvoke:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{endpoint=projects/*/locations/*/endpoints/*}/invoke/**',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1/{endpoint=projects/*/locations/*/endpoints/*}/deployedModels/{deployed_model_id}/invoke/**',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1/{endpoint=projects/*/locations/*/endpoints/openapi}/embeddings',
                'body': 'http_body',
            },
        {
                'method': 'post',
                'uri': '/v1/{endpoint=projects/*/locations/*/endpoints/openapi}/completions',
                'body': 'http_body',
            },
        {
                'method': 'post',
        ...
        {
                'method': 'post',
                'uri': '/v1/{endpoint=projects/*/locations/*/endpoints/google}/science/inference',
                'body': 'http_body',
            },
        {
                'method': 'post',
                'uri': '/v1/{endpoint=projects/*/locations/*/publishers/*/models/*}/invoke/**',
                'body': '*',
            },
            ]
            return http_options
