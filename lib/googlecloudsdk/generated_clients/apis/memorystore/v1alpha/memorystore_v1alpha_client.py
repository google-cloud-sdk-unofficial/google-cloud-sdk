...
class MemorystoreV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsInstancesService(base_api.BaseApiService):
    ...
    FinishMigration.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:finishMigration',
        http_method='POST',
        method_id='memorystore.projects.locations.instances.finishMigration',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}:finishMigration',
    ...
    StartMigration.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:startMigration',
        http_method='POST',
        method_id='memorystore.projects.locations.instances.startMigration',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}:startMigration',
