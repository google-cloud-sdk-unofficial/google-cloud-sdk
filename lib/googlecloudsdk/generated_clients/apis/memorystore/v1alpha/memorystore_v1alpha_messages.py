...
class Instance(_messages.Message):
  ...
  stateInfo = _messages.MessageField('StateInfo', 40)
  transitEncryptionMode = _messages.EnumField('TransitEncryptionModeValueValuesEnum', 41)
  uid = _messages.StringField(42)
  updateTime = _messages.StringField(43)
