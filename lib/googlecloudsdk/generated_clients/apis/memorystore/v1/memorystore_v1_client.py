...
class MemorystoreV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsAclPoliciesRevisionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(MemorystoreV1.ProjectsLocationsAclPoliciesRevisionsService, self).__init__(client)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/aclPolicies/{aclPoliciesId}/revisions/{revisionsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/aclPolicies/{aclPoliciesId}/revisions',
        http_method='GET',
  ...
  class ProjectsLocationsAclPoliciesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(MemorystoreV1.ProjectsLocationsAclPoliciesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/aclPolicies',
        http_method='POST',
        method_id='memorystore.projects.locations.aclPolicies.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['aclPolicyId', 'requestId'],
        relative_path='v1/{+parent}/aclPolicies',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/aclPolicies/{aclPoliciesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsInstancesTokenAuthUsersAuthTokensService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(MemorystoreV1.ProjectsLocationsInstancesTokenAuthUsersAuthTokensService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/tokenAuthUsers/{tokenAuthUsersId}/authTokens/{authTokensId}',
        http_method='DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/tokenAuthUsers/{tokenAuthUsersId}/authTokens',
        http_method='GET',
  ...
  class ProjectsLocationsInstancesTokenAuthUsersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(MemorystoreV1.ProjectsLocationsInstancesTokenAuthUsersService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    AddAuthToken.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/tokenAuthUsers/{tokenAuthUsersId}:addAuthToken',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/tokenAuthUsers/{tokenAuthUsersId}',
        http_method='DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/tokenAuthUsers',
        http_method='GET',
  ...
  class ProjectsLocationsInstancesService(base_api.BaseApiService):
    ...
    AddTokenAuthUser.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:addTokenAuthUser',
        http_method='POST',
        method_id='memorystore.projects.locations.instances.addTokenAuthUser',
        ordered_params=['instance'],
        path_params=['instance'],
        query_params=[],
        relative_path='v1/{+instance}:addTokenAuthUser',
    ...
    FinishMigration.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:finishMigration',
        http_method='POST',
        method_id='memorystore.projects.locations.instances.finishMigration',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:finishMigration',
    ...
    StartMigration.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:startMigration',
        http_method='POST',
        method_id='memorystore.projects.locations.instances.startMigration',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:startMigration',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    GetSharedRegionalCertificateAuthority.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/sharedRegionalCertificateAuthority',
        http_method='GET',
