...
class UpgradeInfo(_messages.Message):
  ...
  class UpgradeStateValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      COMMIT_FUNCTION_UPGRADE_AS_GEN2_SUCCESSFUL: Deprecated: This state is no
        longer returned by the backend. Clients should not rely on polling for
        this specific state. A successful upgrade is now indicated by the
        long-running operation completing successfully with a Function
