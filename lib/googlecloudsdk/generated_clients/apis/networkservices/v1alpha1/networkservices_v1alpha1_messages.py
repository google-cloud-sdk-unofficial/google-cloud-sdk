...
class CdnEdgeExtension(_messages.Message):
  r"""`CdnEdgeExtension` is a resource that lets the extension service modify
  the headers of both requests to the cache and responses from the cache
  served by an [`EdgeCacheService`](https://cloud.google.com/media-
  cdn/docs/reference/rest/v1/projects.locations.edgeCacheServices).

  Messages:
    LabelsValue: Optional. Set of labels associated with the
      `CdnEdgeExtension` resource. The format must comply with [the
  ...
  Fields:
    ...
    name: Required. Identifier. Name of the `CdnEdgeExtension` resource in the
      following format: `projects/{project}/locations/{location}/cdnEdgeExtens
      ions/{cdn_edge_extension}`.
  ...
  @encoding.MapUnrecognizedFields('additionalProperties')
  class LabelsValue(_messages.Message):
    r"""Optional. Set of labels associated with the `CdnEdgeExtension`
    resource. The format must comply with [the requirements for
    labels](https://cloud.google.com/compute/docs/labeling-
    resources#requirements) for Google Cloud resources.
  ...
  target = _messages.MessageField('CdnEdgeExtensionTarget', 6)
  updateTime = _messages.StringField(7)


class CdnEdgeExtensionTarget(_messages.Message):
  r"""Specifies the set of targets to which `CdnEdgeExtension` should be
  applied to.

  Fields:
    resources: Required. A list of references to the resources that are
      targeted by `CdnEdgeExtension`. Types of resources supported:
      `EdgeCacheService`. The format must be the full resource name of
      [EdgeCacheService](https://cloud.google.com/media-
      cdn/docs/reference/rest/v1/projects.locations.edgeCacheServices) in the
      following format: `//networkservices.googleapis.com/projects/{project}/l
      ocations/{location}/edgeCacheServices/{edgeCacheService}`.
  """
...
class ExtensionChainExtension(_messages.Message):
  ...
  name = _messages.StringField(7)
  observabilityMode = _messages.BooleanField(8)
  requestBodySendMode = _messages.EnumField('RequestBodySendModeValueValuesEnum', 9)
  responseBodySendMode = _messages.EnumField('ResponseBodySendModeValueValuesEnum', 10)
  service = _messages.StringField(11)
...
class ListCdnEdgeExtensionsResponse(_messages.Message):
  r"""Message for response to listing `CdnEdgeExtension` resources.
  ...
  cdnEdgeExtensions = _messages.MessageField('CdnEdgeExtension', 1, repeated=True)
  nextPageToken = _messages.StringField(2)
  unreachable = _messages.StringField(3, repeated=True)
...
class NetworkservicesProjectsLocationsCdnEdgeExtensionsCreateRequest(_messages.Message):
  r"""A NetworkservicesProjectsLocationsCdnEdgeExtensionsCreateRequest object.

  Fields:
    cdnEdgeExtension: A CdnEdgeExtension resource to be passed as the request
      body.
    cdnEdgeExtensionId: Required. User-provided ID of the `CdnEdgeExtension`
      resource to be created.
    parent: Required. The parent resource of the `CdnEdgeExtension` resource.
      Must be in the format `projects/{project}/locations/{location}`.
    requestId: Optional. An optional request ID to identify requests. Specify
      a unique request ID so that if you must retry your request, the server
      can ignore the request if it has already been completed. The server
  ...
  cdnEdgeExtension = _messages.MessageField('CdnEdgeExtension', 1)
  cdnEdgeExtensionId = _messages.StringField(2)
  parent = _messages.StringField(3, required=True)
  requestId = _messages.StringField(4)


class NetworkservicesProjectsLocationsCdnEdgeExtensionsDeleteRequest(_messages.Message):
  r"""A NetworkservicesProjectsLocationsCdnEdgeExtensionsDeleteRequest object.

  Fields:
    name: Required. The name of the `CdnEdgeExtension` resource to delete.
      Must be in the format `projects/{project}/locations/{location}/cdnEdgeEx
      tensions/{cdn_edge_extension}`.
    requestId: Optional. An optional request ID to identify requests. Specify
      a unique request ID so that if you must retry your request, the server
      can ignore the request if it has already been completed. The server
      guarantees that for 60 minutes after the first request. For example,
...
class NetworkservicesProjectsLocationsCdnEdgeExtensionsGetRequest(_messages.Message):
  r"""A NetworkservicesProjectsLocationsCdnEdgeExtensionsGetRequest object.

  Fields:
    name: Required. A name of the `CdnEdgeExtension` resource to get. Must be
      in the format `projects/{project}/locations/{location}/cdnEdgeExtensions
      /{cdn_edge_extension}`.
  """
...
class NetworkservicesProjectsLocationsCdnEdgeExtensionsListRequest(_messages.Message):
  r"""A NetworkservicesProjectsLocationsCdnEdgeExtensionsListRequest object.
  ...
  Fields:
    ...
    pageToken: Optional. A token identifying a page of results that the server
      returns.
    parent: Required. The project and location from which the
      `CdnEdgeExtension` resources are listed. These values are specified in
...
class NetworkservicesProjectsLocationsCdnEdgeExtensionsPatchRequest(_messages.Message):
  r"""A NetworkservicesProjectsLocationsCdnEdgeExtensionsPatchRequest object.
...
class NetworkservicesProjectsLocationsMulticastConsumerAssociationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastConsumerAssociationId: Required. A unique name for the multicast
      consumer association. The name is restricted to lower-case letters,
      numbers, and hyphen, with the first character a lower-case letter, and
...
class NetworkservicesProjectsLocationsMulticastDomainActivationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastDomainActivationId: Required. A unique name for the multicast
      domain activation. The name is restricted to lower-case letters,
      numbers, and hyphen, with the first character a lower-case letter, and
      the last a letter or a number. The name must not exceed 48 characters.
...
class NetworkservicesProjectsLocationsMulticastDomainGroupsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastDomainGroupId: Required. A unique name for the multicast domain
      group. The name is restricted to lower-case letters, numbers, and
      hyphen, with the first character a lower-case letter, and the last a
...
class NetworkservicesProjectsLocationsMulticastDomainsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastDomainId: Required. A unique name for the multicast domain. The
      ...
      first character a lower-case letter, and the last a letter or a number.
      The name must not exceed 48 characters.
...
class NetworkservicesProjectsLocationsMulticastGroupConsumerActivationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastGroupConsumerActivationId: Required. A unique name for the
      multicast group consumer activation. The name is restricted to lower-
...
class NetworkservicesProjectsLocationsMulticastGroupDefinitionsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastGroupDefinitionId: Required. A unique name for the multicast
      group definition. The name is restricted to lower-case letters, numbers,
...
class NetworkservicesProjectsLocationsMulticastGroupProducerActivationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastGroupProducerActivationId: Required. A unique name for the
      multicast group producer activation. The name is restricted to lower-
      case letters, numbers, and hyphen, with the first character a lower-case
      letter, and the last a letter or a number. The name must not exceed 48
      characters.
...
class NetworkservicesProjectsLocationsMulticastGroupRangeActivationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastGroupRangeActivationId: Required. A unique name for the multicast
      group range activation. The name is restricted to lower-case letters,
      numbers, and hyphen, with the first character a lower-case letter, and
      the last a letter or a number. The name must not exceed 48 characters.
...
class NetworkservicesProjectsLocationsMulticastGroupRangesCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastGroupRangeId: Required. A unique name for the multicast group
      range. The name is restricted to lower-case letters, numbers, and
      hyphen, with the first character a lower-case letter, and the last a
      letter or a number. The name must not exceed 48 characters.
...
class NetworkservicesProjectsLocationsMulticastProducerAssociationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    multicastProducerAssociationId: Required. A unique name for the multicast
      producer association. The name is restricted to lower-case letters,
      numbers, and hyphen, with the first character a lower-case letter, and
      the last a letter or a number. The name must not exceed 48 characters.
...
class NetworkservicesProjectsLocationsRegionalMulticastConsumerAssociationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    regionalMulticastConsumerAssociationId: Required. A unique name for the
      ...
      lower-case letter, and the last a letter or a number. The name must not
...
class NetworkservicesProjectsLocationsRegionalMulticastDomainActivationsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    regionalMulticastDomainActivationId: Required. A unique name for the
      regional multicast domain activation. The name is restricted to lower-
      case letters, numbers, and hyphen, with the first character a lower-case
      letter, and the last a letter or a number. The name must not exceed 63
      characters.
    requestId: Optional. An optional request ID to identify requests. Specify
      a unique request ID so that if you must retry your request, the server
      will know to ignore the request if it has already been completed. The
