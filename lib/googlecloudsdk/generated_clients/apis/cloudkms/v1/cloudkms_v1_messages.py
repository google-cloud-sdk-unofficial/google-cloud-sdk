...
class Digest(_messages.Message):
  ...
  Fields:
    externalMu: A message digest produced with SHAKE-256, to be used with ML-
      DSA external-\u03bc algorithms only. See "message representative" note
      in section 6.2, algorithm 7 of the FIPS-204 standard:
  ...
  externalMu = _messages.BytesField(1)
  sha256 = _messages.BytesField(2)
  sha384 = _messages.BytesField(3)
  sha512 = _messages.BytesField(4)
