...
class ConfigV1alpha2(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_locations_warmPools = self.ProjectsLocationsWarmPoolsService(self)
  ...
  class ProjectsLocationsDeploymentGroupsRevisionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigV1alpha2.ProjectsLocationsDeploymentGroupsRevisionsService, self).__init__(client)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deploymentGroups/{deploymentGroupsId}/revisions/{revisionsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deploymentGroups/{deploymentGroupsId}/revisions',
        http_method='GET',
  ...
  class ProjectsLocationsDeploymentGroupsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigV1alpha2.ProjectsLocationsDeploymentGroupsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deploymentGroups',
        http_method='POST',
        method_id='config.projects.locations.deploymentGroups.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['deploymentGroupId', 'requestId'],
        relative_path='v1alpha2/{+parent}/deploymentGroups',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deploymentGroups/{deploymentGroupsId}',
        http_method='DELETE',
    ...
    Deprovision.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deploymentGroups/{deploymentGroupsId}:deprovision',
        http_method='POST',
        method_id='config.projects.locations.deploymentGroups.deprovision',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha2/{+name}:deprovision',
    ...
    Provision.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deploymentGroups/{deploymentGroupsId}:provision',
        http_method='POST',
        method_id='config.projects.locations.deploymentGroups.provision',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha2/{+name}:provision',
  ...
  class ProjectsLocationsWarmPoolsService(base_api.BaseApiService):
    """Service class for the projects_locations_warmPools resource."""

    _NAME = 'projects_locations_warmPools'

    def __init__(self, client):
      super(ConfigV1alpha2.ProjectsLocationsWarmPoolsService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new WarmPool.

      Args:
        request: (ConfigProjectsLocationsWarmPoolsCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/warmPools',
        http_method='POST',
        method_id='config.projects.locations.warmPools.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'warmPoolId'],
        relative_path='v1alpha2/{+parent}/warmPools',
        request_field='warmPool',
        request_type_name='ConfigProjectsLocationsWarmPoolsCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Delete(self, request, global_params=None):
      r"""Deletes a WarmPool.

      Args:
        request: (ConfigProjectsLocationsWarmPoolsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/warmPools/{warmPoolsId}',
        http_method='DELETE',
        method_id='config.projects.locations.warmPools.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v1alpha2/{+name}',
        request_field='',
        request_type_name='ConfigProjectsLocationsWarmPoolsDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets details about a WarmPool.

      Args:
        request: (ConfigProjectsLocationsWarmPoolsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (WarmPool) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/warmPools/{warmPoolsId}',
        http_method='GET',
        method_id='config.projects.locations.warmPools.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha2/{+name}',
        request_field='',
        request_type_name='ConfigProjectsLocationsWarmPoolsGetRequest',
        response_type_name='WarmPool',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists WarmPools in a given project and location.

      Args:
        request: (ConfigProjectsLocationsWarmPoolsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListWarmPoolsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/warmPools',
        http_method='GET',
        method_id='config.projects.locations.warmPools.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha2/{+parent}/warmPools',
        request_field='',
        request_type_name='ConfigProjectsLocationsWarmPoolsListRequest',
        response_type_name='ListWarmPoolsResponse',
        supports_download=False,
    )

    def Patch(self, request, global_params=None):
      r"""Updates a WarmPool.

      Args:
        request: (ConfigProjectsLocationsWarmPoolsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/warmPools/{warmPoolsId}',
        http_method='PATCH',
        method_id='config.projects.locations.warmPools.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v1alpha2/{+name}',
        request_field='warmPool',
        request_type_name='ConfigProjectsLocationsWarmPoolsPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
