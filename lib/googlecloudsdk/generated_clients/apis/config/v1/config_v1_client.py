...
class ConfigV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsWarmPoolsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigV1.ProjectsLocationsWarmPoolsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/warmPools',
        http_method='POST',
        method_id='config.projects.locations.warmPools.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'warmPoolId'],
        relative_path='v1/{+parent}/warmPools',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/warmPools/{warmPoolsId}',
        http_method='DELETE',
