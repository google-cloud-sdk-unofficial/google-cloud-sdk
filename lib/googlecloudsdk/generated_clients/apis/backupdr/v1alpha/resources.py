...
BASE_URL = 'https://backupdr.googleapis.com/v1alpha/'
...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_RESOURCEBACKUPCONFIGS = (
      'projects.locations.resourceBackupConfigs',
      'projects/{projectsId}/locations/{locationsId}/resourceBackupConfigs/'
      '{resourceBackupConfigsId}',
      {},
