"""Generated message classes for backupdr version v1alpha.
...
class AutoProtectionPolicy(_messages.Message):
  ...
  Fields:
    ...
    etag: Output only. The etag for the policy. If this is provided on update,
      it must match the server's etag, otherwise the request will be rejected
...
class BackupRule(_messages.Message):
  ...
  Fields:
    ...
    backupVault: Optional. Resource name of backup vault which will be used as
      storage location for backups generated by this rule. Format:
      projects/{project}/locations/{location}/backupVaults/{backup_vault}
    backupVaultServiceAccount: Output only. The service account used by the
      BackupVault to take backups.
...
class BackupdrProjectsLocationsAutoProtectionPoliciesDeleteRequest(_messages.Message):
  ...
  Fields:
    etag: The current etag of the AutoProtectionPolicy. If an etag is provided
      and does not match the current etag of the connection, the request will
...
class BackupdrProjectsLocationsBackupPlansListRequest(_messages.Message):
  ...
  Fields:
    ...
    parent: Required. The project and location for which to retrieve
      ...
      DR, locations map to Google Cloud regions, for e.g. **us-central1**. To
...
class BackupdrProjectsLocationsBackupVaultsDataSourcesBackupsListRequest(_messages.Message):
  ...
  Fields:
    ...
    parent: Required. The project and location for which to retrieve backup
      ...
      In Google Cloud Backup and DR, locations map to Google Cloud regions,
      for example **us-central1**. To retrieve data sources for all locations,
...
class BackupdrProjectsLocationsServiceConfigInitializeRequest(_messages.Message):
  ...
  Fields:
    ...
    name: Required. The resource name of the serviceConfig used to initialize
      the service. The location must be the location of the BackupVault.
...
class DiskBackupProperties(_messages.Message):
  ...
  physicalBlockSizeBytes = _messages.IntegerField(9)
...
class GoogleCloudBackupdrV1alphaOperationMetadata(_messages.Message):
...
class InitializeServiceRequest(_messages.Message):
  ...
  Fields:
    backupPlanLocation: Optional. The location where the BackupPlan will be
      ...
      BackupPlan will be created in the same location as specified in the
      `name` field.
