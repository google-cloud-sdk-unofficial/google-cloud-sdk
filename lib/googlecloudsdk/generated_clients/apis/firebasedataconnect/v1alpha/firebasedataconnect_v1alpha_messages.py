...
class PostgreSql(_messages.Message):
  ...
  schemaMigration = _messages.EnumField('SchemaMigrationValueValuesEnum', 5)
  schemaValidation = _messages.EnumField('SchemaValidationValueValuesEnum', 6)
  unlinked = _messages.BooleanField(7)
