...
class FirebasedataconnectV1beta(base_api.BaseApiClient):
  ...
  class ProjectsLocationsServicesService(base_api.BaseApiService):
    ...
    GenerateQuery.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/services/{servicesId}:generateQuery',
        http_method='POST',
        method_id='firebasedataconnect.projects.locations.services.generateQuery',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta/{+name}:generateQuery',
    ...
    GenerateSchema.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/services/{servicesId}:generateSchema',
        http_method='POST',
        method_id='firebasedataconnect.projects.locations.services.generateSchema',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta/{+name}:generateSchema',
