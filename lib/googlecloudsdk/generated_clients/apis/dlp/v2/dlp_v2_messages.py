...
class GooglePrivacyDlpV2CustomInfoType(_messages.Message):
  ...
  Enums:
    ExclusionTypeValueValuesEnum: If set to EXCLUSION_TYPE_EXCLUDE this
      ...
      for rules matching. Only supported for the `dictionary`, `regex`, and
  ...
  Fields:
    detectionRules: Set of detection rules to apply to all findings of this
      CustomInfoType. Rules are applied in the order that they are specified.
  ...
  class ExclusionTypeValueValuesEnum(_messages.Enum):
    ...
    finding to be returned. It still can be used for rules matching. Only
    supported for the `dictionary`, `regex`, and `stored_type`
    CustomInfoTypes.
...
class GooglePrivacyDlpV2InspectConfig(_messages.Message):
  ...
  Fields:
    ...
    ruleSet: Set of rules to apply to the findings for this InspectConfig.
      ...
      Not supported for the `metadata_key_value_expression` CustomInfoType.
  """
...
class GooglePrivacyDlpV2KeyValueMetadataLabel(_messages.Message):
...
class GooglePrivacyDlpV2MetadataKeyValueExpression(_messages.Message):
  ...
  Fields:
    ...
    valueRegex: The regular expression for the value. Value should be non-
      empty.
  """

  keyRegex = _messages.StringField(1)
  valueRegex = _messages.StringField(2)
