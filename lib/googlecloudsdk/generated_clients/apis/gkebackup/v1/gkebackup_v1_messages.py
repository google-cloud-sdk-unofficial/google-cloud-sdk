...
class BDRBackupRestoreJobLog(_messages.Message):
  ...
  dataSourceName = _messages.StringField(7)
  endTime = _messages.StringField(8)
  errorCode = _messages.IntegerField(9, variant=_messages.Variant.INT32)
  errorMessage = _messages.StringField(10)
  errorType = _messages.StringField(11)
  incrementalBackupSizeGib = _messages.FloatField(12)
  jobCategory = _messages.StringField(13)
  jobId = _messages.StringField(14)
  jobStatus = _messages.StringField(15)
  recoveryPointTime = _messages.StringField(16)
  resourceType = _messages.StringField(17)
  restoreResourceLocation = _messages.StringField(18)
  restoreResourceName = _messages.StringField(19)
  sourceResourceId = _messages.StringField(20)
...
class Backup(_messages.Message):
  ...
  namespaceCount = _messages.IntegerField(16, variant=_messages.Variant.INT32)
  permissiveMode = _messages.BooleanField(17)
  podCount = _messages.IntegerField(18, variant=_messages.Variant.INT32)
  regionalSnapshots = _messages.BooleanField(19)
  resourceCount = _messages.IntegerField(20, variant=_messages.Variant.INT32)
  retainDays = _messages.IntegerField(21, variant=_messages.Variant.INT32)
  retainExpireTime = _messages.StringField(22)
  satisfiesPzi = _messages.BooleanField(23)
  satisfiesPzs = _messages.BooleanField(24)
  selectedApplications = _messages.MessageField('NamespacedNames', 25)
  selectedNamespaceLabels = _messages.MessageField('ResourceLabels', 26)
  selectedNamespaces = _messages.MessageField('Namespaces', 27)
  sizeBytes = _messages.IntegerField(28)
  state = _messages.EnumField('StateValueValuesEnum', 29)
  stateReason = _messages.StringField(30)
  troubleshootingInfo = _messages.MessageField('TroubleshootingInfo', 31)
...
class BackupPlan(_messages.Message):
  ...
  Fields:
    ...
    protectedNamespaceCount: Output only. The number of user managed
      namespaces backed up in the last successful Backup created via this
      BackupPlan.
  ...
  protectedNamespaceCount = _messages.IntegerField(13, variant=_messages.Variant.INT32)
  protectedPodCount = _messages.IntegerField(14, variant=_messages.Variant.INT32)
  regionalSnapshots = _messages.BooleanField(15)
  retentionPolicy = _messages.MessageField('RetentionPolicy', 16)
  rpoRiskLevel = _messages.IntegerField(17, variant=_messages.Variant.INT32)
  rpoRiskReason = _messages.StringField(18)
