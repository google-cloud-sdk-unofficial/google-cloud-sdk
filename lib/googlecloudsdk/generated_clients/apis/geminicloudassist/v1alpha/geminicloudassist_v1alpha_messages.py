...
class Observation(_messages.Message):
  ...
  class ObservationTypeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      OBSERVATION_TYPE_REMEDIATION_PLAN: Indicates a remediation plan to fix
        the root cause(s).
      OBSERVATION_TYPE_INVESTIGATION_SUMMARY: Indicates a summary of the
        investigation.
      OBSERVATION_TYPE_HYPOTHESIS_NEXT_STEPS: Indicates the next steps to be
        taken by the user to help resolve the root cause(s).
    """
    ...
    OBSERVATION_TYPE_REMEDIATION_PLAN = 19
    OBSERVATION_TYPE_INVESTIGATION_SUMMARY = 20
    OBSERVATION_TYPE_HYPOTHESIS_NEXT_STEPS = 21
