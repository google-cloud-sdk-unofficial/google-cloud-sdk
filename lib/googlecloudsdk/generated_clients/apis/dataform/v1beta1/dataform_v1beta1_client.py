  ...
  class ProjectsLocationsRepositoriesService(base_api.BaseApiService):
    ...
    def DeleteLongRunning(self, request, global_params=None):
      ...
      Returns:
        (Operation) The response message.
      """
      config = self.GetMethodConfig('DeleteLongRunning')
      return self._RunMethod(
          config, request, global_params=global_params)

    DeleteLongRunning.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}:deleteLongRunning',
        http_method='POST',
        method_id='dataform.projects.locations.repositories.deleteLongRunning',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:deleteLongRunning',
        request_field='deleteRepositoryLongRunningRequest',
        request_type_name='DataformProjectsLocationsRepositoriesDeleteLongRunningRequest',
        response_type_name='Operation',
        supports_download=False,
    )
