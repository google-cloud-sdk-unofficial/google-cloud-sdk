...
class ComposerProjectsLocationsEnvironmentsDagsDagRunsListRequest(_messages.Message):
  ...
  Fields:
    ...
    runsCountPerDag: Optional. If set to value greater than 0, the cross-DAG
      ...
      `runs_count_per_dag` * The order of the returned DAG runs is unspecified
      * `filter` is supported
  """
...
class ComposerProjectsLocationsEnvironmentsDagsListRequest(_messages.Message):
  ...
  Fields:
    filter: An expression for filtering the results. For example: `tags:"tag1"
      AND tags:"tag2"`
...
class Dag(_messages.Message):
  ...
  Fields:
    ...
    docMd: Describes the DAG in Markdown format.
  ...
  docMd = _messages.StringField(6)
  durationSchedule = _messages.StringField(7)
  endDate = _messages.StringField(8)
  failStop = _messages.BooleanField(9)
  fileloc = _messages.StringField(10)
  lastRunEndTime = _messages.StringField(11)
  lastUpdated = _messages.StringField(12)
  maxActiveRuns = _messages.IntegerField(13, variant=_messages.Variant.INT32)
...
class DagRun(_messages.Message):
  ...
  Fields:
    ...
    name: The resource name of the DAG, in the form: "projects/{projectId}/loc
      ...
      agRunId}".
    note: The note content of the DAG run. Added in Airflow 2.10.0.
  ...
  class TypeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      ASSET_TRIGGERED: Triggered by an asset update.
    """
    TYPE_UNSPECIFIED = 0
    BACKFILL = 1
    SCHEDULED = 2
...
class Task(_messages.Message):
  ...
  Fields:
    ...
    docMd: Describes the task in Markdown format.
  ...
  docMd = _messages.StringField(4)
  downstreamTasks = _messages.StringField(5, repeated=True)
  emailOnFailure = _messages.BooleanField(6)
  emailOnRetry = _messages.BooleanField(7)
  emails = _messages.StringField(8, repeated=True)
  endDate = _messages.StringField(9)
  executionTimeout = _messages.StringField(10)
  id = _messages.StringField(11)
  isDynamicallyMapped = _messages.BooleanField(12)
  maxRetryDelay = _messages.StringField(13)
  name = _messages.StringField(14)
  owner = _messages.StringField(15)
  pool = _messages.StringField(16)
  poolSlots = _messages.IntegerField(17, variant=_messages.Variant.INT32)
  priorityWeight = _messages.IntegerField(18, variant=_messages.Variant.INT32)
  queue = _messages.StringField(19)
  retries = _messages.IntegerField(20, variant=_messages.Variant.INT32)
  retryDelay = _messages.StringField(21)
  retryExponentialBackoff = _messages.BooleanField(22)
  runAsUser = _messages.StringField(23)
...
class TaskInstance(_messages.Message):
  ...
  Fields:
    ...
    name: Required. The resource name of the task instance, in the form: "proj
      ...
      optional_map_index}".
    note: The note content of the task instance. Added in Airflow 2.10.0.
    ...
    runAfter: Timestamp when the parent DAG run was scheduled to start. Added
      in Airflow 3.
...
class TrafficRoutingConfig(_messages.Message):
  r"""Configuration for network traffic routing from the Cloud Composer
  environment to other services.

  Enums:
    CloudRunFunctionsRoutingValueValuesEnum: Optional. Controls how network
      traffic to Cloud Run functions is routed.
  ...
  class CloudRunFunctionsRoutingValueValuesEnum(_messages.Enum):
    r"""Optional. Controls how network traffic to Cloud Run functions is
    routed.

    Values:
      ROUTING_MODE_UNSPECIFIED: Unspecified routing mode. When provided in a
        create environment request, this value will be treated as `DIRECT`.
        When provided in an update environment request, this value will be
        ignored and the existing routing mode will be preserved.
      ...
      VIA_NETWORK_ATTACHMENT: Route traffic via connected network attachment.
        This mode requires that the environment has connectivity to the user's
        VPC network.
    """
    ROUTING_MODE_UNSPECIFIED = 0
    DIRECT = 1
    VIA_NETWORK_ATTACHMENT = 2

  cloudRunFunctionsRouting = _messages.EnumField('CloudRunFunctionsRoutingValueValuesEnum', 1)
