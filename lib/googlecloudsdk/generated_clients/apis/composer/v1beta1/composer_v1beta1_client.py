...
class ComposerV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsEnvironmentsDagsDagRunsTaskInstancesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComposerV1beta1.ProjectsLocationsEnvironmentsDagsDagRunsTaskInstancesService, self).__init__(client)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}/dagRuns/{dagRunsId}/taskInstances/{taskInstancesId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}/dagRuns/{dagRunsId}/taskInstances',
        http_method='GET',
        method_id='composer.projects.locations.environments.dags.dagRuns.taskInstances.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1beta1/{+parent}/taskInstances',
        request_field='',
  ...
  class ProjectsLocationsEnvironmentsDagsDagRunsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComposerV1beta1.ProjectsLocationsEnvironmentsDagsDagRunsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}/dagRuns/{dagRunsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}/dagRuns',
        http_method='GET',
        ...
        relative_path='v1beta1/{+parent}/dagRuns',
        request_field='',
  ...
  class ProjectsLocationsEnvironmentsDagsTasksService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComposerV1beta1.ProjectsLocationsEnvironmentsDagsTasksService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}/tasks',
        http_method='GET',
        method_id='composer.projects.locations.environments.dags.tasks.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1beta1/{+parent}/tasks',
        request_field='',
  ...
  class ProjectsLocationsEnvironmentsDagsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComposerV1beta1.ProjectsLocationsEnvironmentsDagsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Activate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}:activate',
        http_method='POST',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}',
        http_method='GET',
    ...
    GetSourceCode.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}:getSourceCode',
        http_method='GET',
        method_id='composer.projects.locations.environments.dags.getSourceCode',
        ordered_params=['dag'],
        path_params=['dag'],
        query_params=[],
        relative_path='v1beta1/{+dag}:getSourceCode',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags',
        http_method='GET',
        method_id='composer.projects.locations.environments.dags.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1beta1/{+parent}/dags',
        request_field='',
    ...
    Pause.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}:pause',
        http_method='POST',
    ...
    Trigger.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}/dags/{dagsId}:trigger',
        http_method='POST',
        method_id='composer.projects.locations.environments.dags.trigger',
        ordered_params=['dag'],
        path_params=['dag'],
        query_params=[],
        relative_path='v1beta1/{+dag}:trigger',
  ...
  class ProjectsLocationsEnvironmentsService(base_api.BaseApiService):
    ...
    Hibernate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}:hibernate',
        http_method='POST',
        method_id='composer.projects.locations.environments.hibernate',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:hibernate',
    ...
    ListImportErrors.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}:listImportErrors',
        http_method='GET',
        method_id='composer.projects.locations.environments.listImportErrors',
        ordered_params=['environment'],
        path_params=['environment'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1beta1/{+environment}:listImportErrors',
        request_field='',
    ...
    Resume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}:resume',
        http_method='POST',
