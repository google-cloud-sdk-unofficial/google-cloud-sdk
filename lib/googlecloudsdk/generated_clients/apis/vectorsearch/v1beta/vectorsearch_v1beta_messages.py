...
class GoogleCloudVectorsearchV1betaCollection(_messages.Message):
  ...
  encryptionSpec = _messages.MessageField('GoogleCloudVectorsearchV1betaEncryptionSpec', 5)
...
class GoogleCloudVectorsearchV1betaDedicatedInfrastructureAutoscalingSpec(_messages.Message):
  ...
  Fields:
    maxReplicaCount: Optional. The maximum number of replicas. Must be >=
      `min_replica_count` and <= `1000`. For the v1beta version, if not set or
      set to `0`, defaults to the greater of `min_replica_count` and `5`. For
      all other versions, if not set or set to `0`, defaults to the greater of
      `min_replica_count` and `2`.
    minReplicaCount: Optional. The minimum number of replicas. If not set or
      set to `0`, defaults to `2`. Must be >= `1` and <= `1000`.
  """
...
class GoogleCloudVectorsearchV1betaEncryptionSpec(_messages.Message):
...
class GoogleCloudVectorsearchV1betaExportDataObjectsRequest(_messages.Message):
  ...
  fieldFilter = _messages.MessageField('GoogleCloudVectorsearchV1betaExportDataObjectsRequestFieldFilter', 1)
  gcsDestination = _messages.MessageField('GoogleCloudVectorsearchV1betaExportDataObjectsRequestGcsExportDestination', 2)


class GoogleCloudVectorsearchV1betaExportDataObjectsRequestFieldFilter(_messages.Message):
  ...
  excludedFields = _messages.MessageField('GoogleCloudVectorsearchV1betaExportDataObjectsRequestFieldFilterFieldList', 1)
  includedFields = _messages.MessageField('GoogleCloudVectorsearchV1betaExportDataObjectsRequestFieldFilterFieldList', 2)


class GoogleCloudVectorsearchV1betaExportDataObjectsRequestFieldFilterFieldList(_messages.Message):
