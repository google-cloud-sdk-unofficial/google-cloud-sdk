...
class VectorsearchV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsCollectionsService(base_api.BaseApiService):
    ...
    ExportDataObjects.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/collections/{collectionsId}:exportDataObjects',
        http_method='POST',
        method_id='vectorsearch.projects.locations.collections.exportDataObjects',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:exportDataObjects',
        request_field='googleCloudVectorsearchV1ExportDataObjectsRequest',
