...
class AppengineV1beta(base_api.BaseApiClient):
  ...
  class ProjectsLocationsApplicationsServicesVersionsInstancesService(base_api.BaseApiService):
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (AppengineProjectsLocationsApplicationsServicesVersionsInstancesDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}',
        http_method='DELETE',
        method_id='appengine.projects.locations.applications.services.versions.instances.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta/{+name}',
        request_field='',
        request_type_name='AppengineProjectsLocationsApplicationsServicesVersionsInstancesDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )
