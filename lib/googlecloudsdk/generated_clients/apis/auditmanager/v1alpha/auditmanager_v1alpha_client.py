...
class AuditmanagerV1alpha(base_api.BaseApiClient):
  ...
  class FoldersLocationsAuditSchedulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AuditmanagerV1alpha.FoldersLocationsAuditSchedulesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/auditSchedules',
        http_method='POST',
        method_id='auditmanager.folders.locations.auditSchedules.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['auditScheduleId', 'validateOnly'],
        relative_path='v1alpha/{+parent}/auditSchedules',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/auditSchedules/{auditSchedulesId}',
        http_method='GET',
  ...
  class OrganizationsLocationsAuditSchedulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AuditmanagerV1alpha.OrganizationsLocationsAuditSchedulesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/auditSchedules',
        http_method='POST',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/auditSchedules/{auditSchedulesId}',
        http_method='GET',
  ...
  class ProjectsLocationsAuditSchedulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AuditmanagerV1alpha.ProjectsLocationsAuditSchedulesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/auditSchedules',
        http_method='POST',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/auditSchedules/{auditSchedulesId}',
        http_method='GET',
