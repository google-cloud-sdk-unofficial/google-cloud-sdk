...
class AuditmanagerV1(base_api.BaseApiClient):
  ...
  class OrganizationsLocationsAuditReportsService(base_api.BaseApiService):
    ...
    Generate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/auditReports:generate',
        http_method='POST',
  ...
  class OrganizationsLocationsOperationDetailsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AuditmanagerV1.OrganizationsLocationsOperationDetailsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class OrganizationsLocationsOperationIdsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AuditmanagerV1.OrganizationsLocationsOperationIdsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/operationIds/{operationIdsId}',
        http_method='GET',
