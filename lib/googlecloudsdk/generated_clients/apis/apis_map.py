...
class APIDef(object):
  ...
  def get_init_source(self):
    ...
    return src_fmt.format(
        self.apitools,
        self.gapic,
        self.default_version,
        self.enable_mtls,
        self.mtls_endpoint_override,
    )
...
class ApitoolsClientDef(object):
  ...
  def __init__(
      self, class_path, client_classpath, messages_modulepath, base_url
  ):
...
MAP = _ApiDefMap({
    ...
    'gkebackup': {
        'v1': (
            ...
            True,
            '',
            {'me-central1': 'https://gkebackup.me-central1.rep.googleapis.com/', 'me-central2': 'https://gkebackup.me-central2.rep.googleapis.com/', 'me-west1': 'https://gkebackup.me-west1.rep.googleapis.com/', 'europe-west6': 'https://gkebackup.europe-west6.rep.googleapis.com/'},
        ),
    },
    'gkehub': {
        'v1': (
