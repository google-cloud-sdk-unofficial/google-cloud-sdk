...
MAP = _ApiDefMap({
    ...
    'workstations': {
        'v1': (
            ...
            True,
            '',
            {'us-central1': 'https://rep-wkstn.us-central1.rep.googleapis.com/'},
        ),
        'v1beta': (
