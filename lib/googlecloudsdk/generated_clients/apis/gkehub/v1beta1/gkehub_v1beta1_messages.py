...
class KubernetesMetadata(_messages.Message):
  ...
  Fields:
    ...
    nodeProviderId: Output only. Node providerID as reported by the first node
      ...
      that support zero-node clusters (like GKE-on-Google Cloud), the
...
class Membership(_messages.Message):
  ...
  Messages:
    LabelsValue: Optional. Google Cloud labels for this membership. These
      labels are not leveraged by multi-cluster features, instead, we prefer
      cluster labels, which can be set on GKE cluster or other cluster types.
  ...
  Fields:
    ...
    infrastructureType: Optional. The infrastructure type this Membership is
      running on.
    labels: Optional. Google Cloud labels for this membership. These labels
      are not leveraged by multi-cluster features, instead, we prefer cluster
  ...
  @encoding.MapUnrecognizedFields('additionalProperties')
  class LabelsValue(_messages.Message):
    r"""Optional. Google Cloud labels for this membership. These labels are
