...
class ClusterStatus(_messages.Message):
  ...
  class StateValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      SKIPPED: The cluster is skipped for the Rollout.
    """
    STATE_UNSPECIFIED = 0
    PENDING = 1
    RUNNING = 2
...
class DefaultClusterConfig(_messages.Message):
  ...
  Fields:
    ...
    compliancePostureConfig: Optional. Deprecated: Compliance Posture is no
      ...
      the cluster. Note that on UpdateFleet, only full replacement of this
      field is allowed. Users are not allowed for partial updates through
      field mask.
  ...
  class StragglerMigrationStrategyValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      STRAGGLER_MIGRATION_STRATEGY_LAST_WAVE: Migrate stragglers to the last
        wave of the rollout.
      STRAGGLER_MIGRATION_STRATEGY_NEXT_WAVE: Migrate stragglers to the next
        wave of the rollout.
    """
    ...
    STRAGGLER_MIGRATION_STRATEGY_NEXT_WAVE = 3
