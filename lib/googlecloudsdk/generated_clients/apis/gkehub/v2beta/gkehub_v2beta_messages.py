...
class FeatureConfig(_messages.Message):
  ...
  Messages:
    LabelsValue: Google Cloud labels for this FeatureConfig.
  ...
  Fields:
    ...
    labels: Google Cloud labels for this FeatureConfig.
  ...
  class LabelsValue(_messages.Message):
    r"""Google Cloud labels for this FeatureConfig.
...
class MembershipFeature(_messages.Message):
  ...
  Messages:
    LabelsValue: Google Cloud labels for this MembershipFeature.
  ...
  @encoding.MapUnrecognizedFields('additionalProperties')
  class LabelsValue(_messages.Message):
    r"""Google Cloud labels for this MembershipFeature.
