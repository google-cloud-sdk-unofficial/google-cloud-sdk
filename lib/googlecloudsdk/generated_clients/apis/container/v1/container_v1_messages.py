...
class AddonsConfig(_messages.Message):
  ...
  kueueConfig = _messages.MessageField('KueueConfig', 13)
  ...
  nodeReadinessConfig = _messages.MessageField('NodeReadinessConfig', 16)
  ...
  wizSensorConfig = _messages.MessageField('WizSensorConfig', 24)
...
class Cluster(_messages.Message):
  ...
  Fields:
    ...
    rollbackSafeUpgrade: Optional. The rollback safe upgrade information of
      the cluster. This field is used when user manually triggers a rollback
      safe upgrade.
  ...
  currentEmulatedVersion = _messages.StringField(17)
  ...
  gkeAutoUpgradeConfig = _messages.MessageField('GkeAutoUpgradeConfig', 32)
  ...
  jwtAuthenticatorConfig = _messages.MessageField('JWTAuthenticatorConfig', 39)
  labelFingerprint = _messages.StringField(40)
  legacyAbac = _messages.MessageField('LegacyAbac', 41)
  linkedRunnersConfig = _messages.MessageField('LinkedRunnersConfig', 42)
  ...
  managedMachineLearningDiagnosticsConfig = _messages.MessageField('ManagedMachineLearningDiagnosticsConfig', 49)
  managedOpentelemetryConfig = _messages.MessageField('ManagedOpenTelemetryConfig', 50)
  ...
  nodeCreationConfig = _messages.MessageField('NodeCreationConfig', 61)
  ...
  nodePoolUpgradeConcurrencyConfig = _messages.MessageField('NodePoolUpgradeConcurrencyConfig', 65)
  ...
  rollbackSafeUpgrade = _messages.MessageField('RollbackSafeUpgrade', 75)
  ...
  scheduleUpgradeConfig = _messages.MessageField('ScheduleUpgradeConfig', 79)
  secretManagerConfig = _messages.MessageField('SecretManagerConfig', 80)
  secretSyncConfig = _messages.MessageField('SecretSyncConfig', 81)
  ...
  targetNodeVersion = _messages.StringField(90)
...
class ClusterUpdate(_messages.Message):
  ...
  desiredEmulatedVersion = _messages.StringField(27)
  ...
  desiredJwtAuthenticatorConfig = _messages.MessageField('JWTAuthenticatorConfig', 42)
  ...
  desiredLinkedRunnersConfig = _messages.MessageField('LinkedRunnersConfig', 45)
  ...
  desiredManagedMachineLearningDiagnosticsConfig = _messages.MessageField('ManagedMachineLearningDiagnosticsConfig', 51)
  ...
  desiredNodeCreationConfig = _messages.MessageField('NodeCreationConfig', 60)
  ...
  desiredNodePoolUpgradeConcurrencyConfig = _messages.MessageField('NodePoolUpgradeConcurrencyConfig', 69)
  ...
  desiredTargetNodeVersion = _messages.StringField(89)
...
class ClusterUpgradeInfo(_messages.Message):
  ...
  Fields:
    ...
    rollbackSafeUpgradeStatus: Output only. The cluster's rollback-safe
      upgrade status.
...
class MonitoringComponentConfig(_messages.Message):
  ...
  class EnableComponentsValueListEntryValuesEnum(_messages.Enum):
    ...
    APISERVER_ALL = 16
    SCHEDULER_ALL = 17
    CONTROLLER_MANAGER_ALL = 18
    ETCD_ALL = 19
    KUBELET_RESOURCE_ALL = 20
    KUBELET_CADVISOR_ALL = 21
    ENVOY_ALL = 22
...
class NodeConfig(_messages.Message):
  ...
  lustreConfig = _messages.MessageField('LustreConfig', 27)
  ...
  taintConfig = _messages.MessageField('TaintConfig', 48)
  taints = _messages.MessageField('NodeTaint', 49, repeated=True)
  ubuntuKernelTrack = _messages.EnumField('UbuntuKernelTrackValueValuesEnum', 50)
  windowsNodeConfig = _messages.MessageField('WindowsNodeConfig', 51)
  workloadMetadataConfig = _messages.MessageField('WorkloadMetadataConfig', 52)
...
class NodePool(_messages.Message):
  ...
  Fields:
    ...
    etag: Output only. This checksum is computed by the server based on the
      value of node pool fields, and may be sent on update requests to ensure
...
class RecurringMaintenanceWindow(_messages.Message):
  r"""Represents an arbitrary window of time that recurs. Will replace
  RecurringTimeWindow.

  Fields:
    delayUntil: Optional. Specifies the date before which will not be
      scheduled. Depending on the recurrence, this may be the date the first
      window appears. Days are measured in the UTC timezone. This setting must
    ...
    recurrence: Required. An RRULE
      ...
      window recurs. For example, to have something repeat every weekday,
...
class ReleaseChannelConfig(_messages.Message):
  ...
  channel = _messages.EnumField('ChannelValueValuesEnum', 1)
  customVersions = _messages.StringField(2, repeated=True)
...
class RollbackSafeUpgradeStatus(_messages.Message):
  ...
  Enums:
    ModeValueValuesEnum: Output only. The mode of the rollback-safe upgrade.
  ...
  class ModeValueValuesEnum(_messages.Enum):
    r"""Output only. The mode of the rollback-safe upgrade.
...
class UpgradeDetails(_messages.Message):
  ...
  Fields:
    ...
    targetEmulatedVersion: Output only. The emulated version after the
      upgrade.
...
class UpgradeEvent(_messages.Message):
  ...
  Fields:
    currentEmulatedVersion: Output only. The current emulated version before
      the upgrade.
