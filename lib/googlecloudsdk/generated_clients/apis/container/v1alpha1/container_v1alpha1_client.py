...
class ContainerV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsAcceleratorNetworkProfilesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ContainerV1alpha1.ProjectsLocationsAcceleratorNetworkProfilesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/acceleratorNetworkProfiles',
        http_method='POST',
        method_id='container.projects.locations.acceleratorNetworkProfiles.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['acceleratorNetworkProfileId'],
        relative_path='v1alpha1/{+parent}/acceleratorNetworkProfiles',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/acceleratorNetworkProfiles/{acceleratorNetworkProfilesId}',
        http_method='DELETE',
