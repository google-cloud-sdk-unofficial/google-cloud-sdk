...
class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig(_messages.Message):
  ...
  audioOutputUriPrefix = _messages.StringField(1)
  audioTracks = _messages.IntegerField(2, repeated=True, variant=_messages.Variant.INT32)
  ...
  enableSpeakerDiarization = _messages.BooleanField(5)
  enableWordConfidence = _messages.BooleanField(6)
  filterProfanity = _messages.BooleanField(7)
  languageCode = _messages.StringField(8)
  maxAlternatives = _messages.IntegerField(9, variant=_messages.Variant.INT32)
  speechContexts = _messages.MessageField('GoogleCloudVideointelligenceV1SpeechContext', 10, repeated=True)
...
class GoogleCloudVideointelligenceV1WordInfo(_messages.Message):
  ...
  Fields:
    ...
    speakerLabel: Output only. A distinct string value is assigned for every
      ...
      speakers was detected to have spoken this word.
