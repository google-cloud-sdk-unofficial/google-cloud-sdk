...
class GoogleCloudPolicysimulatorV1alphaAccessActivityResource(_messages.Message):
  ...
  locations = _messages.MessageField('GoogleCloudPolicysimulatorV1alphaAccessActivityResourceLocation', 3, repeated=True)
  name = _messages.StringField(4)
  service = _messages.StringField(5)
  type = _messages.StringField(6)


class GoogleCloudPolicysimulatorV1alphaAccessActivityResourceLocation(_messages.Message):
