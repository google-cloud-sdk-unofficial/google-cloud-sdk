...
class GoogleCloudPolicysimulatorV1betaActivityBacktestAccessDecisionChangeSummary(_messages.Message):
  ...
  impactedLocationSummaries = _messages.MessageField('GoogleCloudPolicysimulatorV1betaActivityBacktestAccessDecisionChangeSummaryLocationSummary', 1, repeated=True)
...
class GoogleCloudPolicysimulatorV1betaActivityBacktestAccessDecisionChangeSummaryLocationSummary(_messages.Message):
...
class GoogleCloudPolicysimulatorV1betaPrincipalAccessBoundaryPolicyRule(_messages.Message):
  ...
  effect = _messages.EnumField('EffectValueValuesEnum', 2)
  excludedResources = _messages.StringField(3, repeated=True)
  operation = _messages.MessageField('GoogleCloudPolicysimulatorV1betaPrincipalAccessBoundaryPolicyRuleOperation', 4)
  resources = _messages.StringField(5, repeated=True)


class GoogleCloudPolicysimulatorV1betaPrincipalAccessBoundaryPolicyRuleOperation(_messages.Message):
