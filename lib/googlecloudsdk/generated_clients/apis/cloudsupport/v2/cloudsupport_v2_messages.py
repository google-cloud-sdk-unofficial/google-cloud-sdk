"""Generated message classes for cloudsupport version v2.
...
class Case(_messages.Message):
  ...
  subscriberEmailAddresses = _messages.StringField(12, repeated=True)
  testCase = _messages.BooleanField(13)
