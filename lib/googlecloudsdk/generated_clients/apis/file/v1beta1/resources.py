...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_VOLUMEPOOLS = (
      'projects.locations.volumePools',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/volumePools/'
              '{volumePoolsId}',
      },
      ['name'],
      True
  )
  PROJECTS_LOCATIONS_VOLUMEPOOLS_VOLUMES = (
      'projects.locations.volumePools.volumes',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/volumePools/'
              '{volumePoolsId}/volumes/{volumesId}',
      },
      ['name'],
      True
  )
