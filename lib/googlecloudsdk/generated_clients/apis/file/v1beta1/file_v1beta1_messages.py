...
class AcquireShareRequest(_messages.Message):
  r"""Request message for AcquireShare.
  ...
  capacityGb = _messages.IntegerField(1, variant=_messages.Variant.INT32)
  requestId = _messages.StringField(2)


class AcquireShareResponse(_messages.Message):
  r"""Output message for AcquireShare.
...
class FileProjectsLocationsSharePoolsAcquireShareRequest(_messages.Message):
  r"""A FileProjectsLocationsSharePoolsAcquireShareRequest object.

  Fields:
    acquireShareRequest: A AcquireShareRequest resource to be passed as the
      request body.
    parent: Required. The parent share pool path, in the format
      `projects/{project}/locations/{location}/sharePools/{share_pool}`.
  """

  acquireShareRequest = _messages.MessageField('AcquireShareRequest', 1)
  parent = _messages.StringField(2, required=True)


class FileProjectsLocationsSharePoolsReleaseShareRequest(_messages.Message):
  r"""A FileProjectsLocationsSharePoolsReleaseShareRequest object.

  Fields:
    parent: Required. The parent share pool path, in the format
      `projects/{project}/locations/{location}/sharePools/{share_pool}`.
    releaseShareRequest: A ReleaseShareRequest resource to be passed as the
      request body.
  """
...
class ReleaseShareRequest(_messages.Message):
  r"""Request message for ReleaseShare.
...
class ReleaseShareResponse(_messages.Message):
  r"""Response message for ReleaseShare."""
...
class VolumePool(_messages.Message):
  ...
  activeVolumeIops = _messages.IntegerField(1, variant=_messages.Variant.INT32)
  createTime = _messages.StringField(2)
  defaultVolumeQuotaMib = _messages.IntegerField(3, variant=_messages.Variant.INT32)
