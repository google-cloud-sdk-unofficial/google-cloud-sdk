...
class ArtifactscanguardV1alpha(base_api.BaseApiClient):
  ...
  class OrganizationsLocationsArtifactPoliciesEvaluationsService(base_api.BaseApiService):
    ...
    def List(self, request, global_params=None):
      r"""Lists ArtifactPoliciesEvaluation resources for a given parent. Supports pagination and filtering.

      Args:
        request: (ArtifactscanguardOrganizationsLocationsArtifactPoliciesEvaluationsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListArtifactPoliciesEvaluationsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/artifactPoliciesEvaluations',
        http_method='GET',
        method_id='artifactscanguard.organizations.locations.artifactPoliciesEvaluations.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/artifactPoliciesEvaluations',
        request_field='',
        request_type_name='ArtifactscanguardOrganizationsLocationsArtifactPoliciesEvaluationsListRequest',
        response_type_name='ListArtifactPoliciesEvaluationsResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsArtifactPoliciesEvaluationsService(base_api.BaseApiService):
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (ArtifactscanguardProjectsLocationsArtifactPoliciesEvaluationsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListArtifactPoliciesEvaluationsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/artifactPoliciesEvaluations',
        http_method='GET',
        method_id='artifactscanguard.projects.locations.artifactPoliciesEvaluations.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/artifactPoliciesEvaluations',
        request_field='',
        request_type_name='ArtifactscanguardProjectsLocationsArtifactPoliciesEvaluationsListRequest',
        response_type_name='ListArtifactPoliciesEvaluationsResponse',
        supports_download=False,
    )
