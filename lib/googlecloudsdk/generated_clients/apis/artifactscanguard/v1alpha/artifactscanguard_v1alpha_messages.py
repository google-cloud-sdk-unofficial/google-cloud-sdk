...
class ArtifactscanguardOrganizationsLocationsArtifactPoliciesEvaluationsListRequest(_messages.Message):
  r"""A ArtifactscanguardOrganizationsLocationsArtifactPoliciesEvaluationsList
  Request object.

  Fields:
    filter: Optional. A filter expression to restrict the artifact policies
      evaluations returned. The filter is a sequence of field-operator-value
      expressions, separated by "AND". Fields can be "name", "artifact_id".
      The operators are "=" (equals) and "!=" (not equals). Example:
      "artifact_id=my-artifact AND name=test-name"
    pageSize: Optional. The maximum number of artifact policies evaluations to
      return. The service may return fewer than this value. If unspecified, at
      most 100 artifact policies evaluations will be returned. The maximum
      value is 100; values above 100 will be coerced to 100.
    pageToken: Optional. A page token, received from a previous
      `ListArtifactPoliciesEvaluations` call. Provide this to retrieve the
      subsequent page. When paginating, all other parameters provided to
      `ListArtifactPoliciesEvaluations` must match the call that provided the
      page token.
    parent: Required. The parent resource whose artifact policies evaluations
      are to be listed. Format: -
...
class ArtifactscanguardOrganizationsLocationsPoliciesListRequest(_messages.Message):
  ...
  Fields:
    filter: Optional. A filter expression to restrict the policies returned.
      ...
      by "AND". Fields can be "name", "policy_id", "enforcement_action",
...
class ArtifactscanguardProjectsLocationsArtifactPoliciesEvaluationsListRequest(_messages.Message):
  r"""A
  ArtifactscanguardProjectsLocationsArtifactPoliciesEvaluationsListRequest
  object.
...
class ListArtifactPoliciesEvaluationsResponse(_messages.Message):
  r"""Response message for the ListArtifactPoliciesEvaluations RPC.

  Fields:
    artifactPoliciesEvaluations: The artifact policies evaluations found.
    nextPageToken: A token that can be sent as `page_token` to retrieve the
      next page. If this field is omitted, there are no subsequent pages.
    unreachable: Unordered list. Locations that could not be reached.
  """

  artifactPoliciesEvaluations = _messages.MessageField('ArtifactPoliciesEvaluation', 1, repeated=True)
