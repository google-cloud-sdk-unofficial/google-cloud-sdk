...
class BackupRun(_messages.Message):
  ...
  class BackendTypeValueValuesEnum(_messages.Enum):
    r"""The instance generation when this backup was made.

    The field is necessary for the frontend to determine, when showing the list
    of instances a backup can be restored to, whether first generation or second
    generation instances are shown. Determining this from the current generation
    of the backup's source instance does not work, since the instance might have
    changed generations. Introduced from here: cl/210832250
...
class BlueGreenDeployment(_messages.Message):
  ...
  pairedNodes = _messages.MessageField(
      'SourceTargetPairedNode', 7, repeated=True
  )
...
class BlueGreenDeploymentInfo(_messages.Message):
  r"""Blue-green deployment metadata for a database instance.
  ...
  target = _messages.MessageField('TargetRole', 3)
...
class ConnectSettings(_messages.Message):
  ...
  class BackendTypeValueValuesEnum(_messages.Enum):
    r"""`SECOND_GEN`: Cloud SQL database instance.
  ...
  class DatabaseVersionValueValuesEnum(_messages.Enum):
    ...
    The `databaseVersion` field cannot be changed after instance creation. MySQL
    instances: `MYSQL_8_0`, `MYSQL_5_7` (default), or `MYSQL_5_6`. PostgreSQL
    instances: `POSTGRES_9_6`, `POSTGRES_10`, `POSTGRES_11` or `POSTGRES_12`
    (default), `POSTGRES_13`, or `POSTGRES_14`. SQL Server instances:
  ...
  mdxProtocolSupport = _messages.EnumField(
      'MdxProtocolSupportValueListEntryValuesEnum', 9, repeated=True
  )
...
class DatabaseInstance(_messages.Message):
  ...
  databaseCenterIntegrationEnabled = _messages.BooleanField(6)
  databaseInstalledVersion = _messages.StringField(7)
  databaseVersion = _messages.EnumField('DatabaseVersionValueValuesEnum', 8)
  deploymentInfo = _messages.MessageField('BlueGreenDeploymentInfo', 9)
  diskEncryptionConfiguration = _messages.MessageField(
      'DiskEncryptionConfiguration', 10
  )
  diskEncryptionStatus = _messages.MessageField('DiskEncryptionStatus', 11)
  dnsName = _messages.StringField(12)
  dnsNames = _messages.MessageField('DnsNameMapping', 13, repeated=True)
  etag = _messages.StringField(14)
  failoverReplica = _messages.MessageField('FailoverReplicaValue', 15)
  gceZone = _messages.StringField(16)
  geminiConfig = _messages.MessageField('GeminiInstanceConfig', 17)
  includeReplicasForMajorVersionUpgrade = _messages.BooleanField(18)
  installedVersion = _messages.EnumField('InstalledVersionValueValuesEnum', 19)
  instanceType = _messages.EnumField('InstanceTypeValueValuesEnum', 20)
  ipAddresses = _messages.MessageField('IpMapping', 21, repeated=True)
  ipv6Address = _messages.StringField(22)
  kind = _messages.StringField(23)
  maintenanceVersion = _messages.StringField(24)
  majorVersionUpgradeIncludesReplicas = _messages.BooleanField(25)
  masterInstanceName = _messages.StringField(26)
  maxDiskSize = _messages.IntegerField(27)
  name = _messages.StringField(28)
  nodeCount = _messages.IntegerField(29, variant=_messages.Variant.INT32)
  nodes = _messages.MessageField('PoolNodeConfig', 30, repeated=True)
  onPremisesConfiguration = _messages.MessageField(
      'OnPremisesConfiguration', 31
  )
  outOfDiskReport = _messages.MessageField('SqlOutOfDiskReport', 32)
  ...
  semiManagedConfig = _messages.MessageField('SemiManagedConfig', 46)
  serverCaCert = _messages.MessageField('SslCert', 47)
  serviceAccountEmailAddress = _messages.StringField(48)
  settings = _messages.MessageField('Settings', 49)
  sourceInstanceNames = _messages.StringField(50, repeated=True)
  sqlNetworkArchitecture = _messages.EnumField(
      'SqlNetworkArchitectureValueValuesEnum', 51
  )
  state = _messages.EnumField('StateValueValuesEnum', 52)
  suspensionReason = _messages.EnumField(
      'SuspensionReasonValueListEntryValuesEnum', 53, repeated=True
  )
  switchTransactionLogsToCloudStorageEnabled = _messages.BooleanField(54)
  tags = _messages.MessageField('TagsValue', 55)
  upgradableDatabaseVersions = _messages.MessageField(
      'AvailableDatabaseVersion', 56, repeated=True
  )
  writeEndpoint = _messages.StringField(57)
...
class Settings(_messages.Message):
  ...
  class MsdtcRpcAuthModeValueValuesEnum(_messages.Enum):
    ...
    RPC authentication mode for Microsoft Distributed Transaction Coordinator
    (MSDTC).
  ...
  passwordValidationPolicy = _messages.MessageField(
      'PasswordValidationPolicy', 41
  )
  performanceCaptureConfig = _messages.MessageField(
      'PerformanceCaptureConfig', 42
  )
  pricingPlan = _messages.EnumField('PricingPlanValueValuesEnum', 43)
  readPoolAutoScaleConfig = _messages.MessageField(
      'ReadPoolAutoScaleConfig', 44
  )
  recreateReplicasOnPrimaryCrash = _messages.BooleanField(45)
  replicationLagMaxSeconds = _messages.IntegerField(
      46, variant=_messages.Variant.INT32
  )
  ...
  storageAutoResize = _messages.BooleanField(51)
  storageAutoResizeLimit = _messages.IntegerField(52)
  tier = _messages.StringField(53)
  timeZone = _messages.StringField(54)
  uncMappings = _messages.MessageField('UncMapping', 55, repeated=True)
  userLabels = _messages.MessageField('UserLabelsValue', 56)
...
class TestingAgentMetadata(_messages.Message):
  ...
  recommendationType = _messages.EnumField(
      'RecommendationTypeValueValuesEnum', 8
  )
...
class TestingAgentSession(_messages.Message):
  ...
  benchmarkingResults = _messages.MessageField(
      'TestingAgentBenchmarkingResult', 2, repeated=True
  )
  ...
  workflowSteps = _messages.MessageField(
      'TestingAgentWorkflowStep', 8, repeated=True
  )
...
class User(_messages.Message):
  ...
  class TypeValueValuesEnum(_messages.Enum):
    ...
    It determines the method to authenticate the user during login. The default
