...
class Artifact(_messages.Message):
  r"""An artifact is a piece of result data that is associated with a task.

  Fields:
    parts: Optional. Payload parts comprising the artifact.
  """
...
class Backup(_messages.Message):
  ...
  class DatabaseVersionValueValuesEnum(_messages.Enum):
    ...
    POSTGRES_19 = 43
    POSTGRES_20 = 44
    SQLSERVER_2019_STANDARD = 45
    SQLSERVER_2019_ENTERPRISE = 46
    SQLSERVER_2019_EXPRESS = 47
    SQLSERVER_2019_WEB = 48
    SQLSERVER_2022_STANDARD = 49
    SQLSERVER_2022_ENTERPRISE = 50
    SQLSERVER_2022_EXPRESS = 51
    SQLSERVER_2022_WEB = 52
    SQLSERVER_2025_STANDARD = 53
    SQLSERVER_2025_ENTERPRISE = 54
    SQLSERVER_2025_EXPRESS = 55
...
class BackupConfiguration(_messages.Message):
  ...
  Fields:
    ...
    replicationLogArchivingEnabled: Optional. Deprecated:
      replication_log_archiving_enabled is deprecated and will be removed from
...
class BackupRun(_messages.Message):
  ...
  Enums:
    BackendTypeValueValuesEnum: The instance generation when this backup was
      made. The field is necessary for the frontend to determine, when showing
      the list of instances a backup can be restored to, whether first
      generation or second generation instances are shown. Determining this
      from the current generation of the backup's source instance does not
      work, since the instance might have changed generations. Introduced from
      here: cl/210832250
  ...
  Fields:
    backendType: The instance generation when this backup was made. The field
      is necessary for the frontend to determine, when showing the list of
      instances a backup can be restored to, whether first generation or
      second generation instances are shown. Determining this from the current
      generation of the backup's source instance does not work, since the
      instance might have changed generations. Introduced from here:
      cl/210832250
  ...
  class BackendTypeValueValuesEnum(_messages.Enum):
    r"""The instance generation when this backup was made. The field is
    necessary for the frontend to determine, when showing the list of
    instances a backup can be restored to, whether first generation or second
    generation instances are shown. Determining this from the current
    generation of the backup's source instance does not work, since the
    instance might have changed generations. Introduced from here:
    cl/210832250
    ...
    Values:
      ...
      SEMI_MANAGED: Semi-managed instance.
    """
  ...
  backupDatabaseInstalledVersion = _messages.StringField(2)
  backupKind = _messages.EnumField('BackupKindValueValuesEnum', 3)
  databaseVersion = _messages.EnumField('DatabaseVersionValueValuesEnum', 4)
  description = _messages.StringField(5)
  ...
  enqueuedTime = _messages.StringField(9)
  error = _messages.MessageField('OperationError', 10)
  ...
  timeZone = _messages.StringField(19)
  type = _messages.EnumField('TypeValueValuesEnum', 20)
  windowStartTime = _messages.StringField(21)
...
class BenchmarkingResult(_messages.Message):
  r"""The result of a benchmark run.

  Fields:
    averageLatency: Output only. The average latency recorded for the
      benchmark.
    queriesPerSecond: Output only. The number of queries per second.
    throughputEventsPerSecond: Output only. The number of events per second
      (throughput).
    transactionsPerSecond: Output only. The number of transactions per second.
  """

  averageLatency = _messages.StringField(1)
  queriesPerSecond = _messages.FloatField(2)
  throughputEventsPerSecond = _messages.FloatField(3)
  transactionsPerSecond = _messages.FloatField(4)
...
class BlueGreenDeployment(_messages.Message):
  ...
  Fields:
    ...
    requestedConfig: Optional. Immutable. Optional on create, and immutable.
      The configuration intended for the target instance(s) when the
      deployment was created.
    sourceInstance: Required. Immutable. The instance ID of the source
      instance (the "blue" instance). The value for this field does not
      include the project ID, for example, `my-instance-id`. This field is
      immutable.
    ...
    targetConfig: Optional. Immutable. Deprecated: Use requested_config
      instead. The configuration intended for the target instance(s) when the
      deployment was created. This field is immutable.
  """
  ...
  deploymentTasks = _messages.MessageField('DeploymentTasks', 3)
  description = _messages.StringField(4)
  errorDetail = _messages.StringField(5)
  name = _messages.StringField(6)
  pairedNodes = _messages.MessageField('SourceTargetPairedNode', 7, repeated=True)
  requestedConfig = _messages.MessageField('RequestedConfig', 8)
  sourceInstance = _messages.StringField(9)
  state = _messages.EnumField('StateValueValuesEnum', 10)
  switchoverTargetInstance = _messages.StringField(11)
  targetConfig = _messages.MessageField('TargetConfig', 12)


class BlueGreenDeploymentInfo(_messages.Message):
  r"""Blue-green deployment metadata for a database instance. In a blue-green
  ...
  Enums:
    StateValueValuesEnum: Output only. The current state of blue-green-
      deployment for UI tags
  ...
  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. The current state of blue-green-deployment for UI tags
  ...
  source = _messages.MessageField('SourceRole', 2)
...
class CancelSessionResponse(_messages.Message):
  r"""The response message for cancelling an agent session.

  Enums:
    StateValueValuesEnum: Output only. The current state of the session.

  Fields:
    state: Output only. The current state of the session.
  """

  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. The current state of the session.

    Values:
      STATE_UNSPECIFIED: The state is unspecified.
      CANCELLED: The session is cancelled.
      FAILED: Failed to cancel the session.
    """
    STATE_UNSPECIFIED = 0
    CANCELLED = 1
    FAILED = 2
...
class ConnectSettings(_messages.Message):
  ...
  Fields:
    ...
    connectionName: Optional. Output only. Connection name of the Cloud SQL
      instance used in connection strings, in the format
  ...
  dnsNames = _messages.MessageField('DnsNameMapping', 6, repeated=True)
  ipAddresses = _messages.MessageField('IpMapping', 7, repeated=True)
  kind = _messages.StringField(8)
  mdxProtocolSupport = _messages.EnumField('MdxProtocolSupportValueListEntryValuesEnum', 9, repeated=True)
  nodeCount = _messages.IntegerField(10, variant=_messages.Variant.INT32)
  nodes = _messages.MessageField('ConnectPoolNodeConfig', 11, repeated=True)
  pscEnabled = _messages.BooleanField(12)
  region = _messages.StringField(13)
  serverCaCert = _messages.MessageField('SslCert', 14)
  serverCaMode = _messages.EnumField('ServerCaModeValueValuesEnum', 15)
...
class DatabaseInstance(_messages.Message):
  ...
  Fields:
    analyzePostUpgradeEnabled: Optional. Input only. Determines whether a
      `VACUUM ANALYZE` command is run on PostgreSQL instances after a major
      version upgrade. The default value is `true`.
    ...
    selfLink: The URI of this resource.
    semiManagedConfig: Optional. Configuration specific to semi-managed
      instances. Semi-managed instances allow managing databases on customer-
      owned Compute Engine VMs.
    serverCaCert: SSL configuration.
  ...
  analyzePostUpgradeEnabled = _messages.BooleanField(1)
  availableMaintenanceVersions = _messages.StringField(2, repeated=True)
  backendType = _messages.EnumField('BackendTypeValueValuesEnum', 3)
...
class DeploymentTasks(_messages.Message):
  r"""Combined list of tasks for all paired nodes in the deployment.

  Fields:
    task: Output only. Tasks performed or being performed on the paired nodes
      of the deployment at a consolidated level.
  """

  task = _messages.MessageField('DeploymentTask', 1, repeated=True)
...
class DiskEncryptionConfiguration(_messages.Message):
  ...
  cmekSourceLogEncryptionEnforced = _messages.BooleanField(1)
  confidentialMode = _messages.BooleanField(2)
  kind = _messages.StringField(3)
...
class ExecuteSqlPayload(_messages.Message):
  ...
  Fields:
    ...
    readOnly: Optional. Restricts the SQL execution to read-only statements.
      Any statements that modify data or schema (such as INSERT, UPDATE,
      DELETE, or DDL) will be rejected. If `false` or unset, the execution is
      not restricted and may include statements that modify data or schema.
  ...
  readOnly = _messages.BooleanField(9)
...
class HostMapping(_messages.Message):
  r"""A mapping of an IP address to a hostname.

  Fields:
    hostname: Required. The hostname. Must be compliant with [RFC
...
class OnPremisesConfiguration(_messages.Message):
  ...
  clientCertificate = _messages.StringField(2)
  clientKey = _messages.StringField(3)
  dmsManaged = _messages.BooleanField(4)
  dumpFilePath = _messages.StringField(5)
  hostPort = _messages.StringField(6)
  kind = _messages.StringField(7)
  password = _messages.StringField(8)
  selectedObjects = _messages.MessageField('SelectedObjects', 9, repeated=True)
  sourceInstance = _messages.MessageField('InstanceReference', 10)
  sslOption = _messages.EnumField('SslOptionValueValuesEnum', 11)
...
class Operation(_messages.Message):
  ...
  Fields:
    ...
    targetProject: The project ID of the target instance related to this
      operation.
    testingAgentResponseContext: Output only. Context for the Testing Agent
  ...
  class OperationTypeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      START_WORKLOAD_CAPTURE: Starts workload capture.
    ...
    SETUP_MIGRATION = 56
    AGENT_SEND_MESSAGE = 57
    START_WORKLOAD_CAPTURE = 58
  ...
  startWorkloadCaptureContext = _messages.MessageField('StartWorkloadCaptureContext', 16)
  startWorkloadReplayContext = _messages.MessageField('StartWorkloadReplayContext', 17)
  status = _messages.EnumField('StatusValueValuesEnum', 18)
  stopWorkloadCaptureContext = _messages.MessageField('StopWorkloadCaptureContext', 19)
  stopWorkloadReplayContext = _messages.MessageField('StopWorkloadReplayContext', 20)
  subOperationType = _messages.MessageField('SqlSubOperationType', 21)
  targetId = _messages.StringField(22)
  targetLink = _messages.StringField(23)
  targetProject = _messages.StringField(24)
  testingAgentResponseContext = _messages.MessageField('SendMessageResponseContext', 25)
...
class Part(_messages.Message):
  r"""A structured part of a message payload.
...
class PscAutoConnectionConfig(_messages.Message):
  ...
  Enums:
    InstanceAutoDnsStatusValueValuesEnum: Output only. The status of automated
      DNS provisioning.
    WriteEndpointAutoDnsStatusValueValuesEnum: Output only. The status of
      automated DNS provisioning for the write endpoint.
  ...
  class InstanceAutoDnsStatusValueValuesEnum(_messages.Enum):
    r"""Output only. The status of automated DNS provisioning.
  ...
  class WriteEndpointAutoDnsStatusValueValuesEnum(_messages.Enum):
    r"""Output only. The status of automated DNS provisioning for the write
    endpoint.
  ...
  instanceAutoDnsStatus = _messages.EnumField('InstanceAutoDnsStatusValueValuesEnum', 4)
  ipAddress = _messages.StringField(5)
  serviceConnectionPolicy = _messages.StringField(6)
  serviceConnectionPolicyCreationResult = _messages.StringField(7)
  status = _messages.StringField(8)
  writeEndpointAutoDnsStatus = _messages.EnumField('WriteEndpointAutoDnsStatusValueValuesEnum', 9)
...
class PscConfig(_messages.Message):
  ...
  Fields:
    ...
    pscAutoDnsEnabled: Optional. Indicates whether Private Service Connect DNS
      automation is enabled for this instance. When enabled, Cloud SQL
      provisions a universal DNS record across all networks configured with
      Private Service Connect auto-connections. This will default to true for
      new instances when Private Service Connect is enabled.
    pscEnabled: Whether PSC connectivity is enabled for this instance.
    pscWriteEndpointDnsEnabled: Optional. Indicates whether Private Service
      ...
      points to the cluster primary instance. This feature is only supported
      for Enterprise Plus edition. This will default to true for new
      enterprise plus instances when `psc_auto_dns_enabled` is enabled.
  """
...
class SendMessageConfig(_messages.Message):
  r"""Configuration for sending a message to an agent.

  Fields:
    expectFinalResponse: Optional. Whether a final response is expected from
      the agent. If false, the agent is invoked, but the operation completes
      without waiting for a result message from the agent.
  """

  expectFinalResponse = _messages.BooleanField(1)


class SendMessageRequest(_messages.Message):
  r"""Request message for sending a message to a Cloud SQL agent.

  Fields:
    config: Optional. Execution and notification configuration for the send
      request.
    prompt: Optional. The user prompt for the agent, containing all
      information necessary for the agent to fulfill the request.
    sessionId: Optional. Session ID to which the message is sent. If not
      provided, a new session is created.
    testingAgentMetadata: Optional. Metadata for the testing agent.
  """

  config = _messages.MessageField('SendMessageConfig', 1)
  prompt = _messages.StringField(2)
  sessionId = _messages.StringField(3)
  testingAgentMetadata = _messages.MessageField('TestingAgentMetadata', 4)


class SendMessageResponse(_messages.Message):
  r"""Response payload for SendMessage.
...
class SendMessageResponseContext(_messages.Message):
  r"""Context for the `SendMessage` operation response.

  Fields:
    kind: This is always `sql#sendMessageResponseContext`.
    response: Output only. The response payload of the `SendMessage`
      operation.
  """

  kind = _messages.StringField(1)
  response = _messages.MessageField('SendMessageResponse', 2)


class Session(_messages.Message):
  r"""A `Session` resource represents a communication session with a Cloud SQL
  agent. Session stores status updates, results, and metadata for agent
  workflows. The session state contains information about the progress of the
  workflow and the results of the workflow.

  Fields:
    createTime: Output only. The timestamp when the session was initially
      created on the server side.
    name: Output only. Identifier. The full resource name of the session.
      Format: `projects/{project}/locations/{location}/instances/{instance}/ag
      ents/{agent}/sessions/{session}` `projects/{project}/instances/{instance
      }/agents/{agent}/sessions/{session}`
      `projects/{project}/agents/{agent}/sessions/{session}`
    testingAgentSession: Output only. Session data for the testing agent
      session.
    updateTime: Output only. The timestamp when the session was last modified
      on the server side.
  """

  createTime = _messages.StringField(1)
  name = _messages.StringField(2)
  testingAgentSession = _messages.MessageField('TestingAgentSession', 3)
...
class Settings(_messages.Message):
  ...
  Enums:
    ...
    EditionValueValuesEnum: Optional. The edition type of the Cloud SQL
      instance.
    MsdtcRpcAuthModeValueValuesEnum: Optional. RPC authentication mode for
  ...
  Fields:
    ...
    finalBackupConfig: Optional. The final backup configuration for the
      instance.
    hostMappings: Optional. Host mappings for the VM to be used by Microsoft
    ...
    msdtcEnabled: Optional. Enables Microsoft Distributed Transaction
      Coordinator (MSDTC) for SQL Server.
    msdtcRpcAuthMode: Optional. RPC authentication mode for Microsoft
      Distributed Transaction Coordinator (MSDTC).
    ...
    sqlServerPasswordValidationPolicy: Optional. Instance-level password
      validation policy configuration for SQL Server local logins.
  ...
  class EditionValueValuesEnum(_messages.Enum):
    r"""Optional. The edition type of the Cloud SQL instance.
  ...
  class MsdtcRpcAuthModeValueValuesEnum(_messages.Enum):
    r"""Optional. RPC authentication mode for Microsoft Distributed
    Transaction Coordinator (MSDTC).

    Values:
      MSDTC_RPC_AUTH_MODE_UNSPECIFIED: Unspecified RPC authentication mode.
      ALLOW_ONLY_SECURE_RPC_CALLS: Allow only secure RPC calls. Both servers
        (caller and receiver) must successfully verify each other's
        identities, typically using Active Directory machine accounts and
        Kerberos Service Principal Names (SPNs). This is equivalent to Mutual
        Authentication in Microsoft SQL Server on Windows.
      FALLBACK_TO_UNSECURE_RPC_IF_NECESSARY: Similar to Incoming
        authentication mode in Microsoft SQL Server on Windows, the caller
        authenticates to the receiver. The receiver verifies the caller's
        identity, but the Receiver does not authenticate itself back to the
        caller.
      TURN_OFF_RPC_SECURITY: No authentication. Highly insecure and thus
        should only be used on already secure networks and never over public
        IP.
    """
    MSDTC_RPC_AUTH_MODE_UNSPECIFIED = 0
    ALLOW_ONLY_SECURE_RPC_CALLS = 1
    FALLBACK_TO_UNSECURE_RPC_IF_NECESSARY = 2
    TURN_OFF_RPC_SECURITY = 3
  ...
  hostMappings = _messages.MessageField('HostMapping', 30, repeated=True)
  initialUsersConfig = _messages.MessageField('InitialUsersConfig', 31)
  insightsConfig = _messages.MessageField('InsightsConfig', 32)
  instanceVersion = _messages.StringField(33)
  ipConfiguration = _messages.MessageField('IpConfiguration', 34)
  kind = _messages.StringField(35)
  locationPreference = _messages.MessageField('LocationPreference', 36)
  maintenanceVersion = _messages.StringField(37)
  maintenanceWindow = _messages.MessageField('MaintenanceWindow', 38)
  msdtcEnabled = _messages.BooleanField(39)
  msdtcRpcAuthMode = _messages.EnumField('MsdtcRpcAuthModeValueValuesEnum', 40)
  passwordValidationPolicy = _messages.MessageField('PasswordValidationPolicy', 41)
  performanceCaptureConfig = _messages.MessageField('PerformanceCaptureConfig', 42)
  pricingPlan = _messages.EnumField('PricingPlanValueValuesEnum', 43)
  readPoolAutoScaleConfig = _messages.MessageField('ReadPoolAutoScaleConfig', 44)
  recreateReplicasOnPrimaryCrash = _messages.BooleanField(45)
  replicationLagMaxSeconds = _messages.IntegerField(46, variant=_messages.Variant.INT32)
  replicationType = _messages.EnumField('ReplicationTypeValueValuesEnum', 47)
  retainBackupsOnDelete = _messages.BooleanField(48)
  settingsVersion = _messages.IntegerField(49)
  sqlServerAuditConfig = _messages.MessageField('SqlServerAuditConfig', 50)
  sqlServerPasswordValidationPolicy = _messages.MessageField('SqlServerPasswordValidationPolicy', 51)
  storageAutoResize = _messages.BooleanField(52)
  storageAutoResizeLimit = _messages.IntegerField(53)
  tier = _messages.StringField(54)
  timeZone = _messages.StringField(55)
  uncMappings = _messages.MessageField('UncMapping', 56, repeated=True)
  userLabels = _messages.MessageField('UserLabelsValue', 57)


class SourceRole(_messages.Message):
  r"""The source instance for the Blue-Green deployment.

  Fields:
    targetId: Output only. The target instance paired with this source
      instance in a blue-green deployment.
  """

  targetId = _messages.MessageField('InstanceReference', 1)
...
class SqlConnectResolveRequest(_messages.Message):
  r"""A SqlConnectResolveRequest object.
...
class SqlInstancesPatchRequest(_messages.Message):
  ...
  Fields:
    ...
    reconcilePscNetworkingForce: Optional. Set PSC config to the same value as
      the existing config and force reconcile the PSC networking.
  """
...
class SqlServerPasswordValidationPolicy(_messages.Message):
  r"""Represents instance-level password validation policy configurations for
  SQL Server local logins.

  Fields:
    enablePasswordPolicy: Optional. Enables password policy enforcement for
      SQL Server logins created via Cloud SQL APIs. When set to `true`, Cloud
      SQL enforces default password policy rules when creating or altering
      logins via the Control Plane: - Minimum length of 8 characters (can be
      overridden by `password_minimum_length`). - Character complexity
      (password must contain characters from at least 3 of 4 categories:
      uppercase, lowercase, numbers, and special characters). - Password must
      not contain the SQL Server login name. Setting this flag to `true` also
      allows configuring custom password policy rules on the instance (such as
      history length, minimum age, and maximum age). Note: Password policies
      are already enforced by default for logins created directly within SQL
      Server T-SQL. Setting this flag to `true` will also enable password
      policy enforcement for logins created via Cloud SQL APIs.
    passwordHistoryLength: Optional. Specifies the number of previously used
      passwords that cannot be reused when creating or updating a password for
      a local login. Allowed values range from 1 to 24. If set to `null`,
      password history validation is disabled for the instance. Requires
      `enable_password_policy` to be `true`.
    passwordMaximumAge: Optional. Specifies the maximum duration that a
      password remains valid before it expires for a local login. Allowed
      values range from 1 to 999 days (must be a whole number of days; sub-day
      values are not supported). If set to `null`, password expiration
      validation is disabled for the instance. Requires
      `enable_password_policy` to be `true`.
    passwordMinimumAge: Optional. Specifies the minimum duration that must
      pass before a password can be changed for a local login. Allowed values
      range from 1 to 999 days (must be a whole number of days; sub-day values
      are not supported). If set to `null`, minimum age validation is disabled
      for the instance. Requires `enable_password_policy` to be `true`.
    passwordMinimumLength: Optional. Specifies the minimum number of
      characters required for passwords on local logins. Allowed values range
      from 8 to 128. If unspecified, defaults to 8. Requires
      `enable_password_policy` to be `true`.
  """

  enablePasswordPolicy = _messages.BooleanField(1)
  passwordHistoryLength = _messages.IntegerField(2, variant=_messages.Variant.INT32)
  passwordMaximumAge = _messages.StringField(3)
  passwordMinimumAge = _messages.StringField(4)
  passwordMinimumLength = _messages.IntegerField(5, variant=_messages.Variant.INT32)
...
class SqlServerUserDetails(_messages.Message):
  ...
  Fields:
    ...
    passwordPolicy: Optional. Lists the password policy boolean flags for this
      user. This includes flags to enable or disable password policy and
      password expiration rules configured on the Cloud SQL for SQL Server
      instance.
    serverRoles: Indicates the server roles for this user.
  """

  disabled = _messages.BooleanField(1)
  passwordPolicy = _messages.MessageField('SqlServerUserPasswordPolicy', 2)
  serverRoles = _messages.StringField(3, repeated=True)


class SqlServerUserPasswordPolicy(_messages.Message):
  r"""Represents password policy boolean flags for a SQL Server login that
  control whether instance-level password policy and expiration rules apply to
  this user.

  Fields:
    checkExpiry: Optional. Indicates whether the SQL Server `CHECK_EXPIRATION`
      policy is enforced for this login. If set to `true`, the login follows
      the password expiration rules configured on the instance, and the
      password periodically expires, requiring the user to change it to
      maintain access. If set to `false`, expiration rules are ignored for
      this login.
    checkPolicy: Optional. Indicates whether the SQL Server `CHECK_POLICY`
      policy is enforced for this login. If set to `true`, the login follows
      the custom password policy configured on the instance (or the default
      policy if no custom policy is configured). If set to `false`, password
      policy rules are ignored for this login.
  """

  checkExpiry = _messages.BooleanField(1)
  checkPolicy = _messages.BooleanField(2)
...
class SqlUsersUpdateRequest(_messages.Message):
  ...
  Fields:
    ...
    revokeExistingRoles: Optional. Specifies whether to revoke existing roles
      ...
      existing roles.
    revokeExistingServerRoles: Optional. Specifies whether to revoke existing
      roles that are not present in the `server_roles` field. If `false` or
      unset, the server roles specified in `server_roles` are added to the
      user's existing server roles.
...
class StopWorkloadCaptureContext(_messages.Message):
  ...
  Fields:
    abortLiveReplay: Optional. If true, immediately aborts the concurrent live
      replay and discards any un-replayed traffic alongside stopping the
      capture. If false (the default), the capture stops recording new
      traffic, but the live replay will continue executing until the entire
      backlog of captured traffic has been replayed.
  """

  abortLiveReplay = _messages.BooleanField(1)
...
class TargetConfig(_messages.Message):
  r"""Deprecated: Use RequestedConfig instead. Configuration specified by the
  user at creation time for the target (Green) instance.
...
class TargetRole(_messages.Message):
  r"""The target instance for the Blue-Green deployment.

  Fields:
    sourceId: Output only. The source instance paired with this target
      instance in a blue-green deployment.
  """

  sourceId = _messages.MessageField('InstanceReference', 1)
...
class Task(_messages.Message):
  ...
  Enums:
    StateValueValuesEnum: Optional. Output only. Current status of the task.

  Fields:
    contextId: Optional. Context identifier. Context ID for a task is the
      session ID.
    state: Optional. Output only. Current status of the task.
    testingAgentArtifacts: Output only. Artifacts generated by the testing
      agent.
  """

  class StateValueValuesEnum(_messages.Enum):
    r"""Optional. Output only. Current status of the task.

    Values:
      STATE_UNSPECIFIED: Unspecified task state.
      SUBMITTED: Task has been submitted.
      WORKING: Task is actively being worked on.
      COMPLETED: Task has completed successfully.
      FAILED: Task execution failed.
      CANCELLED: Task was cancelled.
      INPUT_REQUIRED: Task requires external input to proceed.
  ...
  testingAgentArtifacts = _messages.MessageField('TestingAgentArtifacts', 3)


class TestingAgentArtifacts(_messages.Message):
  r"""Artifacts generated by the testing agent.

  Fields:
    artifacts: Output only. The artifacts generated by the testing agent.
  """

  artifacts = _messages.MessageField('Artifact', 1, repeated=True)


class TestingAgentBenchmarkingResult(_messages.Message):
  r"""The result of a benchmarking run.

  Enums:
    BenchmarkingTypeValueValuesEnum: The type of benchmarking performed.

  Fields:
    benchmark: The result of a benchmark run.
    benchmarkStartTime: Optional. The timestamp when the benchmark started.
    benchmarkingType: The type of benchmarking performed.
  """

  class BenchmarkingTypeValueValuesEnum(_messages.Enum):
    r"""The type of benchmarking performed.

    Values:
      BENCHMARKING_TYPE_UNSPECIFIED: The benchmarking type is unspecified.
      BASELINE: Indicates a baseline benchmarking run.
      RECOMMENDATION: Indicates a benchmarking run with the recommendation
        applied.
    """
    BENCHMARKING_TYPE_UNSPECIFIED = 0
    BASELINE = 1
    RECOMMENDATION = 2

  benchmark = _messages.MessageField('BenchmarkingResult', 1)
  benchmarkStartTime = _messages.StringField(2)
  benchmarkingType = _messages.EnumField('BenchmarkingTypeValueValuesEnum', 3)


class TestingAgentMetadata(_messages.Message):
  r"""Metadata specifically for the testing agent.

  Enums:
    IssueTypeValueValuesEnum: Optional. The issue type for the recommendation.
    RecommendationTypeValueValuesEnum: Optional. The type of recommendation
      for the agent to validate.

  Fields:
    approveTestPlan: Optional. If true, the test plan generated by the agent
      is approved, and execution proceeds. When this field is set, the
      `prompt` field is ignored.
    cancelAgentExecution: Optional. If true, the agent execution is cancelled.
    cloudRunServiceAccount: Optional. The service account to use for Cloud Run
      invocation.
    database: Optional. The name of the database to connect to.
    issueType: Optional. The issue type for the recommendation.
    passwordSecretVersion: Optional. The resource name of the Secret Manager
      secret holding the password for the user to log into the database. The
      expected format is
      `projects/{project}/secrets/{secret}/versions/{secret_version}`. The
      secret resource name will not be stored.
    recommendation: Optional. The recommendation described in detail,
      specifying the exact changes to be made to the instance.
    recommendationType: Optional. The type of recommendation for the agent to
      validate.
    user: Optional. The name of an existing database user to connect to the
      database.
  """
  ...
  class IssueTypeValueValuesEnum(_messages.Enum):
    r"""Optional. The issue type for the recommendation.

    Values:
      ISSUE_TYPE_UNSPECIFIED: The issue type is unspecified.
      HIGH_TRANSACTION_ID_UTILIZATION: Indicates high transaction ID
        utilization.
      HIGH_RESOURCE_UTILIZATION: Indicates high resource utilization.
    """
    ISSUE_TYPE_UNSPECIFIED = 0
    HIGH_TRANSACTION_ID_UTILIZATION = 1
    HIGH_RESOURCE_UTILIZATION = 2

  class RecommendationTypeValueValuesEnum(_messages.Enum):
    r"""Optional. The type of recommendation for the agent to validate.

    Values:
      RECOMMENDATION_TYPE_UNSPECIFIED: The recommendation type is unspecified.
      UPSIZE_COMPUTE: Upsize the compute for the instance.
      UPDATE_DATABASE_FLAG: Set or update a database flag.
      UPDATE_EDITION: Update the edition of the instance.
      ENABLE_DATA_CACHE: Enable data-cache for the instance.
    """
    RECOMMENDATION_TYPE_UNSPECIFIED = 0
    UPSIZE_COMPUTE = 1
    UPDATE_DATABASE_FLAG = 2
    UPDATE_EDITION = 3
    ENABLE_DATA_CACHE = 4

  approveTestPlan = _messages.BooleanField(1)
  cancelAgentExecution = _messages.BooleanField(2)
  cloudRunServiceAccount = _messages.StringField(3)
  database = _messages.StringField(4)
  issueType = _messages.EnumField('IssueTypeValueValuesEnum', 5)
  passwordSecretVersion = _messages.StringField(6)
  recommendation = _messages.StringField(7)
  recommendationType = _messages.EnumField('RecommendationTypeValueValuesEnum', 8)
  user = _messages.StringField(9)


class TestingAgentParameter(_messages.Message):
  r"""Represents a parameter for a testing agent step.

  Fields:
    parameter: Output only. The name of the parameter.
    value: Output only. The value of the parameter.
  """
...
class TestingAgentSession(_messages.Message):
  r"""State for the testing agent session.

  Enums:
    StateValueValuesEnum: Output only. The current state of the testing
      workflow.

  Fields:
    benchmarkDuration: Output only. The total duration of the benchmark
      execution.
    benchmarkingResults: Output only. The results of any benchmarking steps
      performed during the workflow.
    errorMessage: Output only. A message detailing why the workflow failed.
      This field is only populated when `state` is `WORKFLOW_FAILED`.
    expirationTime: Output only. The timestamp when the session is set to
      expire.
    metadata: Optional. Metadata provided when the session was created.
    state: Output only. The current state of the testing workflow.
    testPlan: Output only. The generated test plan.
    workflowSteps: Output only. The execution workflow steps for the test
      plan.
  """

  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. The current state of the testing workflow.

    Values:
      STATE_UNSPECIFIED: The state is unspecified.
      TEST_PLAN_GENERATING: The test plan is being generated.
      TEST_PLAN_CREATED: The test plan has been created.
      TEST_PLAN_APPROVED: The test plan has been approved.
      WORKFLOW_PLAN_GENERATING: The workflow plan is being generated.
      WORKFLOW_PLAN_CREATED: The workflow plan has been created.
      WORKFLOW_EXECUTION_IN_PROGRESS: The workflow execution is in progress.
      WORKFLOW_COMPLETED: The workflow execution has completed successfully.
      WORKFLOW_FAILED: The workflow execution has failed.
      WORKFLOW_CANCELLED: The workflow execution has been cancelled.
    """
    STATE_UNSPECIFIED = 0
    TEST_PLAN_GENERATING = 1
    TEST_PLAN_CREATED = 2
    TEST_PLAN_APPROVED = 3
    WORKFLOW_PLAN_GENERATING = 4
    WORKFLOW_PLAN_CREATED = 5
    WORKFLOW_EXECUTION_IN_PROGRESS = 6
    WORKFLOW_COMPLETED = 7
    WORKFLOW_FAILED = 8
    WORKFLOW_CANCELLED = 9

  benchmarkDuration = _messages.StringField(1)
  benchmarkingResults = _messages.MessageField('TestingAgentBenchmarkingResult', 2, repeated=True)
  errorMessage = _messages.StringField(3)
  expirationTime = _messages.StringField(4)
  metadata = _messages.MessageField('TestingAgentMetadata', 5)
  state = _messages.EnumField('StateValueValuesEnum', 6)
  testPlan = _messages.MessageField('TestingAgentTestPlan', 7)
  workflowSteps = _messages.MessageField('TestingAgentWorkflowStep', 8, repeated=True)


class TestingAgentTestPlan(_messages.Message):
  r"""Represents a test plan for the testing agent.

  Fields:
    pendingArguments: Output only. A list of pending arguments required for
      the test plan.
    steps: Output only. The steps of the test plan.
  """

  pendingArguments = _messages.StringField(1, repeated=True)
  steps = _messages.MessageField('TestingAgentTestPlanStep', 2, repeated=True)


class TestingAgentTestPlanStep(_messages.Message):
  r"""Represents a single step in the testing agent's test plan.

  Fields:
    action: Output only. Action to perform.
    description: Output only. Description of the step.
    parameters: Output only. Parameters for the step.
    stepNumber: Output only. Step number.
  """

  action = _messages.StringField(1)
  description = _messages.StringField(2)
  parameters = _messages.MessageField('TestingAgentParameter', 3, repeated=True)
  stepNumber = _messages.IntegerField(4, variant=_messages.Variant.INT32)


class TestingAgentWorkflowStep(_messages.Message):
  r"""Represents a single step in the testing agent's workflow plan.

  Enums:
    StateValueValuesEnum: Output only. The current state of the execution
      step.

  Fields:
    action: Optional. The action to be performed in this step.
    description: Optional. A description of the execution step.
    parameters: Optional. The parameters for the action.
    state: Output only. The current state of the execution step.
    stepNumber: Optional. The sequential step number in the workflow plan.
  """

  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. The current state of the execution step.

    Values:
      STATE_UNSPECIFIED: The state is unspecified.
      NOT_STARTED: The execution has not started.
      IN_PROGRESS: The execution is in progress.
  ...
  parameters = _messages.MessageField('TestingAgentParameter', 3, repeated=True)
  state = _messages.EnumField('StateValueValuesEnum', 4)
  stepNumber = _messages.IntegerField(5, variant=_messages.Variant.INT32)
