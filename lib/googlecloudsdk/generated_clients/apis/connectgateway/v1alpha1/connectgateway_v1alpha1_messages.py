...
class ConnectgatewayProjectsLocationsMembershipsGenerateCredentialsRequest(_messages.Message):
  ...
  Fields:
    applicationDefaultCredentials: Optional. Configures the generated
      kubeconfig to use Application Default Credentials. When this field is
      set to `true`, the `kubeconfig` generated by Connect Gateway will
      include `--use_application_default_credentials` in the arguments for
      `gke-gcloud-auth-plugin`. If `false`, the plugin will use the default
      gcloud credentials.
  ...
  applicationDefaultCredentials = _messages.BooleanField(1)
  forceUseAgent = _messages.BooleanField(2)
  impersonatedServiceAccount = _messages.StringField(3)
  kubernetesNamespace = _messages.StringField(4)
  name = _messages.StringField(5, required=True)
  operatingSystem = _messages.EnumField('OperatingSystemValueValuesEnum', 6)
