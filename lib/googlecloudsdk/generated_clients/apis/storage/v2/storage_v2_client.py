...
class StorageV2(base_api.BaseApiClient):
  ...
  class ProjectsBucketsFoldersService(base_api.BaseApiService):
    ...
    def Delete(self, request, global_params=None):
      r"""Permanently deletes an empty folder. This operation is only applicable to a hierarchical namespace enabled bucket.
  ...
  class ProjectsBucketsSnapshotsService(base_api.BaseApiService):
    ...
    _NAME = 'projects_buckets_snapshots'

    def __init__(self, client):
      super(StorageV2.ProjectsBucketsSnapshotsService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a snapshot of a bucket.

      Args:
        request: (StorageProjectsBucketsSnapshotsCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/buckets/{bucketsId}/snapshots',
        http_method='POST',
        method_id='storage.projects.buckets.snapshots.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId'],
        relative_path='v2/{+parent}/snapshots',
        request_field='snapshot',
        request_type_name='StorageProjectsBucketsSnapshotsCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsBucketsSnapshotsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/buckets/{bucketsId}/snapshots/{snapshotsId}',
        http_method='DELETE',
        method_id='storage.projects.buckets.snapshots.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v2/{+name}',
        request_field='',
        request_type_name='StorageProjectsBucketsSnapshotsDeleteRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsBucketsSnapshotsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/buckets/{bucketsId}/snapshots/{snapshotsId}',
        http_method='GET',
        method_id='storage.projects.buckets.snapshots.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v2/{+name}',
        request_field='',
        request_type_name='StorageProjectsBucketsSnapshotsGetRequest',
        response_type_name='Snapshot',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists the snapshots of a bucket.

      Args:
        request: (StorageProjectsBucketsSnapshotsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/buckets/{bucketsId}/snapshots',
        http_method='GET',
        method_id='storage.projects.buckets.snapshots.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken', 'requestId'],
        relative_path='v2/{+parent}/snapshots',
        request_field='',
        request_type_name='StorageProjectsBucketsSnapshotsListRequest',
    ...
    def Patch(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsBucketsSnapshotsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Snapshot) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/buckets/{bucketsId}/snapshots/{snapshotsId}',
        http_method='PATCH',
        method_id='storage.projects.buckets.snapshots.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v2/{+name}',
        request_field='snapshot',
        request_type_name='StorageProjectsBucketsSnapshotsPatchRequest',
        response_type_name='Snapshot',
        supports_download=False,
    )
  ...
  class ProjectsBucketsService(base_api.BaseApiService):
    ...
    CreateAuthSession.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['requestedResource'],
        path_params=['requestedResource'],
        query_params=[],
        relative_path='v2/{+requestedResource}:createAuthSession',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(StorageV2.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Cancel(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsLocationsOperationsCancelRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='POST',
        method_id='storage.projects.locations.operations.cancel',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2/{+name}:cancel',
        request_field='cancelOperationRequest',
        request_type_name='StorageProjectsLocationsOperationsCancelRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsLocationsOperationsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='storage.projects.locations.operations.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2/{+name}',
        request_field='',
        request_type_name='StorageProjectsLocationsOperationsDeleteRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsLocationsOperationsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}',
        http_method='GET',
        method_id='storage.projects.locations.operations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2/{+name}',
        request_field='',
        request_type_name='StorageProjectsLocationsOperationsGetRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (StorageProjectsLocationsOperationsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='GET',
        method_id='storage.projects.locations.operations.list',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['filter', 'pageSize', 'pageToken', 'returnPartialSuccess'],
        relative_path='v2/{+name}/operations',
        request_field='',
        request_type_name='StorageProjectsLocationsOperationsListRequest',
