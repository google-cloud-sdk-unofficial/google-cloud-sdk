...
class StorageV1(base_api.BaseApiClient):
  ...
  class FoldersService(base_api.BaseApiService):
    ...
    def DeleteRecursive(self, request, global_params=None):
      r"""Deletes a folder recursively. Only applicable to buckets with hierarchical namespace enabled.

      Args:
        request: (StorageFoldersDeleteRecursiveRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    DeleteRecursive.method_config = lambda: base_api.ApiMethodInfo(
        http_method='POST',
        method_id='storage.folders.deleteRecursive',
        ordered_params=['bucket', 'folder'],
        path_params=['bucket', 'folder'],
        query_params=['ifMetagenerationMatch', 'ifMetagenerationNotMatch'],
        relative_path='b/{bucket}/folders/{folder}/deleteRecursive',
        request_field='',
        request_type_name='StorageFoldersDeleteRecursiveRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
