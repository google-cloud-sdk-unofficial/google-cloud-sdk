...
class StorageFoldersDeleteRecursiveRequest(_messages.Message):
  r"""A StorageFoldersDeleteRecursiveRequest object.
...
class StorageObjectsComposeRequest(_messages.Message):
  ...
  dropContextGroups = _messages.StringField(5, repeated=True)
  ifGenerationMatch = _messages.IntegerField(6)
...
class StorageObjectsRewriteRequest(_messages.Message):
  ...
  dropContextGroups = _messages.StringField(5, repeated=True)
  ifGenerationMatch = _messages.IntegerField(6)
  ifGenerationNotMatch = _messages.IntegerField(7)
  ifMetagenerationMatch = _messages.IntegerField(8)
  ifMetagenerationNotMatch = _messages.IntegerField(9)
  ifSourceGenerationMatch = _messages.IntegerField(10)
  ifSourceGenerationNotMatch = _messages.IntegerField(11)
  ifSourceMetagenerationMatch = _messages.IntegerField(12)
  ifSourceMetagenerationNotMatch = _messages.IntegerField(13)
  maxBytesRewrittenPerCall = _messages.IntegerField(14)
  object = _messages.MessageField('Object', 15)
  projection = _messages.EnumField('ProjectionValueValuesEnum', 16)
