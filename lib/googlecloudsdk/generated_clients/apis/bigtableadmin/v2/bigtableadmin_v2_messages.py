...
class AppProfile(_messages.Message):
  ...
  Fields:
    ...
    etag: Strongly validated etag for optimistic concurrency control. Preserve
      ...
      to fail the request if there has been a modification in the meantime.
...
class Table(_messages.Message):
  ...
  Enums:
    GranularityValueValuesEnum: Immutable. The granularity at which timestamps
  ...
  class GranularityValueValuesEnum(_messages.Enum):
    r"""Immutable. The granularity at which timestamps are stored in this
