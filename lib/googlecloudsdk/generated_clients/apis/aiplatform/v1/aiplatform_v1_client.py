...
class AiplatformV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsEndpointsService(base_api.BaseApiService):
    ...
    def Predict(self, request, global_params=None):
      r"""Perform an online inference. Use this method to run inference on Google's generative AI models as well as custom models deployed to Gemini Enterprise Agent Platform. This method supports both generative AI tasks (such as image generation, virtual try-on, text generation, and multimodal embeddings) and traditional machine learning tasks (such as classification and regression). To run inference on a base (non-tuned) Gemini model, see GenerateContent.
  ...
  class ProjectsLocationsFeatureOnlineStoresFeatureViewsService(base_api.BaseApiService):
    ...
    def GenerateFetchAccessToken(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1GenerateFetchAccessTokenResponse) The response message.
      """
    ...
    GenerateFetchAccessToken.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/featureOnlineStores/{featureOnlineStoresId}/featureViews/{featureViewsId}:generateFetchAccessToken',
        http_method='POST',
        method_id='aiplatform.projects.locations.featureOnlineStores.featureViews.generateFetchAccessToken',
        ordered_params=['featureView'],
        path_params=['featureView'],
        query_params=[],
        relative_path='v1/{+featureView}:generateFetchAccessToken',
        request_field='googleCloudAiplatformV1GenerateFetchAccessTokenRequest',
        request_type_name='AiplatformProjectsLocationsFeatureOnlineStoresFeatureViewsGenerateFetchAccessTokenRequest',
        response_type_name='GoogleCloudAiplatformV1GenerateFetchAccessTokenResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsPublishersModelsService(base_api.BaseApiService):
    ...
    def EmbedContent(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1EmbedContentResponse) The response message.
      """
    ...
    EmbedContent.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/publishers/{publishersId}/models/{modelsId}:embedContent',
        http_method='POST',
        method_id='aiplatform.projects.locations.publishers.models.embedContent',
        ordered_params=['model'],
        path_params=['model'],
        query_params=[],
        relative_path='v1/{+model}:embedContent',
        request_field='googleCloudAiplatformV1EmbedContentRequest',
        request_type_name='AiplatformProjectsLocationsPublishersModelsEmbedContentRequest',
        response_type_name='GoogleCloudAiplatformV1EmbedContentResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsReasoningEnginesRuntimeRevisionsService(base_api.BaseApiService):
    """Service class for the projects_locations_reasoningEngines_runtimeRevisions resource."""

    _NAME = 'projects_locations_reasoningEngines_runtimeRevisions'

    def __init__(self, client):
      super(AiplatformV1.ProjectsLocationsReasoningEnginesRuntimeRevisionsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Query(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesRuntimeRevisionsQueryRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    Query.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/runtimeRevisions/{runtimeRevisionsId}:query',
        http_method='POST',
        method_id='aiplatform.projects.locations.reasoningEngines.runtimeRevisions.query',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:query',
        request_field='googleCloudAiplatformV1QueryReasoningEngineRequest',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesRuntimeRevisionsQueryRequest',
    ...
    def StreamQuery(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesRuntimeRevisionsStreamQueryRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleApiHttpBody) The response message.
      """
    ...
    StreamQuery.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/runtimeRevisions/{runtimeRevisionsId}:streamQuery',
        http_method='POST',
        method_id='aiplatform.projects.locations.reasoningEngines.runtimeRevisions.streamQuery',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:streamQuery',
        request_field='googleCloudAiplatformV1StreamQueryReasoningEngineRequest',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesRuntimeRevisionsStreamQueryRequest',
        response_type_name='GoogleApiHttpBody',
        supports_download=False,
    )
  ...
  class ProjectsLocationsReasoningEnginesSessionsEventsService(base_api.BaseApiService):
    ...
    _NAME = 'projects_locations_reasoningEngines_sessions_events'

    def __init__(self, client):
      super(AiplatformV1.ProjectsLocationsReasoningEnginesSessionsEventsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesSessionsEventsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1ListEventsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions/{sessionsId}/events',
        http_method='GET',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.events.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/events',
        request_field='',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesSessionsEventsListRequest',
        response_type_name='GoogleCloudAiplatformV1ListEventsResponse',
        supports_download=False,
    )

  class ProjectsLocationsReasoningEnginesSessionsService(base_api.BaseApiService):
    """Service class for the projects_locations_reasoningEngines_sessions resource."""

    _NAME = 'projects_locations_reasoningEngines_sessions'

    def __init__(self, client):
      super(AiplatformV1.ProjectsLocationsReasoningEnginesSessionsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def AppendEvent(self, request, global_params=None):
      ...
      Args:
        request: (GoogleCloudAiplatformV1SessionEvent) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1AppendEventResponse) The response message.
      """
    ...
    AppendEvent.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions/{sessionsId}:appendEvent',
        http_method='POST',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.appendEvent',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:appendEvent',
        request_field='<request>',
        request_type_name='GoogleCloudAiplatformV1SessionEvent',
        response_type_name='GoogleCloudAiplatformV1AppendEventResponse',
        supports_download=False,
    )
    ...
    def Create(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesSessionsCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions',
        http_method='POST',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['sessionId'],
        relative_path='v1/{+parent}/sessions',
        request_field='googleCloudAiplatformV1Session',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesSessionsCreateRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesSessionsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions/{sessionsId}',
        http_method='DELETE',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesSessionsDeleteRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesSessionsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1Session) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions/{sessionsId}',
        http_method='GET',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesSessionsGetRequest',
        response_type_name='GoogleCloudAiplatformV1Session',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesSessionsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1ListSessionsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions',
        http_method='GET',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/sessions',
        request_field='',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesSessionsListRequest',
        response_type_name='GoogleCloudAiplatformV1ListSessionsResponse',
        supports_download=False,
    )
    ...
    def Patch(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesSessionsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1Session) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/sessions/{sessionsId}',
        http_method='PATCH',
        method_id='aiplatform.projects.locations.reasoningEngines.sessions.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['updateMask'],
        relative_path='v1/{+name}',
        request_field='googleCloudAiplatformV1Session',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesSessionsPatchRequest',
        response_type_name='GoogleCloudAiplatformV1Session',
        supports_download=False,
    )
  ...
  class ProjectsLocationsReasoningEnginesService(base_api.BaseApiService):
    ...
    AsyncQuery.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}:asyncQuery',
        http_method='POST',
        method_id='aiplatform.projects.locations.reasoningEngines.asyncQuery',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:asyncQuery',
        request_field='googleCloudAiplatformV1AsyncQueryReasoningEngineRequest',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesAsyncQueryRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )

    def CancelAsyncQuery(self, request, global_params=None):
      r"""Cancels an AsyncQueryReasoningEngine operation.

      Args:
        request: (AiplatformProjectsLocationsReasoningEnginesCancelAsyncQueryRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1CancelAsyncQueryReasoningEngineResponse) The response message.
      """
      config = self.GetMethodConfig('CancelAsyncQuery')
      return self._RunMethod(
          config, request, global_params=global_params)

    CancelAsyncQuery.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}:cancelAsyncQuery',
        http_method='POST',
        method_id='aiplatform.projects.locations.reasoningEngines.cancelAsyncQuery',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:cancelAsyncQuery',
        request_field='googleCloudAiplatformV1CancelAsyncQueryReasoningEngineRequest',
        request_type_name='AiplatformProjectsLocationsReasoningEnginesCancelAsyncQueryRequest',
        response_type_name='GoogleCloudAiplatformV1CancelAsyncQueryReasoningEngineResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsSemanticGovernancePoliciesService(base_api.BaseApiService):
    """Service class for the projects_locations_semanticGovernancePolicies resource."""

    _NAME = 'projects_locations_semanticGovernancePolicies'

    def __init__(self, client):
      super(AiplatformV1.ProjectsLocationsSemanticGovernancePoliciesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Create(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsSemanticGovernancePoliciesCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicies',
        http_method='POST',
        method_id='aiplatform.projects.locations.semanticGovernancePolicies.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['semanticGovernancePolicyId'],
        relative_path='v1/{+parent}/semanticGovernancePolicies',
        request_field='googleCloudAiplatformV1SemanticGovernancePolicy',
        request_type_name='AiplatformProjectsLocationsSemanticGovernancePoliciesCreateRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsSemanticGovernancePoliciesDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicies/{semanticGovernancePoliciesId}',
        http_method='DELETE',
        method_id='aiplatform.projects.locations.semanticGovernancePolicies.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['etag'],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='AiplatformProjectsLocationsSemanticGovernancePoliciesDeleteRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsSemanticGovernancePoliciesGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1SemanticGovernancePolicy) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicies/{semanticGovernancePoliciesId}',
        http_method='GET',
        method_id='aiplatform.projects.locations.semanticGovernancePolicies.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='AiplatformProjectsLocationsSemanticGovernancePoliciesGetRequest',
        response_type_name='GoogleCloudAiplatformV1SemanticGovernancePolicy',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsSemanticGovernancePoliciesListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1ListSemanticGovernancePoliciesResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicies',
        http_method='GET',
        method_id='aiplatform.projects.locations.semanticGovernancePolicies.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1/{+parent}/semanticGovernancePolicies',
        request_field='',
        request_type_name='AiplatformProjectsLocationsSemanticGovernancePoliciesListRequest',
        response_type_name='GoogleCloudAiplatformV1ListSemanticGovernancePoliciesResponse',
        supports_download=False,
    )
    ...
    def Patch(self, request, global_params=None):
      ...
      Args:
        request: (AiplatformProjectsLocationsSemanticGovernancePoliciesPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicies/{semanticGovernancePoliciesId}',
        http_method='PATCH',
        method_id='aiplatform.projects.locations.semanticGovernancePolicies.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['updateMask'],
        relative_path='v1/{+name}',
        request_field='googleCloudAiplatformV1SemanticGovernancePolicy',
        request_type_name='AiplatformProjectsLocationsSemanticGovernancePoliciesPatchRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
  ...
  class ProjectsLocationsSemanticGovernancePolicyEngineService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AiplatformV1.ProjectsLocationsSemanticGovernancePolicyEngineService, self).__init__(client)
      self._upload_configs = {
          }

    def Deprovision(self, request, global_params=None):
      r"""Deprovisions the SemanticGovernancePolicyEngine, tearing down the associated tenant project, GKE cluster, and PSC service attachments. This operation is irreversible. Returns a long-running operation; poll for completion. The response contains the SemanticGovernancePolicyEngine in DEPROVISIONING state.

      Args:
        request: (AiplatformProjectsLocationsSemanticGovernancePolicyEngineDeprovisionRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Deprovision.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicyEngine:deprovision',
        http_method='POST',
        method_id='aiplatform.projects.locations.semanticGovernancePolicyEngine.deprovision',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:deprovision',
        request_field='googleCloudAiplatformV1DeprovisionSemanticGovernancePolicyEngineRequest',
        request_type_name='AiplatformProjectsLocationsSemanticGovernancePolicyEngineDeprovisionRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
  ...
  class ProjectsLocationsTuningJobsService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      r"""Creates a tuning job. A created tuning job will be subsequently executed to start the model tuning process.
    ...
    def List(self, request, global_params=None):
      r"""Lists tuning jobs in a location.
    ...
    def RebaseTunedModel(self, request, global_params=None):
      r"""Rebase a tuned model. A rebase operation takes a model that was previously tuned on a base model version, and retunes it on a new base model version. The rebase operation creates a new tuning job and a new tuned model.
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def AskContexts(self, request, global_params=None):
      r"""Agentic Retrieval Ask API for RAG.

      Args:
        request: (AiplatformProjectsLocationsAskContextsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1AskContextsResponse) The response message.
      """
      config = self.GetMethodConfig('AskContexts')
      return self._RunMethod(
          config, request, global_params=global_params)

    AskContexts.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}:askContexts',
        http_method='POST',
        method_id='aiplatform.projects.locations.askContexts',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}:askContexts',
        request_field='googleCloudAiplatformV1AskContextsRequest',
        request_type_name='AiplatformProjectsLocationsAskContextsRequest',
        response_type_name='GoogleCloudAiplatformV1AskContextsResponse',
        supports_download=False,
    )

    def AsyncRetrieveContexts(self, request, global_params=None):
      r"""Asynchronous API to retrieves relevant contexts for a query.

      Args:
        request: (AiplatformProjectsLocationsAsyncRetrieveContextsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
      config = self.GetMethodConfig('AsyncRetrieveContexts')
      return self._RunMethod(
          config, request, global_params=global_params)

    AsyncRetrieveContexts.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}:asyncRetrieveContexts',
        http_method='POST',
        method_id='aiplatform.projects.locations.asyncRetrieveContexts',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}:asyncRetrieveContexts',
        request_field='googleCloudAiplatformV1AsyncRetrieveContextsRequest',
        request_type_name='AiplatformProjectsLocationsAsyncRetrieveContextsRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def GenerateSyntheticData(self, request, global_params=None):
      r"""Generates synthetic (artificial) data based on a description.

      Args:
        request: (AiplatformProjectsLocationsGenerateSyntheticDataRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1GenerateSyntheticDataResponse) The response message.
      """
    ...
    GenerateSyntheticData.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}:generateSyntheticData',
        http_method='POST',
        method_id='aiplatform.projects.locations.generateSyntheticData',
        ordered_params=['location'],
        path_params=['location'],
        query_params=[],
        relative_path='v1/{+location}:generateSyntheticData',
        request_field='googleCloudAiplatformV1GenerateSyntheticDataRequest',
        request_type_name='AiplatformProjectsLocationsGenerateSyntheticDataRequest',
        response_type_name='GoogleCloudAiplatformV1GenerateSyntheticDataResponse',
        supports_download=False,
    )
    ...
    def GetSemanticGovernancePolicyEngine(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAiplatformV1SemanticGovernancePolicyEngine) The response message.
      """
      config = self.GetMethodConfig('GetSemanticGovernancePolicyEngine')
      return self._RunMethod(
          config, request, global_params=global_params)

    GetSemanticGovernancePolicyEngine.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicyEngine',
        http_method='GET',
        method_id='aiplatform.projects.locations.getSemanticGovernancePolicyEngine',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='AiplatformProjectsLocationsGetSemanticGovernancePolicyEngineRequest',
        response_type_name='GoogleCloudAiplatformV1SemanticGovernancePolicyEngine',
        supports_download=False,
    )
    ...
    def UpdateSemanticGovernancePolicyEngine(self, request, global_params=None):
      r"""Updates a SemanticGovernancePolicyEngine. This method performs an upsert operation. If the SemanticGovernancePolicyEngine resource does not exist, it will be created. Otherwise, it will be updated.

      Args:
        request: (AiplatformProjectsLocationsUpdateSemanticGovernancePolicyEngineRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
      config = self.GetMethodConfig('UpdateSemanticGovernancePolicyEngine')
      return self._RunMethod(
          config, request, global_params=global_params)

    UpdateSemanticGovernancePolicyEngine.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/semanticGovernancePolicyEngine',
        http_method='PATCH',
        method_id='aiplatform.projects.locations.updateSemanticGovernancePolicyEngine',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['updateMask'],
        relative_path='v1/{+name}',
        request_field='googleCloudAiplatformV1SemanticGovernancePolicyEngine',
        request_type_name='AiplatformProjectsLocationsUpdateSemanticGovernancePolicyEngineRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
