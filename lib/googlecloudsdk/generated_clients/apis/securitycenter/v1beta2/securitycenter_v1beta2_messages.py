...
class Agent(_messages.Message):
  ...
  Fields:
    displayName: The user friendly name of the specific agent instance where
      the finding was detected, for example, "Banking Agent".
...
class AgentAnomaly(_messages.Message):
  r"""Represents details about an anomaly detected in an AI agent's behavior.

  Fields:
    confidenceScore: The overall confidence score indicating the likelihood
      that this session contains a true anomaly. The score ranges from 0.0 to
      1.0, where 1.0 signifies 100% confidence in the presence of an anomaly
      and 0.0 signifies 0% confidence.
    detectorReferences: The list of references to specific detectors that
      identified anomalies within this session.
    invocationReferences: References to the OpenTelemetry invocations.
  """

  confidenceScore = _messages.FloatField(1)
  detectorReferences = _messages.MessageField('DetectorReference', 2, repeated=True)
  invocationReferences = _messages.MessageField('InvocationReference', 3, repeated=True)
...
class AgentSession(_messages.Message):
  r"""Represents a conversational session where the finding occurred.

  Fields:
    sessionId: The session ID of a conversation.
  """
...
class DataRetentionDeletionEvent(_messages.Message):
  ...
  class EventTypeValueValuesEnum(_messages.Enum):
    ...
    EVENT_TYPE_MIN_TTL_FROM_CREATION = 4
  ...
  minRetentionAllowed = _messages.StringField(5)
...
class Details(_messages.Message):
  ...
  class TypeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      SUBSCRIPTION: Manually granted subscription.
      SUB_FIXED: Fixed contract based subscription.
      SUB_BASE_OVERAGE: Manually granted SCCP/E subscription
    """
    TYPE_UNSPECIFIED = 0
    STANDARD = 1
    TRIAL = 2
...
class DetectorReference(_messages.Message):
  r"""Represents a reference to a specific anomaly detector.

  Enums:
    SeverityValueValuesEnum: The severity of the detector.

  Fields:
    detectorId: The unique identifier of the detector.
    displayName: A human readable name for the detector, providing context on
      its purpose. For example, "ASI02: Tool Misuse", or "Excessive API
      Calls".
    explanation: A detailed explanation generated by an LLM or the detector
      itself, describing why this specific anomaly was flagged. This provides
      rationale and context for the detection.
    recommendation: Recommended steps or actions to remediate or investigate
      the anomaly flagged by this detector. These could include configuration
      changes, code adjustments, or further diagnostic procedures.
    severity: The severity of the detector.
  """

  class SeverityValueValuesEnum(_messages.Enum):
    r"""The severity of the detector.
  ...
  detectorId = _messages.StringField(1)
  displayName = _messages.StringField(2)
...
class DiscoveredWorkload(_messages.Message):
  ...
  Enums:
    ...
    WorkloadTypeValueValuesEnum: The type of workload.

  Fields:
    confidence: The confidence in detection of this workload.
    detectedRelevantHardware: A boolean flag set to true if associated
      hardware strongly predicts the workload type.
    detectedRelevantKeywords: A boolean flag set to true if associated
      keywords strongly predict the workload type.
  ...
  class ConfidenceValueValuesEnum(_messages.Enum):
    r"""The confidence in detection of this workload.
  ...
  detectedRelevantHardware = _messages.BooleanField(2)
  detectedRelevantKeywords = _messages.BooleanField(3)
  detectedRelevantPackages = _messages.BooleanField(4)
  workloadType = _messages.EnumField('WorkloadTypeValueValuesEnum', 5)
...
class ExternalExposure(_messages.Message):
  r"""Details about the externally exposed resource associated with the
  finding.
  ...
  Fields:
    ...
    serviceFirewallPolicy: The full resource name of the firewall policy of
      the exposed service, for example,
      "//compute.googleapis.com/projects/{project-
      id}/global/firewallPolicies/{policy-name}".
  """
...
class Finding(_messages.Message):
  ...
  Fields:
    ...
    agent: Primary Agent that the specified finding was flagged for
    agentAnomaly: Details about behavior anomalies detected in AI agents.
    agentDataAccessEvents: Agent data access events associated with the
      finding.
    agentSessions: Conversational session(s) where the finding occurred.
  ...
  agent = _messages.MessageField('Agent', 3)
  agentAnomaly = _messages.MessageField('AgentAnomaly', 4)
  agentDataAccessEvents = _messages.MessageField('AgentDataAccessEvent', 5, repeated=True)
  agentSessions = _messages.MessageField('AgentSession', 6, repeated=True)
  aiModel = _messages.MessageField('AiModel', 7)
  application = _messages.MessageField('Application', 8)
  artifactGuardPolicies = _messages.MessageField('ArtifactGuardPolicies', 9)
  attackExposure = _messages.MessageField('AttackExposure', 10)
  backupDisasterRecovery = _messages.MessageField('BackupDisasterRecovery', 11)
  canonicalName = _messages.StringField(12)
  category = _messages.StringField(13)
  chokepoint = _messages.MessageField('Chokepoint', 14)
  cloudArmor = _messages.MessageField('CloudArmor', 15)
  cloudDlpDataProfile = _messages.MessageField('CloudDlpDataProfile', 16)
  cloudDlpInspection = _messages.MessageField('CloudDlpInspection', 17)
  complianceDetails = _messages.MessageField('ComplianceDetails', 18)
  compliances = _messages.MessageField('Compliance', 19, repeated=True)
  connections = _messages.MessageField('Connection', 20, repeated=True)
  contacts = _messages.MessageField('ContactsValue', 21)
  containers = _messages.MessageField('Container', 22, repeated=True)
  createTime = _messages.StringField(23)
  dataAccessEvents = _messages.MessageField('DataAccessEvent', 24, repeated=True)
  dataFlowEvents = _messages.MessageField('DataFlowEvent', 25, repeated=True)
  dataRetentionDeletionEvents = _messages.MessageField('DataRetentionDeletionEvent', 26, repeated=True)
  database = _messages.MessageField('Database', 27)
  description = _messages.StringField(28)
  discoveredWorkload = _messages.MessageField('DiscoveredWorkload', 29)
  disk = _messages.MessageField('Disk', 30)
  eventTime = _messages.StringField(31)
  exfiltration = _messages.MessageField('Exfiltration', 32)
  externalExposure = _messages.MessageField('ExternalExposure', 33)
  externalSystems = _messages.MessageField('ExternalSystemsValue', 34)
  externalUri = _messages.StringField(35)
  files = _messages.MessageField('File', 36, repeated=True)
  findingClass = _messages.EnumField('FindingClassValueValuesEnum', 37)
  groupMemberships = _messages.MessageField('GroupMembership', 38, repeated=True)
  iamBindings = _messages.MessageField('IamBinding', 39, repeated=True)
  iamDetails = _messages.MessageField('GoogleCloudSecuritycenterV1IamDetails', 40)
  indicator = _messages.MessageField('Indicator', 41)
  ipRules = _messages.MessageField('IpRules', 42)
  job = _messages.MessageField('Job', 43)
  kernelRootkit = _messages.MessageField('KernelRootkit', 44)
  kubernetes = _messages.MessageField('Kubernetes', 45)
  loadBalancers = _messages.MessageField('LoadBalancer', 46, repeated=True)
  logEntries = _messages.MessageField('LogEntry', 47, repeated=True)
  mitreAttack = _messages.MessageField('MitreAttack', 48)
  moduleName = _messages.StringField(49)
  mute = _messages.EnumField('MuteValueValuesEnum', 50)
  muteInfo = _messages.MessageField('MuteInfo', 51)
  muteInitiator = _messages.StringField(52)
  muteUpdateTime = _messages.StringField(53)
  name = _messages.StringField(54)
  networks = _messages.MessageField('Network', 55, repeated=True)
  nextSteps = _messages.StringField(56)
  notebook = _messages.MessageField('Notebook', 57)
  orgPolicies = _messages.MessageField('OrgPolicy', 58, repeated=True)
  parent = _messages.StringField(59)
  parentDisplayName = _messages.StringField(60)
  policyViolationSummary = _messages.MessageField('PolicyViolationSummary', 61)
  processes = _messages.MessageField('Process', 62, repeated=True)
  resourceName = _messages.StringField(63)
  secret = _messages.MessageField('Secret', 64)
  securityMarks = _messages.MessageField('SecurityMarks', 65)
  securityPosture = _messages.MessageField('SecurityPosture', 66)
  severity = _messages.EnumField('SeverityValueValuesEnum', 67)
  sourceProperties = _messages.MessageField('SourcePropertiesValue', 68)
  state = _messages.EnumField('StateValueValuesEnum', 69)
  toxicCombination = _messages.MessageField('ToxicCombination', 70)
  vertexAi = _messages.MessageField('VertexAi', 71)
  vulnerability = _messages.MessageField('Vulnerability', 72)
...
class GoogleCloudSecuritycenterV2Agent(_messages.Message):
  r"""Represents a monitored AI Agent.
...
class GoogleCloudSecuritycenterV2AgentAnomaly(_messages.Message):
  r"""Represents details about an anomaly detected in an AI agent's behavior.
  ...
  confidenceScore = _messages.FloatField(1)
  detectorReferences = _messages.MessageField('GoogleCloudSecuritycenterV2DetectorReference', 2, repeated=True)
  invocationReferences = _messages.MessageField('GoogleCloudSecuritycenterV2InvocationReference', 3, repeated=True)
...
class GoogleCloudSecuritycenterV2AgentSession(_messages.Message):
  r"""Represents a conversational session where the finding occurred.
...
class GoogleCloudSecuritycenterV2DetectorReference(_messages.Message):
  r"""Represents a reference to a specific anomaly detector.
...
class GoogleCloudSecuritycenterV2ExternalExposure(_messages.Message):
  r"""Details about the externally exposed resource associated with the
  finding.
...
class GoogleCloudSecuritycenterV2Finding(_messages.Message):
  ...
  agent = _messages.MessageField('GoogleCloudSecuritycenterV2Agent', 3)
  agentAnomaly = _messages.MessageField('GoogleCloudSecuritycenterV2AgentAnomaly', 4)
  agentDataAccessEvents = _messages.MessageField('GoogleCloudSecuritycenterV2AgentDataAccessEvent', 5, repeated=True)
  agentSessions = _messages.MessageField('GoogleCloudSecuritycenterV2AgentSession', 6, repeated=True)
  aiModel = _messages.MessageField('GoogleCloudSecuritycenterV2AiModel', 7)
  application = _messages.MessageField('GoogleCloudSecuritycenterV2Application', 8)
  artifactGuardPolicies = _messages.MessageField('GoogleCloudSecuritycenterV2ArtifactGuardPolicies', 9)
  attackExposure = _messages.MessageField('GoogleCloudSecuritycenterV2AttackExposure', 10)
  backupDisasterRecovery = _messages.MessageField('GoogleCloudSecuritycenterV2BackupDisasterRecovery', 11)
  canonicalName = _messages.StringField(12)
  category = _messages.StringField(13)
  chokepoint = _messages.MessageField('GoogleCloudSecuritycenterV2Chokepoint', 14)
  cloudArmor = _messages.MessageField('GoogleCloudSecuritycenterV2CloudArmor', 15)
  cloudDlpDataProfile = _messages.MessageField('GoogleCloudSecuritycenterV2CloudDlpDataProfile', 16)
  cloudDlpInspection = _messages.MessageField('GoogleCloudSecuritycenterV2CloudDlpInspection', 17)
  complianceDetails = _messages.MessageField('GoogleCloudSecuritycenterV2ComplianceDetails', 18)
  compliances = _messages.MessageField('GoogleCloudSecuritycenterV2Compliance', 19, repeated=True)
  connections = _messages.MessageField('GoogleCloudSecuritycenterV2Connection', 20, repeated=True)
  contacts = _messages.MessageField('ContactsValue', 21)
  containers = _messages.MessageField('GoogleCloudSecuritycenterV2Container', 22, repeated=True)
  createTime = _messages.StringField(23)
  cryptoKeyName = _messages.StringField(24)
  dataAccessEvents = _messages.MessageField('GoogleCloudSecuritycenterV2DataAccessEvent', 25, repeated=True)
  dataFlowEvents = _messages.MessageField('GoogleCloudSecuritycenterV2DataFlowEvent', 26, repeated=True)
  dataRetentionDeletionEvents = _messages.MessageField('GoogleCloudSecuritycenterV2DataRetentionDeletionEvent', 27, repeated=True)
  database = _messages.MessageField('GoogleCloudSecuritycenterV2Database', 28)
  description = _messages.StringField(29)
  discoveredWorkload = _messages.MessageField('GoogleCloudSecuritycenterV2DiscoveredWorkload', 30)
  disk = _messages.MessageField('GoogleCloudSecuritycenterV2Disk', 31)
  eventTime = _messages.StringField(32)
  exfiltration = _messages.MessageField('GoogleCloudSecuritycenterV2Exfiltration', 33)
  externalExposure = _messages.MessageField('GoogleCloudSecuritycenterV2ExternalExposure', 34)
  externalSystems = _messages.MessageField('ExternalSystemsValue', 35)
  externalUri = _messages.StringField(36)
  files = _messages.MessageField('GoogleCloudSecuritycenterV2File', 37, repeated=True)
  findingClass = _messages.EnumField('FindingClassValueValuesEnum', 38)
  groupMemberships = _messages.MessageField('GoogleCloudSecuritycenterV2GroupMembership', 39, repeated=True)
  iamBindings = _messages.MessageField('GoogleCloudSecuritycenterV2IamBinding', 40, repeated=True)
  iamDetails = _messages.MessageField('GoogleCloudSecuritycenterV2IamDetails', 41)
  indicator = _messages.MessageField('GoogleCloudSecuritycenterV2Indicator', 42)
  ipRules = _messages.MessageField('GoogleCloudSecuritycenterV2IpRules', 43)
  job = _messages.MessageField('GoogleCloudSecuritycenterV2Job', 44)
  kernelRootkit = _messages.MessageField('GoogleCloudSecuritycenterV2KernelRootkit', 45)
  kubernetes = _messages.MessageField('GoogleCloudSecuritycenterV2Kubernetes', 46)
  loadBalancers = _messages.MessageField('GoogleCloudSecuritycenterV2LoadBalancer', 47, repeated=True)
  logEntries = _messages.MessageField('GoogleCloudSecuritycenterV2LogEntry', 48, repeated=True)
  mitreAttack = _messages.MessageField('GoogleCloudSecuritycenterV2MitreAttack', 49)
  moduleName = _messages.StringField(50)
  mute = _messages.EnumField('MuteValueValuesEnum', 51)
  muteInfo = _messages.MessageField('GoogleCloudSecuritycenterV2MuteInfo', 52)
  muteInitiator = _messages.StringField(53)
  muteUpdateTime = _messages.StringField(54)
  name = _messages.StringField(55)
  networks = _messages.MessageField('GoogleCloudSecuritycenterV2Network', 56, repeated=True)
  nextSteps = _messages.StringField(57)
  notebook = _messages.MessageField('GoogleCloudSecuritycenterV2Notebook', 58)
  orgPolicies = _messages.MessageField('GoogleCloudSecuritycenterV2OrgPolicy', 59, repeated=True)
  parent = _messages.StringField(60)
  parentDisplayName = _messages.StringField(61)
  policyViolationSummary = _messages.MessageField('GoogleCloudSecuritycenterV2PolicyViolationSummary', 62)
  processes = _messages.MessageField('GoogleCloudSecuritycenterV2Process', 63, repeated=True)
  resourceName = _messages.StringField(64)
  secret = _messages.MessageField('GoogleCloudSecuritycenterV2Secret', 65)
  securityMarks = _messages.MessageField('GoogleCloudSecuritycenterV2SecurityMarks', 66)
  securityPosture = _messages.MessageField('GoogleCloudSecuritycenterV2SecurityPosture', 67)
  severity = _messages.EnumField('SeverityValueValuesEnum', 68)
  sourceProperties = _messages.MessageField('SourcePropertiesValue', 69)
  state = _messages.EnumField('StateValueValuesEnum', 70)
  toxicCombination = _messages.MessageField('GoogleCloudSecuritycenterV2ToxicCombination', 71)
  vertexAi = _messages.MessageField('GoogleCloudSecuritycenterV2VertexAi', 72)
  vulnerability = _messages.MessageField('GoogleCloudSecuritycenterV2Vulnerability', 73)
...
class GoogleCloudSecuritycenterV2HttpResponse(_messages.Message):
  ...
  Fields:
    path: The http path for which response code was returned by web
      application, for example, `https://example.com/example`.
...
class GoogleCloudSecuritycenterV2InvocationReference(_messages.Message):
  r"""Represents a reference to a specific OpenTelemetry invocation.
...
class InvocationReference(_messages.Message):
  r"""Represents a reference to a specific OpenTelemetry invocation.
