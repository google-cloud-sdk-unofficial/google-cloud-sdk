...
class OAuthSettings(_messages.Message):
  ...
  Fields:
    clientId: Optional. OAuth 2.0 client ID used in the OAuth flow. This
      allows for client sharing. The risks of client sharing are outlined
    ...
    clientSecretSha256: Output only. OAuth secret SHA256 paired with client
      ID.
  ...
  clientSecret = _messages.StringField(2)
  clientSecretSha256 = _messages.StringField(3)
  loginHint = _messages.StringField(4)
  programmaticClients = _messages.StringField(5, repeated=True)
...
class Resource(_messages.Message):
  ...
  Fields:
    ...
    locations: The locations of the resource. This field is used to determine
      ...
      Constraints: - Individual location strings must be less than 1000 bytes.
      - The cumulative size of all locations must be less than 16KB.
