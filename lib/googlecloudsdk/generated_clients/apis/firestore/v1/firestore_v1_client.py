...
class FirestoreV1(base_api.BaseApiClient):
  ...
  class ProjectsDatabasesDocumentsService(base_api.BaseApiService):
    ...
    CreateDocument.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=['documentId', 'mask_fieldPaths', 'requestOptions_requestTags'],
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['currentDocument_exists', 'currentDocument_updateTime', 'requestOptions_requestTags'],
        relative_path='v1/{+name}',
        request_field='',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['mask_fieldPaths', 'readTime', 'requestOptions_requestTags', 'transaction'],
        relative_path='v1/{+name}',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent', 'collectionId'],
        path_params=['collectionId', 'parent'],
        query_params=['mask_fieldPaths', 'orderBy', 'pageSize', 'pageToken', 'readTime', 'recursive', 'requestOptions_requestTags', 'showMissing', 'transaction'],
        relative_path='v1/{+parent}/{collectionId}',
        request_field='',
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['currentDocument_exists', 'currentDocument_updateTime', 'mask_fieldPaths', 'requestOptions_requestTags', 'updateMask_fieldPaths'],
        relative_path='v1/{+name}',
        request_field='document',
