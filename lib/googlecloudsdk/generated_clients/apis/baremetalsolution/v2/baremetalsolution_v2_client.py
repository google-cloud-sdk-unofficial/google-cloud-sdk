...
class BaremetalsolutionV2(base_api.BaseApiClient):
  ...
  class ProjectsLocationsVolumesLunsService(base_api.BaseApiService):
    ...
    def OnDemandEvict(self, request, global_params=None):
      r"""Skips lun's cooloff and deletes it now. Lun must be in cooloff state. This method is used for Evict done with PAM.

      Args:
        request: (BaremetalsolutionProjectsLocationsVolumesLunsOnDemandEvictRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
      config = self.GetMethodConfig('OnDemandEvict')
      return self._RunMethod(
          config, request, global_params=global_params)

    OnDemandEvict.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/locations/{locationsId}/volumes/{volumesId}/luns/{lunsId}:onDemandEvict',
        http_method='POST',
        method_id='baremetalsolution.projects.locations.volumes.luns.onDemandEvict',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2/{+name}:onDemandEvict',
        request_field='onDemandEvictLunRequest',
        request_type_name='BaremetalsolutionProjectsLocationsVolumesLunsOnDemandEvictRequest',
        response_type_name='Operation',
        supports_download=False,
    )
  ...
  class ProjectsLocationsVolumesService(base_api.BaseApiService):
    ...
    def OnDemandEvict(self, request, global_params=None):
      r"""Skips volume's cooloff and deletes it now. Volume must be in cooloff state. This method is used for Evict done with PAM.

      Args:
        request: (BaremetalsolutionProjectsLocationsVolumesOnDemandEvictRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    OnDemandEvict.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/locations/{locationsId}/volumes/{volumesId}:onDemandEvict',
        http_method='POST',
        method_id='baremetalsolution.projects.locations.volumes.onDemandEvict',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2/{+name}:onDemandEvict',
        request_field='onDemandEvictVolumeRequest',
        request_type_name='BaremetalsolutionProjectsLocationsVolumesOnDemandEvictRequest',
        response_type_name='Operation',
        supports_download=False,
    )
