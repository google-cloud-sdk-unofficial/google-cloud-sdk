...
class BaremetalsolutionProjectsLocationsVolumesLunsOnDemandEvictRequest(_messages.Message):
  r"""A BaremetalsolutionProjectsLocationsVolumesLunsOnDemandEvictRequest
  object.

  Fields:
    name: Required. The name of the Lun. Format:
      projects/{project}/locations/{location}/volumes/{volume}/luns/{lun}
    onDemandEvictLunRequest: A OnDemandEvictLunRequest resource to be passed
      as the request body.
  """

  name = _messages.StringField(1, required=True)
  onDemandEvictLunRequest = _messages.MessageField('OnDemandEvictLunRequest', 2)


class BaremetalsolutionProjectsLocationsVolumesOnDemandEvictRequest(_messages.Message):
  r"""A BaremetalsolutionProjectsLocationsVolumesOnDemandEvictRequest object.

  Fields:
    name: Required. The name of the Volume. Format:
      projects/{project}/locations/{location}/volumes/{volume}
    onDemandEvictVolumeRequest: A OnDemandEvictVolumeRequest resource to be
      passed as the request body.
  """

  name = _messages.StringField(1, required=True)
  onDemandEvictVolumeRequest = _messages.MessageField('OnDemandEvictVolumeRequest', 2)
...
class OnDemandEvictLunRequest(_messages.Message):
  r"""Request for skip lun cooloff and delete it."""


class OnDemandEvictVolumeRequest(_messages.Message):
  r"""Request for skip volume cooloff and delete it."""
