...
class BranchRule(_messages.Message):
  ...
  Fields:
    ...
    requireCodeOwnerApproval: Optional. Determines if code owners must approve
  ...
  requireCodeOwnerApproval = _messages.BooleanField(10)
  requireCommentsResolved = _messages.BooleanField(11)
  requireLinearHistory = _messages.BooleanField(12)
  requirePullRequest = _messages.BooleanField(13)
  requiredStatusChecks = _messages.MessageField('Check', 14, repeated=True)
...
class CustomHostConfig(_messages.Message):
  r"""Custom host config for the instance.

  Fields:
    api: Required. The custom API hostname for the instance, e.g.,
      "api.source.internal.mycompany.com"
    gitHttp: Required. The custom git http hostname for the instance, e.g.,
      "git.source.internal.mycompany.com"
    gitSsh: Required. The custom git ssh hostname for the instance, e.g.,
      "ssh.source.internal.mycompany.com"
    html: Required. The custom UI hostname for the instance, e.g.,
      "git.source.internal.mycompany.com"
  """
...
class PrivateConfig(_messages.Message):
  ...
  Fields:
    ...
    customHostConfig: Optional. Custom host config for the instance.
  ...
  customHostConfig = _messages.MessageField('CustomHostConfig', 2)
  httpServiceAttachment = _messages.StringField(3)
  isPrivate = _messages.BooleanField(4)
  pscAllowedProjects = _messages.StringField(5, repeated=True)
  sshServiceAttachment = _messages.StringField(6)
