...
class GeminiGcpEnablementSetting(_messages.Message):
  ...
  Enums:
    ReleaseChannelValueValuesEnum: Optional. Specifies the release channel for
      Gemini features. The release channel determines which set of features
  ...
  Fields:
    createTime: Output only. [Output only] Create time stamp.
    customInstructions: Optional. Contains custom instructions to be applied
      to the GCA agent.
    ...
    proactiveAgentsEnabled: Optional. Indicates whether proactive agents are
      enabled. If not set, proactive agents are disabled.
    releaseChannel: Optional. Specifies the release channel for Gemini
      features. The release channel determines which set of features are
  ...
  class ReleaseChannelValueValuesEnum(_messages.Enum):
    r"""Optional. Specifies the release channel for Gemini features. The
    release channel determines which set of features are available to the
    user.
