...
class GoogleCloudBeyondcorpSecuritygatewaysV1ContextualHeaders(_messages.Message):
  ...
  dispatchInfo = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1ContextualHeadersDelegatedDispatchInfo', 2)
  groupInfo = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1ContextualHeadersDelegatedGroupInfo', 3)
  outputType = _messages.EnumField('OutputTypeValueValuesEnum', 4)
  userInfo = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1ContextualHeadersDelegatedUserInfo', 5)
...
class GoogleCloudBeyondcorpSecuritygatewaysV1ContextualHeadersDelegatedDispatchInfo(_messages.Message):
