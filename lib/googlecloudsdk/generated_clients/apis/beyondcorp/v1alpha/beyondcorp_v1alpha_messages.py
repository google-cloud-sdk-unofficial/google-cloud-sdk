...
class GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnection(_messages.Message):
  ...
  Fields:
    ...
    connectors: Optional. List of
      [google.cloud.beyondcorp.v1main.Connector.name] that are authorized to
...
class GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfo(_messages.Message):
  r"""ResourceInfo represents the information or status of an app connector
  ...
  class SubscriberTypeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      CEP_TRIAL: Represents a trial subscription. This maps to the 'TRIAL'
        ...
        (google3/identity/cloud/contextawareaccess/billing/proto/enums.proto),
        but is named 'CEP_TRIAL' here to avoid a name collision with the
        'Type' enum defined above.
    """
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig(_messages.Message):
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGateway(_messages.Message):
  ...
  logging = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig', 6)
  name = _messages.StringField(7)
  proxyProtocolConfig = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaProxyProtocolConfig', 8)
  serviceDiscovery = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaServiceDiscovery', 9)
  state = _messages.EnumField('StateValueValuesEnum', 10)
  updateTime = _messages.StringField(11)
