...
class Cluster(_messages.Message):
  ...
  primaryZones = _messages.StringField(27, repeated=True)
...
class RedisProjectsLocationsClustersTokenAuthUsersAuthTokensCreateRequest(_messages.Message):
  r"""A RedisProjectsLocationsClustersTokenAuthUsersAuthTokensCreateRequest
  object.

  Fields:
    authToken: A AuthToken resource to be passed as the request body.
    parent: Required. The name of the token auth user resource that this auth
      token will be created for. Format: projects/{project}/locations/{locatio
      n}/clusters/{cluster}/tokenAuthUsers/{token_auth_user_id}
  """
...
class RedisProjectsLocationsClustersTokenAuthUsersAuthTokensDeleteRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of the token auth user resource that this auth
      ...
      on}/clusters/{cluster}/tokenAuthUsers/{token_auth_user_id}/authTokens/{a
      uth_token}
  """
...
class RedisProjectsLocationsClustersTokenAuthUsersAuthTokensGetRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of auth token for a token based auth enabled
      ...
      er}/tokenAuthUsers/{token_auth_user_id}/authTokens/{auth_token}
  """
...
class RedisProjectsLocationsClustersTokenAuthUsersAuthTokensListRequest(_messages.Message):
  ...
  Fields:
    ...
    parent: Required. The parent resource that this auth token will be listed
      ...
      tokenAuthUsers/{token_auth_user_id}
  """
...
class RedisProjectsLocationsClustersTokenAuthUsersCreateRequest(_messages.Message):
  r"""A RedisProjectsLocationsClustersTokenAuthUsersCreateRequest object.

  Fields:
    parent: Required. The parent resource that this token auth user will be
      created for. Format:
      projects/{project}/locations/{location}/clusters/{cluster}
    tokenAuthUser: A TokenAuthUser resource to be passed as the request body.
    tokenAuthUserId: Required. The id of the token auth user to create.
  """

  parent = _messages.StringField(1, required=True)
  tokenAuthUser = _messages.MessageField('TokenAuthUser', 2)
  tokenAuthUserId = _messages.StringField(3)
...
class RedisProjectsLocationsClustersTokenAuthUsersGetRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of token auth user for a token based auth enabled
      cluster. Format: projects/{project}/locations/{location}/clusters/{clust
      er}/tokenAuthUsers/{token_auth_user_id}
  """
