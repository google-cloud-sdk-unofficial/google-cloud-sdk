...
class RedisV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsAclPoliciesRevisionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(RedisV1beta1.ProjectsLocationsAclPoliciesRevisionsService, self).__init__(client)
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (RedisProjectsLocationsAclPoliciesRevisionsGetRequest) input message
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/aclPolicies/{aclPoliciesId}/revisions/{revisionsId}',
        http_method='GET',
        method_id='redis.projects.locations.aclPolicies.revisions.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}',
        request_field='',
        request_type_name='RedisProjectsLocationsAclPoliciesRevisionsGetRequest',
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (RedisProjectsLocationsAclPoliciesRevisionsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/aclPolicies/{aclPoliciesId}/revisions',
        http_method='GET',
        method_id='redis.projects.locations.aclPolicies.revisions.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1beta1/{+parent}/revisions',
        request_field='',
        request_type_name='RedisProjectsLocationsAclPoliciesRevisionsListRequest',
  ...
  class ProjectsLocationsAclPoliciesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(RedisV1beta1.ProjectsLocationsAclPoliciesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/aclPolicies',
        http_method='POST',
        method_id='redis.projects.locations.aclPolicies.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['aclPolicyId', 'requestId'],
        relative_path='v1beta1/{+parent}/aclPolicies',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/aclPolicies/{aclPoliciesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsClustersTokenAuthUsersAuthTokensService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(RedisV1beta1.ProjectsLocationsClustersTokenAuthUsersAuthTokensService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/tokenAuthUsers/{tokenAuthUsersId}/authTokens/{authTokensId}',
        http_method='DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/tokenAuthUsers/{tokenAuthUsersId}/authTokens',
        http_method='GET',
        method_id='redis.projects.locations.clusters.tokenAuthUsers.authTokens.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1beta1/{+parent}/authTokens',
        request_field='',
  ...
  class ProjectsLocationsClustersTokenAuthUsersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(RedisV1beta1.ProjectsLocationsClustersTokenAuthUsersService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    AddAuthToken.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/tokenAuthUsers/{tokenAuthUsersId}:addAuthToken',
        http_method='POST',
        ...
        query_params=[],
        relative_path='v1beta1/{+tokenAuthUser}:addAuthToken',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/tokenAuthUsers/{tokenAuthUsersId}',
        http_method='DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/tokenAuthUsers',
        http_method='GET',
        method_id='redis.projects.locations.clusters.tokenAuthUsers.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1beta1/{+parent}/tokenAuthUsers',
        request_field='',
  ...
  class ProjectsLocationsClustersService(base_api.BaseApiService):
    ...
    AddTokenAuthUser.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:addTokenAuthUser',
        http_method='POST',
        method_id='redis.projects.locations.clusters.addTokenAuthUser',
        ordered_params=['cluster'],
        path_params=['cluster'],
        query_params=[],
        relative_path='v1beta1/{+cluster}:addTokenAuthUser',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def GetSharedRegionalCertificateAuthority(self, request, global_params=None):
      r"""Gets the details of regional certificate authority information for Redis cluster.

      Args:
        request: (RedisProjectsLocationsGetSharedRegionalCertificateAuthorityRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    GetSharedRegionalCertificateAuthority.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/sharedRegionalCertificateAuthority',
        http_method='GET',
        method_id='redis.projects.locations.getSharedRegionalCertificateAuthority',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}',
        request_field='',
        request_type_name='RedisProjectsLocationsGetSharedRegionalCertificateAuthorityRequest',
