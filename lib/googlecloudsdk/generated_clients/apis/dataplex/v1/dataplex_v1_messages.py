...
class DataplexProjectsLocationsModifyEntryRequest(_messages.Message):
  r"""A DataplexProjectsLocationsModifyEntryRequest object.

  Fields:
    googleCloudDataplexV1ModifyEntryRequest: A
      GoogleCloudDataplexV1ModifyEntryRequest resource to be passed as the
      request body.
    name: Required. The project to which the request should be attributed in
      the following form: projects/{project}/locations/{location}.
  """

  googleCloudDataplexV1ModifyEntryRequest = _messages.MessageField('GoogleCloudDataplexV1ModifyEntryRequest', 1)
  name = _messages.StringField(2, required=True)
...
class GoogleCloudDataplexV1DataDiscoverySpecStorageConfig(_messages.Message):
  ...
  Fields:
    ...
    jsonOptions: Optional. Configuration for JSON data.
    unstructuredDataOptions: Optional. Specifies configuration for
  ...
  unstructuredDataOptions = _messages.MessageField('GoogleCloudDataplexV1DataDiscoverySpecStorageConfigUnstructuredDataOptions', 5)
...
class GoogleCloudDataplexV1DataDiscoverySpecStorageConfigUnstructuredDataOptions(_messages.Message):
...
class GoogleCloudDataplexV1DataDocumentationResult(_messages.Message):
  ...
  datasetResult = _messages.MessageField('GoogleCloudDataplexV1DataDocumentationResultDatasetResult', 1)
  tableResult = _messages.MessageField('GoogleCloudDataplexV1DataDocumentationResultTableResult', 2)


class GoogleCloudDataplexV1DataDocumentationResultDatasetResult(_messages.Message):
  ...
  Fields:
    ...
    schemaRelationships: Output only. Relationships suggesting how tables in
      the dataset are related to each other, based on their schema.
  """

  overview = _messages.StringField(1)
  queries = _messages.MessageField('GoogleCloudDataplexV1DataDocumentationResultQuery', 2, repeated=True)
  schemaRelationships = _messages.MessageField('GoogleCloudDataplexV1DataDocumentationResultSchemaRelationship', 3, repeated=True)
...
class GoogleCloudDataplexV1DataDocumentationResultSchemaRelationship(_messages.Message):
  r"""Details of the relationship between the schema of two resources.

  Enums:
    SourcesValueListEntryValuesEnum:
  ...
  Fields:
    leftSchemaPaths: Output only. An ordered list of fields for the join from
      ...
      right_schema_paths. Each field at index i in this list must correspond
      to a field at the same index in the right_schema_paths list.
    rightSchemaPaths: Output only. An ordered list of fields for the join from
      ...
      left_schema_paths. Each field at index i in this list must correspond to
      a field at the same index in the left_schema_paths list.
  ...
  class SourcesValueListEntryValuesEnum(_messages.Enum):
    r"""SourcesValueListEntryValuesEnum enum type.
  ...
  class TypeValueValuesEnum(_messages.Enum):
    r"""Output only. The type of relationship between the schema paths.
  ...
  leftSchemaPaths = _messages.MessageField('GoogleCloudDataplexV1DataDocumentationResultSchemaRelationshipSchemaPaths', 1)
  rightSchemaPaths = _messages.MessageField('GoogleCloudDataplexV1DataDocumentationResultSchemaRelationshipSchemaPaths', 2)
  sources = _messages.EnumField('SourcesValueListEntryValuesEnum', 3, repeated=True)
  type = _messages.EnumField('TypeValueValuesEnum', 4)


class GoogleCloudDataplexV1DataDocumentationResultSchemaRelationshipSchemaPaths(_messages.Message):
  ...
  Fields:
    paths: Output only. An ordered set of Paths to fields within the schema of
      the table. For fields nested within a top level field of type record,
      use '.' to separate field names. Examples: Top level field - top_level
      Nested field - top_level.child.sub_field
    tableFqn: Output only. The service-qualified full resource name of the
      table Ex: //bigquery.googleapis.com/projects/PROJECT_ID/datasets/DATASET
      _ID/tables/TABLE_ID
  """

  paths = _messages.StringField(1, repeated=True)
  tableFqn = _messages.StringField(2)
...
class GoogleCloudDataplexV1DataProfileSpec(_messages.Message):
  ...
  Enums:
    ModeValueValuesEnum: Optional. The execution mode for the profile scan.
  ...
  class ModeValueValuesEnum(_messages.Enum):
    r"""Optional. The execution mode for the profile scan.
  ...
  postScanActions = _messages.MessageField('GoogleCloudDataplexV1DataProfileSpecPostScanActions', 5)
  rowFilter = _messages.StringField(6)
...
class GoogleCloudDataplexV1DataScan(_messages.Message):
  ...
  Fields:
    ...
    displayName: Optional. User friendly display name. Must be between 1-256
      characters.
    executionIdentity: Optional. Immutable. The identity to run the datascan.
  ...
  executionIdentity = _messages.MessageField('GoogleCloudDataplexV1ExecutionIdentity', 13)
  executionSpec = _messages.MessageField('GoogleCloudDataplexV1DataScanExecutionSpec', 14)
  executionStatus = _messages.MessageField('GoogleCloudDataplexV1DataScanExecutionStatus', 15)
...
class GoogleCloudDataplexV1DataScanJob(_messages.Message):
  ...
  partialFailureMessage = _messages.StringField(13)
  startTime = _messages.StringField(14)
  state = _messages.EnumField('StateValueValuesEnum', 15)
...
class GoogleCloudDataplexV1ExecutionIdentity(_messages.Message):
  ...
  Fields:
    ...
    userCredential: Optional. The credential of the calling user. Supports
      only ONE_TIME trigger type.
  """

  dataplexServiceAgent = _messages.MessageField('GoogleCloudDataplexV1ExecutionIdentityDataplexServiceAgent', 1)
  serviceAccount = _messages.MessageField('GoogleCloudDataplexV1ExecutionIdentityServiceAccount', 2)
  userCredential = _messages.MessageField('GoogleCloudDataplexV1ExecutionIdentityUserCredential', 3)


class GoogleCloudDataplexV1ExecutionIdentityDataplexServiceAgent(_messages.Message):
  r"""The Dataplex service agent associated with the user's project."""


class GoogleCloudDataplexV1ExecutionIdentityServiceAccount(_messages.Message):
  r"""The service account

  Fields:
    email: Required. Service account email. The datascan will execute with
      this service account's credentials. The user calling this API must have
...
class GoogleCloudDataplexV1ExecutionIdentityUserCredential(_messages.Message):
...
class GoogleCloudDataplexV1ModifyEntryRequest(_messages.Message):
  ...
  Fields:
    aspectKeys: Optional. The aspect keys which the service should modify. It
      supports the following syntaxes: - matches an aspect of the given type
      and empty path. @path - matches an aspect of the given type and
      ...
      set to true.If this field is left empty, the service treats it as
      specifying exactly those Aspects present in the request.
    deleteMissingAspects: Optional. If set to true, any aspects not specified
      in the request will be deleted. The default is false.
  ...
  aspectKeys = _messages.StringField(1, repeated=True)
  deleteMissingAspects = _messages.BooleanField(2)
  entry = _messages.MessageField('GoogleCloudDataplexV1Entry', 3)
  updateMask = _messages.StringField(4)
