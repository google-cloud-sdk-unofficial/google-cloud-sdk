...
class DataplexV1(base_api.BaseApiClient):
  ...
  _PACKAGE = 'dataplex'
  _SCOPES = ['https://www.googleapis.com/auth/cloud-platform', 'https://www.googleapis.com/auth/cloud-platform.read-only', 'https://www.googleapis.com/auth/dataplex.read-write', 'https://www.googleapis.com/auth/dataplex.readonly']
  _VERSION = 'v1'
  ...
  class ProjectsLocationsDataProductsService(base_api.BaseApiService):
    ...
    def RequestAccess(self, request, global_params=None):
      r"""Requests access to a data product. This will trigger an access approval workflow, and the requester will need to wait for the approval to be granted before they will be able to access the data product assets.

      Args:
        request: (DataplexProjectsLocationsDataProductsRequestAccessRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudDataplexV1RequestDataProductAccessResponse) The response message.
      """
      config = self.GetMethodConfig('RequestAccess')
      return self._RunMethod(
          config, request, global_params=global_params)

    RequestAccess.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/dataProducts/{dataProductsId}:requestAccess',
        http_method='POST',
        method_id='dataplex.projects.locations.dataProducts.requestAccess',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}:requestAccess',
        request_field='googleCloudDataplexV1RequestDataProductAccessRequest',
        request_type_name='DataplexProjectsLocationsDataProductsRequestAccessRequest',
        response_type_name='GoogleCloudDataplexV1RequestDataProductAccessResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def ModifyEntry(self, request, global_params=None):
      r"""Modifies an entry using the permission on the source system.

      Args:
        request: (DataplexProjectsLocationsModifyEntryRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudDataplexV1Entry) The response message.
      """
      config = self.GetMethodConfig('ModifyEntry')
      return self._RunMethod(
          config, request, global_params=global_params)

    ModifyEntry.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}:modifyEntry',
        http_method='POST',
        method_id='dataplex.projects.locations.modifyEntry',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:modifyEntry',
        request_field='googleCloudDataplexV1ModifyEntryRequest',
        request_type_name='DataplexProjectsLocationsModifyEntryRequest',
        response_type_name='GoogleCloudDataplexV1Entry',
        supports_download=False,
    )
