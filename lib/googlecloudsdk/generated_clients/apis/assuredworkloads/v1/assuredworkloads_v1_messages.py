...
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsBatchAcknowledgeViolationsRequest(_messages.Message):
  ...
  Fields:
    googleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest: A
      GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest resource
  ...
  googleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest = _messages.MessageField('GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest', 1)
...
class GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest(_messages.Message):
