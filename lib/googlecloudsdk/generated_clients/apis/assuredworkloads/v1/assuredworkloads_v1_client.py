  ...
  class OrganizationsLocationsWorkloadsViolationsService(base_api.BaseApiService):
    ...
    def BatchAcknowledgeViolations(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsResponse) The response message.
      """
    ...
    BatchAcknowledgeViolations.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/workloads/{workloadsId}/violations:batchAcknowledgeViolations',
        http_method='POST',
        method_id='assuredworkloads.organizations.locations.workloads.violations.batchAcknowledgeViolations',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/violations:batchAcknowledgeViolations',
        request_field='googleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest',
        request_type_name='AssuredworkloadsOrganizationsLocationsWorkloadsViolationsBatchAcknowledgeViolationsRequest',
        response_type_name='GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsResponse',
        supports_download=False,
    )
