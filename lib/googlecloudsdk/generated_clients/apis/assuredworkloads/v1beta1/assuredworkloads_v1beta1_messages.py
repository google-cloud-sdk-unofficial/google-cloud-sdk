...
class GoogleCloudAssuredworkloadsV1beta1AggregateDbFrameworkComplianceReportResponse(_messages.Message):
  ...
  aggregatedComplianceReports = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1AggregatedComplianceReport', 1, repeated=True)


class GoogleCloudAssuredworkloadsV1beta1AggregatedComplianceReport(_messages.Message):
  ...
  controlAssessmentDetails = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1ControlAssessmentDetails', 1)
...
class GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1CELExpression(_messages.Message):
  ...
  resourceTypesValues = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1StringList', 2)


class GoogleCloudAssuredworkloadsV1beta1CloudControlAssessmentDetails(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1CloudControlReport(_messages.Message):
  ...
  cloudControlAssessmentDetails = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1CloudControlAssessmentDetails', 3)
  ...
  manualCloudControlAssessmentDetails = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1ManualCloudControlAssessmentDetails', 13)
  minorRevisionId = _messages.IntegerField(14)
  rules = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1Rule', 15, repeated=True)
  similarControls = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1SimilarControls', 16, repeated=True)


class GoogleCloudAssuredworkloadsV1beta1ControlAssessmentDetails(_messages.Message):
  ...
  class ComplianceRegimeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      ASSURED_WORKLOADS_FOR_PARTNERS: Specifies a [Sovereign Controls by
        ...
        partners/docs/overview) control package. To use this control package,
        you must also specify the partner field from the list of Sovereign
      ...
      REGIONAL_DATA_BOUNDARY: Data boundary for one of Assured Workloads'
        *Free tier* control packages. Determines the region by specifying the
        data location during workload creation.
      ...
      US_DATA_BOUNDARY_FOR_HEALTHCARE_AND_LIFE_SCIENCES_WITH_SUPPORT: United
        States (US) Data Boundary for Healthcare and Life Sciences with
        Support
      ...
      CA_REGIONS_AND_SUPPORT: Use the CANADA_DATA_BOUNDARY_AND_SUPPORT enum
        for this control package instead, as the name of the associated
        Assured Workloads control package has changed.
      CANADA_CONTROLLED_GOODS: Use the
        DATA_BOUNDARY_FOR_CANADA_CONTROLLED_GOODS enum for this control
      ...
      HEALTHCARE_AND_LIFE_SCIENCES_CONTROLS: Use the
        US_DATA_BOUNDARY_FOR_HEALTHCARE_AND_LIFE_SCIENCES enum for this
        control package instead, as the name of the associated Assured
        Workloads control package has changed.
      HEALTHCARE_AND_LIFE_SCIENCES_CONTROLS_US_SUPPORT: Use the
        US_DATA_BOUNDARY_FOR_HEALTHCARE_AND_LIFE_SCIENCES_WITH_SUPPORT enum
        for this control package instead, as the name of the associated
        Assured Workloads control package has changed.
      ...
      KSA_REGIONS_AND_SUPPORT_WITH_SOVEREIGNTY_CONTROLS: Use the
        KSA_DATA_BOUNDARY_WITH_ACCESS_JUSTIFICATIONS enum for this control
        package instead, as the name of the associated Assured Workloads
        control package has changed.
    ...
    ASSURED_WORKLOADS_FOR_PARTNERS = 1
    AUSTRALIA_DATA_BOUNDARY_AND_SUPPORT = 2
    CANADA_DATA_BOUNDARY_AND_SUPPORT = 3
    DATA_BOUNDARY_FOR_CANADA_CONTROLLED_GOODS = 4
    DATA_BOUNDARY_FOR_CANADA_PROTECTED_B = 5
    DATA_BOUNDARY_FOR_CJIS = 6
    DATA_BOUNDARY_FOR_FEDRAMP_HIGH = 7
    DATA_BOUNDARY_FOR_FEDRAMP_MODERATE = 8
    DATA_BOUNDARY_FOR_IL2 = 9
    DATA_BOUNDARY_FOR_IL4 = 10
    DATA_BOUNDARY_FOR_IL5 = 11
    DATA_BOUNDARY_FOR_IRS_PUBLICATION_1075 = 12
    DATA_BOUNDARY_FOR_ITAR = 13
...
class GoogleCloudAssuredworkloadsV1beta1DbControlComplianceSummary(_messages.Message):
  ...
  cloudControlReports = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1CloudControlReport', 1, repeated=True)
...
class GoogleCloudAssuredworkloadsV1beta1DbFrameworkComplianceSummary(_messages.Message):
  ...
  controlAssessmentDetails = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1ControlAssessmentDetails', 1)
  controlsPassingTrend = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1Trend', 2)
  findingCount = _messages.IntegerField(3)
  ...
  targetResourceDetails = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1TargetResourceDetails', 12, repeated=True)
...
class GoogleCloudAssuredworkloadsV1beta1FetchDbFrameworkComplianceReportResponse(_messages.Message):
  ...
  targetResourceDetails = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1TargetResourceDetails', 11, repeated=True)
  updateTime = _messages.StringField(12)


class GoogleCloudAssuredworkloadsV1beta1ListDbControlComplianceSummariesResponse(_messages.Message):
  ...
  dbControlComplianceSummaries = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1DbControlComplianceSummary', 1, repeated=True)
  nextPageToken = _messages.StringField(2)


class GoogleCloudAssuredworkloadsV1beta1ListDbFindingSummariesResponse(_messages.Message):
  ...
  dbFindingSummaries = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1DbFindingSummary', 1, repeated=True)
  nextPageToken = _messages.StringField(2)


class GoogleCloudAssuredworkloadsV1beta1ListDbFrameworkComplianceSummariesResponse(_messages.Message):
  ...
  dbFrameworkComplianceSummaries = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1DbFrameworkComplianceSummary', 1, repeated=True)
  nextPageToken = _messages.StringField(2)
...
class GoogleCloudAssuredworkloadsV1beta1ManualCloudControlAssessmentDetails(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1Rule(_messages.Message):
  ...
  celExpression = _messages.MessageField('GoogleCloudAssuredworkloadsV1beta1CELExpression', 1)
  description = _messages.StringField(2)
  ruleActionTypes = _messages.EnumField('RuleActionTypesValueListEntryValuesEnum', 3, repeated=True)


class GoogleCloudAssuredworkloadsV1beta1SimilarControls(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1StringList(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1TargetResourceDetails(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1Trend(_messages.Message):
...
class GoogleCloudAssuredworkloadsV1beta1Workload(_messages.Message):
  ...
  Fields:
    ...
    partnerServicesBillingAccount: Optional. Billing account necessary for
      ...
      creating SIA/PSN/CNTXT/Telefonica partner workloads. The caller should
      have 'billing.resourceAssociations.create' IAM permission on this
      billing-account. The format of this string is billingAccounts/AAAAAA-
      BBBBBB-CCCCCC
  ...
  class PartnerValueValuesEnum(_messages.Enum):
    ...
    SPAIN_DATA_BOUNDARY_BY_TELEFONICA = 7
