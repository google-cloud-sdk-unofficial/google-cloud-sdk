...
class DropInfo(_messages.Message):
  ...
  class CauseValueValuesEnum(_messages.Enum):
    ...
    FIREWALL_BLOCKING_LOAD_BALANCER_ENVOY_PROXY_HEALTH_CHECK = 27
    INGRESS_FIREWALL_TAGS_UNSUPPORTED_BY_DIRECT_VPC_EGRESS = 28
    INSTANCE_NOT_RUNNING = 29
    GKE_CLUSTER_NOT_RUNNING = 30
    GKE_POD_NOT_RUNNING = 31
    CLOUD_SQL_INSTANCE_NOT_RUNNING = 32
    REDIS_INSTANCE_NOT_RUNNING = 33
    REDIS_CLUSTER_NOT_RUNNING = 34
    ...
    DROPPED_INSIDE_DMS_PRIVATE_CONNECTION = 40
    DROPPED_INSIDE_DATASTREAM_PRIVATE_CONNECTION = 41
    ...
    PRIVATE_NAT_SOURCE_IP_IN_EXCLUDED_RANGE = 92
    PRIVATE_NAT_SOURCE_IP_IS_A_LINK_LOCAL_IP_IN_GKE = 93
...
class Endpoint(_messages.Message):
  ...
  Fields:
    ...
    cloudRunJob: A [Cloud Run](https://cloud.google.com/run) [job](https://doc
      s.cloud.google.com/run/docs/reference/rest/v2/projects.locations.jobs#Jo
      b) URI. Applicable only to source endpoint. The format is:
...
class PrivateConnectionInfo(_messages.Message):
  r"""For display only. Metadata associated with a Private Connection.

  Fields:
    uri: URI of the Private Connection in format "projects/{project_id}/locati
      ons/{location}/privateConnections/{private_connection_id}"
  """
...
class ProviderTag(_messages.Message):
  ...
  class ResourceTypeValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      MONITORING_POINT_RULE: This represents Provider Tag that a user manually
        assigns to a specific Rule within a Monitoring Policy. It is created
        when a user saves a Monitoring Policy with custom tags applied to its
        rules.
      MONITORING_POINT_RULE_AUTO: This represents auto-generated Provider Tags
        derived from the criteria defined in a Monitoring Point Rule (e.g.,
        Subnet, VLAN, Interface). If "Auto Network Rule Tagging" is enabled,
        the system automatically generates these tags based on the rule's
        filter values.
    """
...
class Step(_messages.Message):
  ...
  class StateValueValuesEnum(_messages.Enum):
    ...
    ARRIVE_AT_DIRECT_VPC_INGRESS_CONNECTION = 35
