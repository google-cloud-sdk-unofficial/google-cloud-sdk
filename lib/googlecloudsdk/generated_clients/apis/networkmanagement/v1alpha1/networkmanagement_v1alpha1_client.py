...
class NetworkmanagementV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsNetworkMonitoringProvidersMonitoringPointsService(base_api.BaseApiService):
    ...
    DownloadInstallScript.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['_password', 'hostname', 'monitoringPointType', 'ntpServerAddress', 'ntpServerSecondaryAddress', 'privateConnectivityEnabled', 'staticIpAddress_dnsServerAddress', 'staticIpAddress_dnsServerSecondaryAddress', 'staticIpAddress_domain', 'staticIpAddress_gatewayAddress', 'staticIpAddress_ipAddress', 'staticIpAddress_netmask', 'timeZone_id', 'timeZone_version', 'useDhcp'],
  ...
  class ProjectsLocationsNetworkMonitoringProvidersService(base_api.BaseApiService):
    ...
    GenerateMonitoringPointConfig.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['privateConnectivityEnabled'],
