...
class CloudidentityV1(base_api.BaseApiClient):
  ...
  class AllowlistedDomainsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudidentityV1.AllowlistedDomainsService, self).__init__(client)
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[],
        query_params=[],
        relative_path='v1/allowlistedDomains',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/allowlistedDomains/{allowlistedDomainsId}',
        http_method='DELETE',
