...
class GoogleCloudGkerecommenderV1alpha1GenerateOptimizationSetManifestRequest(_messages.Message):
...
class GoogleCloudGkerecommenderV1alpha1GenerateOptimizationSetManifestResponse(_messages.Message):
