...
class NetworkconnectivityV1(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_locations_automatedDnsRecords = self.ProjectsLocationsAutomatedDnsRecordsService(self)
    ...
    self.projects_locations_pscAuthorizationPolicies = self.ProjectsLocationsPscAuthorizationPoliciesService(self)
  ...
  class ProjectsLocationsAutomatedDnsRecordsService(base_api.BaseApiService):
    """Service class for the projects_locations_automatedDnsRecords resource."""

    _NAME = 'projects_locations_automatedDnsRecords'

    def __init__(self, client):
      super(NetworkconnectivityV1.ProjectsLocationsAutomatedDnsRecordsService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new AutomatedDnsRecord in a given project and location.

      Args:
        request: (NetworkconnectivityProjectsLocationsAutomatedDnsRecordsCreateRequest) input message
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/automatedDnsRecords',
        http_method='POST',
        method_id='networkconnectivity.projects.locations.automatedDnsRecords.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['automatedDnsRecordId', 'insertMode', 'requestId'],
        relative_path='v1/{+parent}/automatedDnsRecords',
        request_field='automatedDnsRecord',
        request_type_name='NetworkconnectivityProjectsLocationsAutomatedDnsRecordsCreateRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )

    def Delete(self, request, global_params=None):
      r"""Deletes a single AutomatedDnsRecord.

      Args:
        request: (NetworkconnectivityProjectsLocationsAutomatedDnsRecordsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/automatedDnsRecords/{automatedDnsRecordsId}',
        http_method='DELETE',
        method_id='networkconnectivity.projects.locations.automatedDnsRecords.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['deleteMode', 'etag', 'requestId'],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsAutomatedDnsRecordsDeleteRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets details of a single AutomatedDnsRecord.

      Args:
        request: (NetworkconnectivityProjectsLocationsAutomatedDnsRecordsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (AutomatedDnsRecord) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/automatedDnsRecords/{automatedDnsRecordsId}',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.automatedDnsRecords.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsAutomatedDnsRecordsGetRequest',
        response_type_name='AutomatedDnsRecord',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists AutomatedDnsRecords in a given project and location.

      Args:
        request: (NetworkconnectivityProjectsLocationsAutomatedDnsRecordsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListAutomatedDnsRecordsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/automatedDnsRecords',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.automatedDnsRecords.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/automatedDnsRecords',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsAutomatedDnsRecordsListRequest',
        response_type_name='ListAutomatedDnsRecordsResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsPscAuthorizationPoliciesService(base_api.BaseApiService):
    """Service class for the projects_locations_pscAuthorizationPolicies resource."""

    _NAME = 'projects_locations_pscAuthorizationPolicies'

    def __init__(self, client):
      super(NetworkconnectivityV1.ProjectsLocationsPscAuthorizationPoliciesService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new PscAuthorizationPolicy in a given project and location.

      Args:
        request: (NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/pscAuthorizationPolicies',
        http_method='POST',
        method_id='networkconnectivity.projects.locations.pscAuthorizationPolicies.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pscAuthorizationPolicyId', 'requestId'],
        relative_path='v1/{+parent}/pscAuthorizationPolicies',
        request_field='pscAuthorizationPolicy',
        request_type_name='NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesCreateRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )

    def Delete(self, request, global_params=None):
      r"""Deletes a single PscAuthorizationPolicy.

      Args:
        request: (NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/pscAuthorizationPolicies/{pscAuthorizationPoliciesId}',
        http_method='DELETE',
        method_id='networkconnectivity.projects.locations.pscAuthorizationPolicies.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['etag', 'requestId'],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesDeleteRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets details of a single PscAuthorizationPolicy.

      Args:
        request: (NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (PscAuthorizationPolicy) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/pscAuthorizationPolicies/{pscAuthorizationPoliciesId}',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.pscAuthorizationPolicies.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesGetRequest',
        response_type_name='PscAuthorizationPolicy',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists PscAuthorizationPolicies in a given project and location.

      Args:
        request: (NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListPscAuthorizationPoliciesResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/pscAuthorizationPolicies',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.pscAuthorizationPolicies.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/pscAuthorizationPolicies',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsPscAuthorizationPoliciesListRequest',
        response_type_name='ListPscAuthorizationPoliciesResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsRemoteTransportProfilesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworkconnectivityV1.ProjectsLocationsRemoteTransportProfilesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (RemoteTransportProfile) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/remoteTransportProfiles/{remoteTransportProfilesId}',
        http_method='GET',
        ...
        response_type_name='RemoteTransportProfile',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListRemoteTransportProfilesResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/remoteTransportProfiles',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.remoteTransportProfiles.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/remoteTransportProfiles',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsRemoteTransportProfilesListRequest',
        response_type_name='ListRemoteTransportProfilesResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsServiceConnectionPoliciesService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['autoSubnetworkConfig_allocRangeSpace', 'autoSubnetworkConfig_ipStack', 'autoSubnetworkConfig_prefixLength', 'requestId', 'serviceConnectionPolicyId', 'subnetworkMode'],
  ...
  class ProjectsLocationsTransportsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworkconnectivityV1.ProjectsLocationsTransportsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/transports',
        http_method='POST',
        method_id='networkconnectivity.projects.locations.transports.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'transportId'],
        relative_path='v1/{+parent}/transports',
        request_field='transport',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/transports/{transportsId}',
        http_method='DELETE',
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Transport) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListTransportsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        response_type_name='ListTransportsResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def CheckConsumerConfig(self, request, global_params=None):
      r"""CheckConsumerConfig validates the consumer network and project for potential PSC connection creation. This method performs several checks, including: - Validating the existence and permissions of the service class. - Ensuring the consumer network exists and is accessible. - Verifying XPN relationships if applicable. - Checking for compatible IP versions between the consumer network and the requested version. This method performs a dynamic IAM check for the `networkconnectivity.serviceClasses.use` permission on the service class resource in the Prepare phase.

      Args:
        request: (NetworkconnectivityProjectsLocationsCheckConsumerConfigRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (CheckConsumerConfigResponse) The response message.
      """
      config = self.GetMethodConfig('CheckConsumerConfig')
      return self._RunMethod(
          config, request, global_params=global_params)

    CheckConsumerConfig.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}:checkConsumerConfig',
        http_method='POST',
        method_id='networkconnectivity.projects.locations.checkConsumerConfig',
        ordered_params=['location'],
        path_params=['location'],
        query_params=[],
        relative_path='v1/{+location}:checkConsumerConfig',
        request_field='checkConsumerConfigRequest',
        request_type_name='NetworkconnectivityProjectsLocationsCheckConsumerConfigRequest',
        response_type_name='CheckConsumerConfigResponse',
        supports_download=False,
    )
