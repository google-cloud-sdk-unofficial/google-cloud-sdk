...
class AutoCreatedSubnetworkInfo(_messages.Message):
  r"""Information for the automatically created subnetwork and its associated
  IR.

  Fields:
    delinked: Output only. Indicates whether the subnetwork is delinked from
      the Service Connection Policy. Only set if the subnetwork mode is
      AUTO_CREATED during creation.
    internalRange: Output only. URI of the automatically created Internal
      Range. Only set if the subnetwork mode is AUTO_CREATED during creation.
    ...
    subnetworkRef: Output only. URI of the automatically created subnetwork
      reference. Only set if the subnetwork mode is AUTO_CREATED during
      creation.
  """

  delinked = _messages.BooleanField(1)
  internalRange = _messages.StringField(2)
  internalRangeRef = _messages.StringField(3)
  subnetwork = _messages.StringField(4)
  subnetworkRef = _messages.StringField(5)


class AutomatedDnsCreationSpec(_messages.Message):
  r"""The specification for automatically creating a DNS record.

  Fields:
    dnsSuffix: Required. The DNS suffix to use for the DNS record. Must end
      with a dot. This should be a valid DNS domain name as per RFC 1035. Each
      label (between dots) can contain letters, digits, and hyphens, and must
      not start or end with a hyphen. Example: "my-service.example.com.",
      "internal."
    hostname: Required. The hostname (the first label of the FQDN) to use for
      the DNS record. This should be a valid DNS label as per RFC 1035.
      Generally, this means the hostname can contain letters, digits, and
      hyphens, and must not start or end with a hyphen. Example: "my-
      instance", "db-1"
...
class AutomatedDnsRecord(_messages.Message):
  r"""Represents a DNS record managed by the AutomatedDnsRecord API.

  Enums:
    CreationModeValueValuesEnum: Required. Immutable. The creation mode of the
      AutomatedDnsRecord. This field is immutable.
    RecordTypeValueValuesEnum: Required. Immutable. The identifier of a
      supported record type.
    StateValueValuesEnum: Output only. The current operational state of this
  ...
  Fields:
    consumerNetwork: Required. Immutable. The full resource path of the
      consumer network this AutomatedDnsRecord is visible to. Example:
    ...
    currentConfig: Output only. The current settings for this record as
      ...
      Cloud DNS based on the `hostname`, `dns_suffix`, and `type`. *
      **Absence:** If `current_config` is unset, it means a DNS record with
      the specified `hostname`, `dns_suffix`, and `type` does not currently
      exist in Cloud DNS. This could be because the `AutomatedDnsRecord` has
      never been successfully programmed, has been deleted, or there was an
      error during provisioning. * **Presence:** If `current_config` is
      present: * It can be different from the `original_config`. This can
      happen due to several reasons: * Out-of-band changes: A consumer might
      have directly modified the DNS record in Cloud DNS. * `OVERWRITE`
      operations from other `AutomatedDnsRecord` resources: Another
      `AutomatedDnsRecord` with the same identifying attributes (`hostname`,
      `dns_suffix`, `type`) but a different configuration might have
    ...
    dnsSuffix: Required. Immutable. The dns suffix for this record to use in
      longest-suffix matching. Requires a trailing dot. Example:
      "example.com."
    dnsZone: Output only. DnsZone is the DNS zone managed by automation.
    ...
    hostname: Required. Immutable. The hostname for the DNS record. This value
      will be prepended to the `dns_suffix` to create the full domain name
      (FQDN) for the record. For example, if `hostname` is "corp.db" and
      `dns_suffix` is "example.com.", the resulting record will be
      "corp.db.example.com.". Should not include a trailing dot.
    labels: Optional. User-defined labels.
    name: Immutable. Identifier. The name of an AutomatedDnsRecord. Format: pr
      ojects/{project}/locations/{location}/automatedDnsRecords/{automated_dns
      _record} See: https://google.aip.dev/122#fields-representing-resource-
      names
    ...
    recordType: Required. Immutable. The identifier of a supported record
      type.
  ...
  class CreationModeValueValuesEnum(_messages.Enum):
    r"""Required. Immutable. The creation mode of the AutomatedDnsRecord. This
    field is immutable.

    Values:
      CREATION_MODE_UNSPECIFIED: Default value. This value is unused.
      CONSUMER_API: The record was created through the AutomatedDnsRecord CCFE
        consumer API.
    ...
    CONSUMER_API = 1
    SERVICE_CONNECTION_MAP = 2

  class RecordTypeValueValuesEnum(_messages.Enum):
    r"""Required. Immutable. The identifier of a supported record type.
  ...
  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. The current operational state of this AutomatedDnsRecord
  ...
  creationMode = _messages.EnumField('CreationModeValueValuesEnum', 3)
  currentConfig = _messages.MessageField('Config', 4)
  description = _messages.StringField(5)
  dnsSuffix = _messages.StringField(6)
  dnsZone = _messages.StringField(7)
  etag = _messages.StringField(8)
  fqdn = _messages.StringField(9)
  hostname = _messages.StringField(10)
  labels = _messages.MessageField('LabelsValue', 11)
  name = _messages.StringField(12)
  originalConfig = _messages.MessageField('Config', 13)
  recordType = _messages.EnumField('RecordTypeValueValuesEnum', 14)
  serviceClass = _messages.StringField(15)
...
class CheckConsumerConfigRequest(_messages.Message):
  r"""Request for CheckConsumerConfig.

  Enums:
    RequestedIpVersionValueValuesEnum: The requested IP Version
  ...
  class RequestedIpVersionValueValuesEnum(_messages.Enum):
    r"""The requested IP Version
  ...
  consumerNetwork = _messages.StringField(1)
  endpointProject = _messages.StringField(2)
  requestedIpVersion = _messages.EnumField('RequestedIpVersionValueValuesEnum', 3)
  serviceClass = _messages.StringField(4)


class CheckConsumerConfigResponse(_messages.Message):
  r"""Response for CheckConsumerConfig.

  Enums:
    ErrorsValueListEntryValuesEnum:

  Fields:
    errors: List of validation errors. If the list is empty, the consumer
      config is valid.
  """
  ...
  class ErrorsValueListEntryValuesEnum(_messages.Enum):
    ...
    """
    ERROR_UNSPECIFIED = 0
    NETWORK_PROJECT_INVALID = 1
    NETWORK_PROJECT_APIS_NOT_ENABLED = 2
    NETWORK_INVALID = 3
    CONNECTION_POLICY_MISSING = 4
    IP_VERSION_NOT_SUPPORTED = 5
    NETWORK_PROJECT_SERVICE_AGENT_NOT_FOUND = 6
    ENDPOINT_PROJECT_INVALID = 7
    ENDPOINT_PROJECT_API_NOT_ENABLED = 8
    ENDPOINT_PROJECT_IS_NOT_SERVICE_PROJECT = 9

  errors = _messages.EnumField('ErrorsValueListEntryValuesEnum', 1, repeated=True)


class Config(_messages.Message):
  r"""Defines the configuration of a DNS record.

  Fields:
    rrdatas: Required. The list of resource record data strings. The content
      and format of these strings depend on the AutomatedDnsRecord.type. For
      many common record types, this list may contain multiple strings. As
      defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1) -- see
      examples. Examples: A record: ["192.0.2.1"] or ["192.0.2.1",
      "192.0.2.2"] TXT record: ["This is a text record"] CNAME record:
      ["target.example.com."] AAAA record: ["::1"] or
  ...
  rrdatas = _messages.StringField(1, repeated=True)
...
class ConsumerPscConfig(_messages.Message):
  ...
  Messages:
    ...
    ServiceAttachmentIpAddressMapValue: Optional. A map to store mapping
      between customer vip and target service attachment. This field can be
      used to specify a static IP address for a PSC connection.
  ...
  class ServiceAttachmentIpAddressMapValue(_messages.Message):
    r"""Optional. A map to store mapping between customer vip and target
    service attachment. This field can be used to specify a static IP address
    for a PSC connection.
...
class ConsumerPscConnection(_messages.Message):
  ...
  Fields:
    dnsAutomationStatus: Output only. The status of DNS automation for this
      PSC connection.
  ...
  dnsAutomationStatus = _messages.MessageField('DnsAutomationStatus', 1)
  error = _messages.MessageField('GoogleRpcStatus', 2)
  errorInfo = _messages.MessageField('GoogleRpcErrorInfo', 3)
  ...
  ip = _messages.StringField(7)
  ipVersion = _messages.EnumField('IpVersionValueValuesEnum', 8)
  network = _messages.StringField(9)
  producerInstanceId = _messages.StringField(10)
  producerInstanceMetadata = _messages.MessageField('ProducerInstanceMetadataValue', 11)
  project = _messages.StringField(12)
  pscConnectionId = _messages.StringField(13)
  selectedSubnetwork = _messages.StringField(14)
  serviceAttachmentUri = _messages.StringField(15)
  state = _messages.EnumField('StateValueValuesEnum', 16)
...
class DnsAutomationStatus(_messages.Message):
  r"""The status of DNS automation for a PSC connection.

  Enums:
    StateValueValuesEnum: Output only. The current state of DNS automation.
  ...
  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. The current state of DNS automation.
...
class ListAutomatedDnsRecordsResponse(_messages.Message):
  r"""Response for ListAutomatedDnsRecords.
  ...
  automatedDnsRecords = _messages.MessageField('AutomatedDnsRecord', 1, repeated=True)
...
class ListRemoteTransportProfilesResponse(_messages.Message):
  ...
  nextPageToken = _messages.StringField(1)
  remoteTransportProfiles = _messages.MessageField('RemoteTransportProfile', 2, repeated=True)
  unreachable = _messages.StringField(3, repeated=True)
...
class ListTransportsResponse(_messages.Message):
  ...
  nextPageToken = _messages.StringField(1)
  transports = _messages.MessageField('Transport', 2, repeated=True)
  unreachable = _messages.StringField(3, repeated=True)
...
class NetworkconnectivityProjectsLocationsAutomatedDnsRecordsCreateRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsAutomatedDnsRecordsCreateRequest
  object.

  Enums:
    InsertModeValueValuesEnum: Optional. The insert mode when creating
      AutomatedDnsRecord.

  Fields:
    automatedDnsRecord: A AutomatedDnsRecord resource to be passed as the
      request body.
  ...
  class InsertModeValueValuesEnum(_messages.Enum):
    r"""Optional. The insert mode when creating AutomatedDnsRecord.
    ...
    """
    INSERT_MODE_UNSPECIFIED = 0
    FAIL_IF_EXISTS = 1
    OVERWRITE = 2

  automatedDnsRecord = _messages.MessageField('AutomatedDnsRecord', 1)
  automatedDnsRecordId = _messages.StringField(2)
  insertMode = _messages.EnumField('InsertModeValueValuesEnum', 3)
  parent = _messages.StringField(4, required=True)
  requestId = _messages.StringField(5)


class NetworkconnectivityProjectsLocationsAutomatedDnsRecordsDeleteRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsAutomatedDnsRecordsDeleteRequest
  object.

  Enums:
    DeleteModeValueValuesEnum: Optional. Delete mode when deleting
      AutomatedDnsRecord. If set to DEPROGRAM, the record will be deprogrammed
      in Cloud DNS. If set to SKIP_DEPROGRAMMING, the record will not be
      deprogrammed in Cloud DNS.

  Fields:
    deleteMode: Optional. Delete mode when deleting AutomatedDnsRecord. If set
      to DEPROGRAM, the record will be deprogrammed in Cloud DNS. If set to
  ...
  class DeleteModeValueValuesEnum(_messages.Enum):
    r"""Optional. Delete mode when deleting AutomatedDnsRecord. If set to
    DEPROGRAM, the record will be deprogrammed in Cloud DNS. If set to
    SKIP_DEPROGRAMMING, the record will not be deprogrammed in Cloud DNS.
    ...
    DEPROGRAM = 1
    SKIP_DEPROGRAMMING = 2

  deleteMode = _messages.EnumField('DeleteModeValueValuesEnum', 1)
  etag = _messages.StringField(2)
  name = _messages.StringField(3, required=True)
  requestId = _messages.StringField(4)


class NetworkconnectivityProjectsLocationsAutomatedDnsRecordsGetRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsAutomatedDnsRecordsGetRequest
  object.

  Fields:
    name: Required. Name of the AutomatedDnsRecord to get. Format: projects/{p
      roject}/locations/{location}/automatedDnsRecords/{automated_dns_record}
  """

  name = _messages.StringField(1, required=True)


class NetworkconnectivityProjectsLocationsAutomatedDnsRecordsListRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsAutomatedDnsRecordsListRequest
  object.
...
class NetworkconnectivityProjectsLocationsCheckConsumerConfigRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsCheckConsumerConfigRequest object.

  Fields:
    checkConsumerConfigRequest: A CheckConsumerConfigRequest resource to be
      passed as the request body.
    location: Required. The location resource path. Example: -
      projects/{project}/locations/{location}
  """

  checkConsumerConfigRequest = _messages.MessageField('CheckConsumerConfigRequest', 1)
...
class NetworkconnectivityProjectsLocationsServiceConnectionPoliciesCreateRequest(_messages.Message):
  ...
  Enums:
    AutoSubnetworkConfigIpStackValueValuesEnum: Optional. The requested IP
      stack for the subnetwork. If not specified, IPv4 is used.
    SubnetworkModeValueValuesEnum: Optional. If this field is not set,
      USER_PROVIDED is the inferred value to use.

  Fields:
    autoSubnetworkConfig_allocRangeSpace: Optional. The space where we search
      for a free range to create a subnetwork. It can be narrow down or pick a
      different space. This is in standard CIDR format. If not specified,
    ...
    autoSubnetworkConfig_prefixLength: Optional. The desired prefix length for
      the subnet's IP address range. E.g., 24 for a /24. The actual range is
    ...
    serviceConnectionPolicyId: Optional. Resource ID (i.e. 'foo' in
      ...
      https://google.aip.dev/122#resource-id-segments Unique per location.
    subnetworkMode: Optional. If this field is not set, USER_PROVIDED is the
      inferred value to use.
  """

  class AutoSubnetworkConfigIpStackValueValuesEnum(_messages.Enum):
    r"""Optional. The requested IP stack for the subnetwork. If not specified,
    IPv4 is used.
    ...
    """
    SUBNET_IP_STACK_UNSPECIFIED = 0
    IPV4_ONLY = 1
    IPV6_ONLY = 2
    IPV4_IPV6 = 3

  class SubnetworkModeValueValuesEnum(_messages.Enum):
    r"""Optional. If this field is not set, USER_PROVIDED is the inferred
    value to use.
    ...
    Values:
      ...
      AUTO_CREATED: Subnetwork list is empty from the user input. A subnetwork
        will be created automatically.
    """
    SUBNETWORK_MODE_UNSPECIFIED = 0
    USER_PROVIDED = 1
    AUTO_CREATED = 2

  autoSubnetworkConfig_allocRangeSpace = _messages.StringField(1, repeated=True)
  autoSubnetworkConfig_ipStack = _messages.EnumField('AutoSubnetworkConfigIpStackValueValuesEnum', 2)
  autoSubnetworkConfig_prefixLength = _messages.IntegerField(3, variant=_messages.Variant.INT32)
  parent = _messages.StringField(4, required=True)
  requestId = _messages.StringField(5)
  serviceConnectionPolicy = _messages.MessageField('ServiceConnectionPolicy', 6)
  serviceConnectionPolicyId = _messages.StringField(7)
  subnetworkMode = _messages.EnumField('SubnetworkModeValueValuesEnum', 8)
...
class NetworkconnectivityProjectsLocationsTransportsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    requestId: Optional. An optional request ID to identify requests. Specify
      ...
      The request ID must be a valid UUID with the exception that zero UUID is
      not supported (00000000-0000-0000-0000-000000000000).
    transport: A Transport resource to be passed as the request body.
    transportId: Required. Id of the requesting object
  """

  parent = _messages.StringField(1, required=True)
  requestId = _messages.StringField(2)
  transport = _messages.MessageField('Transport', 3)
...
class RemoteTransportProfile(_messages.Message):
...
class ServiceConnectionPolicy(_messages.Message):
  ...
  autoCreatedSubnetInfo = _messages.MessageField('AutoCreatedSubnetworkInfo', 1)
  createTime = _messages.StringField(2)
  description = _messages.StringField(3)
  etag = _messages.StringField(4)
  ...
  name = _messages.StringField(7)
  network = _messages.StringField(8)
  pscConfig = _messages.MessageField('PscConfig', 9)
  pscConnections = _messages.MessageField('PscConnection', 10, repeated=True)
  serviceClass = _messages.StringField(11)
  updateTime = _messages.StringField(12)
  ...
  class StateValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      DEPROVISIONED: The Transport was deleted on the remote provider's end
        and is no longer operational. GCP has insufficient information to move
        the resource back to PENDING_KEY state.
    """
    STATE_UNSPECIFIED = 0
    CREATING = 1
    PENDING_CONFIG = 2
...
encoding.AddCustomJsonFieldMapping(
    NetworkconnectivityProjectsLocationsServiceConnectionPoliciesCreateRequest, 'autoSubnetworkConfig_allocRangeSpace', 'autoSubnetworkConfig.allocRangeSpace')
encoding.AddCustomJsonFieldMapping(
    NetworkconnectivityProjectsLocationsServiceConnectionPoliciesCreateRequest, 'autoSubnetworkConfig_ipStack', 'autoSubnetworkConfig.ipStack')
encoding.AddCustomJsonFieldMapping(
    NetworkconnectivityProjectsLocationsServiceConnectionPoliciesCreateRequest, 'autoSubnetworkConfig_prefixLength', 'autoSubnetworkConfig.prefixLength')
encoding.AddCustomJsonFieldMapping(
