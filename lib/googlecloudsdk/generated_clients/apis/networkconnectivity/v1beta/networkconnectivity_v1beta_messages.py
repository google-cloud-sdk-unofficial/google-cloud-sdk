...
class GoogleCloudNetworkconnectivityV1betaGetStatusResponse(_messages.Message):
  r"""Message for the response to getting a Transport's operational status.

  Enums:
    ConnectivityStatusValueValuesEnum: Current status of connectivity to the
      local GCP resource. This reflects whether the VPC Peering or NCC Hub
      appears correctly configured.
    MacSecStatusValueValuesEnum: Current status of MACSec on the underlying
      network connectivity between GC and the partner.
    OperationalStatusValueValuesEnum: The operational status of the underlying
      networking components.
    OverallStatusValueValuesEnum: The overall status of the Transport. This
      field will always output the most critical status of the Transport. For
      example, if the connectivity is DISCONNECTED, and the underlying
      networking components are DOWN, then the overall status will be DOWN.

  Fields:
    connectivityStatus: Current status of connectivity to the local GCP
      resource. This reflects whether the VPC Peering or NCC Hub appears
      correctly configured.
    macSecStatus: Current status of MACSec on the underlying network
      connectivity between GC and the partner.
    operationalStatus: The operational status of the underlying networking
      components.
    overallStatus: The overall status of the Transport. This field will always
      output the most critical status of the Transport. For example, if the
      connectivity is DISCONNECTED, and the underlying networking components
      are DOWN, then the overall status will be DOWN.
  """

  class ConnectivityStatusValueValuesEnum(_messages.Enum):
    r"""Current status of connectivity to the local GCP resource. This
    reflects whether the VPC Peering or NCC Hub appears correctly configured.

    Values:
      CONNECTIVITY_STATUS_UNSPECIFIED: Unspecified status.
      CONNECTIVITY_STATUS_CONNECTED: VPC Peering or the NCC Hub appear to be
        correctly established.
      CONNECTIVITY_STATUS_DISCONNECTED: VPC Peering has been taken down, or
        the NCC Spoke has been rejected.
    """
    CONNECTIVITY_STATUS_UNSPECIFIED = 0
    CONNECTIVITY_STATUS_CONNECTED = 1
    CONNECTIVITY_STATUS_DISCONNECTED = 2

  class MacSecStatusValueValuesEnum(_messages.Enum):
    r"""Current status of MACSec on the underlying network connectivity
    between GC and the partner.

    Values:
      MAC_SEC_STATUS_UNSPECIFIED: Unspecified status.
      MAC_SEC_STATUS_ACTIVE_FAIL_CLOSED: MACSec is protecting the links and
        configured in fail closed.
      MAC_SEC_STATUS_ACTIVE_FAIL_OPEN: MACSec is protecting the links and
        configured to fail open on at least one of the redundant links.
      MAC_SEC_STATUS_NOT_CONFIGURED: MACSec is not configured on at least one
  ...
  class OperationalStatusValueValuesEnum(_messages.Enum):
    r"""The operational status of the underlying networking components.

    Values:
      OPERATIONAL_STATUS_UNSPECIFIED: Unspecified status.
      OPERATIONAL_STATUS_ACTIVE: Protected capacity is available and
        networking components show as up.
      OPERATIONAL_STATUS_DOWN: Protected capacity is showing as operationally
        down.
    """
  ...
  class OverallStatusValueValuesEnum(_messages.Enum):
    r"""The overall status of the Transport. This field will always output the
    most critical status of the Transport. For example, if the connectivity is
    DISCONNECTED, and the underlying networking components are DOWN, then the
    overall status will be DOWN.

    Values:
      OVERALL_STATUS_UNSPECIFIED: Unspecified status.
      ACTIVE: Resource is active and operational.
      PENDING_KEY: Resource is waiting for an activation key to be exchanged.
      CONFIGURING: Activation keys have been exchanged and connectivity is
        being established.
      DISCONNECTED: VPC Peering has been taken down, or the NCC Spoke has been
        rejected.
      DOWN: User configuration is correct, but the configured capacity is
        operationally down.
    """
  ...
  connectivityStatus = _messages.EnumField('ConnectivityStatusValueValuesEnum', 1)
  macSecStatus = _messages.EnumField('MacSecStatusValueValuesEnum', 2)
  operationalStatus = _messages.EnumField('OperationalStatusValueValuesEnum', 3)
  overallStatus = _messages.EnumField('OverallStatusValueValuesEnum', 4)
...
class GoogleCloudNetworkconnectivityV1betaParseFromActivationKeyResponse(_messages.Message):
  r"""Message for response to getting a RemoteTransportProfile from an
  activation key.

  Fields:
    remoteTransportProfile: The RemoteTransportProfile that was parsed from
      the activation key.
  """

  remoteTransportProfile = _messages.MessageField('GoogleCloudNetworkconnectivityV1betaRemoteTransportProfile', 1)
...
class GoogleCloudNetworkconnectivityV1betaTransport(_messages.Message):
  ...
  autoAccept = _messages.BooleanField(3)
  bandwidth = _messages.EnumField('BandwidthValueValuesEnum', 4)
  createTime = _messages.StringField(5)
  description = _messages.StringField(6)
  generatedActivationKey = _messages.StringField(7)
  hub = _messages.StringField(8)
  labels = _messages.MessageField('LabelsValue', 9)
  mtuLimit = _messages.IntegerField(10, variant=_messages.Variant.INT32)
  name = _messages.StringField(11)
  network = _messages.StringField(12)
  peeringNetwork = _messages.StringField(13)
  providedActivationKey = _messages.StringField(14)
  pscRoutingEnabled = _messages.BooleanField(15)
  remoteAccountId = _messages.StringField(16)
  remoteProfile = _messages.StringField(17)
...
class NetworkconnectivityProjectsLocationsRemoteTransportProfilesFromActivationKeyRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsRemoteTransportProfilesFromActivat
  ionKeyRequest object.

  Fields:
    activationKey: Required. The activation key to get the
      RemoteTransportProfile for.
    parent: Required. Parent value for ParseFromActivationKeyRequest.
  """
...
class NetworkconnectivityProjectsLocationsTransportsGetStatusRequest(_messages.Message):
  r"""A NetworkconnectivityProjectsLocationsTransportsGetStatusRequest object.

  Fields:
    name: Required. Name of the resource.
    skipCache: Optional. If set to true, the response will bypass any caches
      and return the freshest possible data.
  """

  name = _messages.StringField(1, required=True)
  skipCache = _messages.BooleanField(2)
