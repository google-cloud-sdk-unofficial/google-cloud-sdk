...
class NetworkconnectivityV1beta(base_api.BaseApiClient):
  ...
  class ProjectsLocationsRemoteTransportProfilesService(base_api.BaseApiService):
    ...
    def FromActivationKey(self, request, global_params=None):
      r"""Gets details of a single RemoteTransportProfile given an activation key.

      Args:
        request: (NetworkconnectivityProjectsLocationsRemoteTransportProfilesFromActivationKeyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudNetworkconnectivityV1betaParseFromActivationKeyResponse) The response message.
      """
      config = self.GetMethodConfig('FromActivationKey')
      return self._RunMethod(
          config, request, global_params=global_params)

    FromActivationKey.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/remoteTransportProfiles:fromActivationKey',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.remoteTransportProfiles.fromActivationKey',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['activationKey'],
        relative_path='v1beta/{+parent}/remoteTransportProfiles:fromActivationKey',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsRemoteTransportProfilesFromActivationKeyRequest',
        response_type_name='GoogleCloudNetworkconnectivityV1betaParseFromActivationKeyResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsTransportsService(base_api.BaseApiService):
    ...
    def GetStatus(self, request, global_params=None):
      r"""Gets the operational status of a single Transport.

      Args:
        request: (NetworkconnectivityProjectsLocationsTransportsGetStatusRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudNetworkconnectivityV1betaGetStatusResponse) The response message.
      """
    ...
    GetStatus.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/transports/{transportsId}:getStatus',
        http_method='GET',
        method_id='networkconnectivity.projects.locations.transports.getStatus',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['skipCache'],
        relative_path='v1beta/{+name}:getStatus',
        request_field='',
        request_type_name='NetworkconnectivityProjectsLocationsTransportsGetStatusRequest',
        response_type_name='GoogleCloudNetworkconnectivityV1betaGetStatusResponse',
        supports_download=False,
    )
