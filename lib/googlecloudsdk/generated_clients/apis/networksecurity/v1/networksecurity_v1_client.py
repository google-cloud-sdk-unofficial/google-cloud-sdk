...
class NetworksecurityV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsMirroringEndpointsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworksecurityV1.ProjectsLocationsMirroringEndpointsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/mirroringEndpoints',
        http_method='POST',
        method_id='networksecurity.projects.locations.mirroringEndpoints.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['mirroringEndpointId', 'requestId'],
        relative_path='v1/{+parent}/mirroringEndpoints',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/mirroringEndpoints/{mirroringEndpointsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsUllMirroringCollectorsRulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworksecurityV1.ProjectsLocationsUllMirroringCollectorsRulesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringCollectors/{ullMirroringCollectorsId}/rules',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringCollectors/{ullMirroringCollectorsId}/rules/{rulesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsUllMirroringCollectorsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworksecurityV1.ProjectsLocationsUllMirroringCollectorsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringCollectors',
        http_method='POST',
        method_id='networksecurity.projects.locations.ullMirroringCollectors.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'ullMirroringCollectorId'],
        relative_path='v1/{+parent}/ullMirroringCollectors',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringCollectors/{ullMirroringCollectorsId}',
        http_method='DELETE',
    ...
    Disable.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringCollectors/{ullMirroringCollectorsId}:disable',
        http_method='POST',
    ...
    Enable.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringCollectors/{ullMirroringCollectorsId}:enable',
        http_method='POST',
  ...
  class ProjectsLocationsUllMirroringEnginesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworksecurityV1.ProjectsLocationsUllMirroringEnginesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringEngines',
        http_method='POST',
        method_id='networksecurity.projects.locations.ullMirroringEngines.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'ullMirroringEngineId'],
        relative_path='v1/{+parent}/ullMirroringEngines',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringEngines/{ullMirroringEnginesId}',
        http_method='DELETE',
    ...
    ListNetworks.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/ullMirroringEngines/{ullMirroringEnginesId}:listNetworks',
        http_method='POST',
        method_id='networksecurity.projects.locations.ullMirroringEngines.listNetworks',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:listNetworks',
