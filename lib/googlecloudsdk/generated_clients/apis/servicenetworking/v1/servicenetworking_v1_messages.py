...
class ConsumerConfig(_messages.Message):
  ...
  consumerPeeringActive = _messages.BooleanField(6)
  producerExportCustomRoutes = _messages.BooleanField(7)
  producerExportSubnetRoutesWithPublicIp = _messages.BooleanField(8)
  producerImportCustomRoutes = _messages.BooleanField(9)
  producerImportSubnetRoutesWithPublicIp = _messages.BooleanField(10)
  producerNetwork = _messages.StringField(11)
  reservedRanges = _messages.MessageField('GoogleCloudServicenetworkingV1ConsumerConfigReservedRange', 12, repeated=True)
  usedIpRanges = _messages.StringField(13, repeated=True)
  vpcScReferenceArchitectureEnabled = _messages.BooleanField(14)
