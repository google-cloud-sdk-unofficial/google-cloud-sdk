...
class ApigeeOrganizationsSecurityMonitoringConditionsDeleteRequest(_messages.Message):
  ...
  class RiskAssessmentTypeValueValuesEnum(_messages.Enum):
    r"""Optional. The risk assessment type of the security monitoring
    condition. Defaults to ADVANCED_API_SECURITY.
...
class ApigeeOrganizationsSecurityMonitoringConditionsListRequest(_messages.Message):
  ...
  pageToken = _messages.StringField(3)
  parent = _messages.StringField(4, required=True)
  riskAssessmentType = _messages.EnumField('RiskAssessmentTypeValueValuesEnum', 5)
...
class GoogleCloudApigeeV1RuntimeTraceConfig(_messages.Message):
  ...
  Fields:
    ...
    openTelemetryProtocolEnabled: Optional. If `true`, the runtime uses
      ...
      `Exporter`s: `CLOUD_TRACE` or `OPEN_TELEMETRY_COLLECTOR`. - If
...
class GoogleCloudApigeeV1SecurityAssessmentResultResource(_messages.Message):
  ...
  Enums:
    ApiHubGatewayTypeValueValuesEnum: Optional.
    TypeValueValuesEnum: Required. Type of this resource.
  ...
  class ApiHubGatewayTypeValueValuesEnum(_messages.Enum):
    r"""Optional.
  ...
  apiHubGatewayType = _messages.EnumField('ApiHubGatewayTypeValueValuesEnum', 2)
  name = _messages.StringField(3)
  resourceRevisionId = _messages.StringField(4)
  type = _messages.EnumField('TypeValueValuesEnum', 5)
...
class GoogleCloudApigeeV1SecurityMonitoringCondition(_messages.Message):
  ...
  Fields:
    apiHubGateway: Optional. The API Hub gateway monitored by the security
      ...
      API_HUB. Format: `projects/{project}/locations/{location}/plugins/{plugi
    ...
    scope: Optional. Scope of the security monitoring condition. When
      RiskAssessmentType is APIGEE, the scope should be set to the environment
      of the resources. When RiskAssessmentType is API_HUB, the scope should
      not be set.
  ...
  apiHubGateway = _messages.StringField(1)
  createTime = _messages.StringField(2)
  include = _messages.MessageField('GoogleCloudApigeeV1BatchComputeSecurityAssessmentResultsRequestResourceArray', 3)
  includeAllResources = _messages.MessageField('GoogleCloudApigeeV1BatchComputeSecurityAssessmentResultsRequestIncludeAll', 4)
  name = _messages.StringField(5)
  profile = _messages.StringField(6)
  riskAssessmentType = _messages.EnumField('RiskAssessmentTypeValueValuesEnum', 7)
  scope = _messages.StringField(8)
  totalDeployedResources = _messages.IntegerField(9, variant=_messages.Variant.INT32)
  totalMonitoredResources = _messages.IntegerField(10, variant=_messages.Variant.INT32)
