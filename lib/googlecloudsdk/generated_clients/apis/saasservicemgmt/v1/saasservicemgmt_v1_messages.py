"""Generated message classes for saasservicemgmt version v1.
...
class UnitKind(_messages.Message):
  ...
  annotations = _messages.MessageField('AnnotationsValue', 1)
  boundaryType = _messages.EnumField('BoundaryTypeValueValuesEnum', 2)
  createTime = _messages.StringField(3)
  defaultFlagRevisions = _messages.StringField(4, repeated=True)
  defaultRelease = _messages.StringField(5)
  dependencies = _messages.MessageField('Dependency', 6, repeated=True)
  etag = _messages.StringField(7)
  inputVariableMappings = _messages.MessageField('VariableMapping', 8, repeated=True)
  labels = _messages.MessageField('LabelsValue', 9)
  name = _messages.StringField(10)
  outputVariableMappings = _messages.MessageField('VariableMapping', 11, repeated=True)
  saas = _messages.StringField(12)
