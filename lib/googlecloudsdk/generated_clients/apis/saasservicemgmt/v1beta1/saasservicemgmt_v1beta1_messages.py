...
class AppParams(_messages.Message):
...
class ComponentRef(_messages.Message):
  ...
  compositeRef = _messages.MessageField('CompositeRef', 2)
...
class DynamicAllocation(_messages.Message):
  r"""Allocation to be dynamically updated by a Rollout. This is the
  name/template of the allocation.

  Fields:
    description: Optional. Description of the dynamic allocation. Max length:
      500 bytes.
    finalVariant: Required. The name of the target variant of the launch - the
      one that should be at 100%.
    id: Required. Allocation ID. Max length: 128 bytes.
    initialVariant: Required. The name of the "starting" variant during the
      launch - the one at 0%.
    randomizedOn: Required. The attribute used for randomization.
    salt: Optional. Salt for the dynamic allocation. By default, the user
      should not provide the salt - the system should provide a default salt
  ...
  randomizedOn = _messages.StringField(5)
  salt = _messages.StringField(6)
...
class EvaluationSpec(_messages.Message):
  ...
  Fields:
    ...
    defaultAllocation: Optional. The ID of an allocation to use as the
      default.
    defaultDynamicAllocation: Optional. The ID of a dynamic allocation to use
      as the default.
    ...
    dynamicAllocations: Optional. A list of dynamic allocations.
  ...
  defaultDynamicAllocation = _messages.StringField(4)
  defaultTarget = _messages.StringField(5)
  defaultVariant = _messages.StringField(6)
  dynamicAllocations = _messages.MessageField('DynamicAllocation', 7, repeated=True)
  rules = _messages.MessageField('EvaluationRule', 8, repeated=True)
  variants = _messages.MessageField('Variant', 9, repeated=True)
...
class Flag(_messages.Message):
  ...
  Enums:
    FlagValueTypeValueValuesEnum: Optional. Immutable. Flag value type.
    StateValueValuesEnum: Optional. Current state of the flag.
    ValueTypeValueValuesEnum: Optional. Immutable. Deprecated: Use
      `flag_value_type` instead. Flag value type.
  ...
  class FlagValueTypeValueValuesEnum(_messages.Enum):
    r"""Optional. Immutable. Flag value type.
    ...
    FLAG_VALUE_TYPE_BOOLEAN = 1
    FLAG_VALUE_TYPE_INTEGER = 2
    FLAG_VALUE_TYPE_STRING = 3
    FLAG_VALUE_TYPE_DOUBLE = 4

  class StateValueValuesEnum(_messages.Enum):
    r"""Optional. Current state of the flag.
    ...
    FLAG_STATE_IN_DEVELOPMENT = 1
    FLAG_STATE_ACTIVE = 2
    FLAG_STATE_SUNSETTING = 3
    FLAG_STATE_CLEANUP = 4

  class ValueTypeValueValuesEnum(_messages.Enum):
    r"""Optional. Immutable. Deprecated: Use `flag_value_type` instead. Flag
    value type.
  ...
  flagValueType = _messages.EnumField('FlagValueTypeValueValuesEnum', 7)
  ...
  valueType = _messages.EnumField('ValueTypeValueValuesEnum', 15)
...
class FlagAttribute(_messages.Message):
  ...
  Enums:
    AttributeValueTypeValueValuesEnum: Optional. Immutable. Type of the
      attribute.
    ValueTypeValueValuesEnum: Optional. Immutable. Deprecated: Use
      `attribute_value_type` instead. Type of the attribute.
  ...
  class AttributeValueTypeValueValuesEnum(_messages.Enum):
    r"""Optional. Immutable. Type of the attribute.
    ...
    FLAG_ATTRIBUTE_VALUE_TYPE_BOOLEAN = 1
    FLAG_ATTRIBUTE_VALUE_TYPE_INTEGER = 2
    FLAG_ATTRIBUTE_VALUE_TYPE_STRING = 3
    FLAG_ATTRIBUTE_VALUE_TYPE_DOUBLE = 4

  class ValueTypeValueValuesEnum(_messages.Enum):
    r"""Optional. Immutable. Deprecated: Use `attribute_value_type` instead.
  ...
  annotations = _messages.MessageField('AnnotationsValue', 1)
  attributeValueType = _messages.EnumField('AttributeValueTypeValueValuesEnum', 2)
...
class FlagRelease(_messages.Message):
  ...
  Fields:
    ...
    obsoleteFlags: Optional. Immutable. Deprecated: Use the 'state' field in
      the 'Flag' resource to manage the cleanup of flag lifecycles including
      removal from UnitKind and Units. Flags to be removed from given UnitKind
      and all related Units. If Flag is provided here, its FlagRevisions will
      be removed from UnitKind and Units.
    uid: Output only. The unique identifier of the resource. UID is unique in
      the time and space for this resource within the scope of the service. It
      is typically generated by the server on successful creation of a
      resource and must not be changed. UID is used to uniquely identify
  ...
  allFlagsRelease = _messages.BooleanField(2)
...
class FlagRevisionList(_messages.Message):
  r"""Wrapper for a list of flag revisions.

  Fields:
    revisions: Required. FlagRevisions to be rolled out.
  """

  revisions = _messages.StringField(1, repeated=True)


class FlagSetList(_messages.Message):
  r"""Wrapper for a list of flag sets.

  Fields:
    sets: Required. Flag sets to be rolled out.
  """

  sets = _messages.StringField(1, repeated=True)
...
class FlagVariant(_messages.Message):
  ...
  Fields:
    ...
    trackingId: Optional. trackingId is unique depending on name and value of
      the variant within the scope of the service. It is typically generated
      by the server and must not be changed. trackingId is used to uniquely
...
class Release(_messages.Message):
  ...
  annotations = _messages.MessageField('AnnotationsValue', 1)
  applicationTemplateComponent = _messages.MessageField('ComponentRef', 2)
...
class Saas(_messages.Message):
  ...
  Enums:
    StateValueValuesEnum: Output only. State of the Saas. It is always in
      STATE_ACTIVE state if the application_template is empty.
  ...
  Fields:
    ...
    applicationTemplate: Reference to composite ApplicationTemplate. When
      specified, the template components will be imported into their
      equivalent UnitKind, Release and Blueprint resources. Deleted references
      will not delete imported resources. Should only be specified on source
      regions, and be unspecified on replica regions.
    ...
    state: Output only. State of the Saas. It is always in STATE_ACTIVE state
  ...
  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. State of the Saas. It is always in STATE_ACTIVE state if
  ...
  annotations = _messages.MessageField('AnnotationsValue', 1)
  applicationTemplate = _messages.MessageField('CompositeRef', 2)
  blueprintRepo = _messages.StringField(3)
  conditions = _messages.MessageField('SaasCondition', 4, repeated=True)
  createTime = _messages.StringField(5)
  error = _messages.MessageField('Status', 6)
  etag = _messages.StringField(7)
  labels = _messages.MessageField('LabelsValue', 8)
  locations = _messages.MessageField('Location', 9, repeated=True)
  name = _messages.StringField(10)
  state = _messages.EnumField('StateValueValuesEnum', 11)
  uid = _messages.StringField(12)
...
class SaasservicemgmtProjectsLocationsSaasReleasesPatchRequest(_messages.Message):
  r"""A SaasservicemgmtProjectsLocationsSaasReleasesPatchRequest object.
...
class SaasservicemgmtProjectsLocationsUnitGroupOperationsPatchRequest(_messages.Message):
  r"""A SaasservicemgmtProjectsLocationsUnitGroupOperationsPatchRequest
  object.
  ...
  Fields:
    ...
    updateMask: Optional. Field mask is used to specify the fields to be
      overwritten in the UnitGroupOperation resource by the update. The fields
      specified in the update_mask are relative to the resource, not the full
      request. A field will be overwritten if it is in the mask. If the user
      does not provide a mask then all fields in the UnitGroupOperation will
      be overwritten.
    validateOnly: Optional. If "validate_only" is set to true, the service
      will try to validate that this request would succeed, but will not
      actually make changes.
...
class SaasservicemgmtProjectsLocationsUnitGroupsPatchRequest(_messages.Message):
  r"""A SaasservicemgmtProjectsLocationsUnitGroupsPatchRequest object.
...
class Unit(_messages.Message):
  ...
  Fields:
    annotations: Optional. Annotations is an unstructured key-value map stored
      ...
      modifying objects. More info: https://kubernetes.io/docs/user-
      guide/annotations
    application: Optional. Reference to the AppHub Application this unit
      belongs to. All resources deployed in this Unit will be associated with
    ...
    etag: Output only. An opaque value that uniquely identifies a version or
      generation of a resource. It can be used to confirm that the client and
      server agree on the ordering of a resource being written.
    flagConfigName: Output only. This field stores the unique identifier for
      the flag configuration to be used by this Unit.
  ...
  etag = _messages.StringField(7)
  flagConfigName = _messages.StringField(8)
  flagRevisions = _messages.StringField(9, repeated=True)
  inputVariables = _messages.MessageField('UnitVariable', 10, repeated=True)
  labels = _messages.MessageField('LabelsValue', 11)
  maintenance = _messages.MessageField('MaintenanceSettings', 12)
  managementMode = _messages.EnumField('ManagementModeValueValuesEnum', 13)
  ...
  scheduledOperations = _messages.StringField(21, repeated=True)
  state = _messages.EnumField('StateValueValuesEnum', 22)
  systemCleanupAt = _messages.StringField(23)
  systemManagedState = _messages.EnumField('SystemManagedStateValueValuesEnum', 24)
  tenant = _messages.StringField(25)
  uid = _messages.StringField(26)
  unitGroup = _messages.StringField(27)
...
class UnitKind(_messages.Message):
  ...
  Enums:
    BoundaryTypeValueValuesEnum: Optional. Output only. BoundaryType describes
      the type of boundary the Unit Kind represents.
  ...
  class BoundaryTypeValueValuesEnum(_messages.Enum):
    r"""Optional. Output only. BoundaryType describes the type of boundary the
    ...
    BOUNDARY_TYPE_MANAGED_PROJECT = 2
  ...
  annotations = _messages.MessageField('AnnotationsValue', 1)
  appParams = _messages.MessageField('AppParams', 2)
  applicationTemplateComponent = _messages.MessageField('ComponentRef', 3)
  boundaryType = _messages.EnumField('BoundaryTypeValueValuesEnum', 4)
  createTime = _messages.StringField(5)
  defaultFlagRevisions = _messages.StringField(6, repeated=True)
  defaultRelease = _messages.StringField(7)
  dependencies = _messages.MessageField('Dependency', 8, repeated=True)
  etag = _messages.StringField(9)
  inputVariableMappings = _messages.MessageField('VariableMapping', 10, repeated=True)
  labels = _messages.MessageField('LabelsValue', 11)
  name = _messages.StringField(12)
  outputVariableMappings = _messages.MessageField('VariableMapping', 13, repeated=True)
  saas = _messages.StringField(14)
