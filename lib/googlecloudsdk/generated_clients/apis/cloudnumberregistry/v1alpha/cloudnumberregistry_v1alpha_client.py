...
class CloudnumberregistryV1alpha(base_api.BaseApiClient):
  ...
  class OrganizationsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudnumberregistryV1alpha.OrganizationsLocationsOperationsService, self).__init__(client)
    ...
    def Cancel(self, request, global_params=None):
      ...
      Args:
        request: (CloudnumberregistryOrganizationsLocationsOperationsCancelRequest) input message
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='POST',
        method_id='cloudnumberregistry.organizations.locations.operations.cancel',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}:cancel',
        request_field='cancelOperationRequest',
        request_type_name='CloudnumberregistryOrganizationsLocationsOperationsCancelRequest',
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (CloudnumberregistryOrganizationsLocationsOperationsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='cloudnumberregistry.organizations.locations.operations.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='CloudnumberregistryOrganizationsLocationsOperationsDeleteRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (CloudnumberregistryOrganizationsLocationsOperationsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/operations/{operationsId}',
        http_method='GET',
        method_id='cloudnumberregistry.organizations.locations.operations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='CloudnumberregistryOrganizationsLocationsOperationsGetRequest',
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (CloudnumberregistryOrganizationsLocationsOperationsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='GET',
        method_id='cloudnumberregistry.organizations.locations.operations.list',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['filter', 'pageSize', 'pageToken', 'returnPartialSuccess'],
        relative_path='v1alpha/{+name}/operations',
        request_field='',
        request_type_name='CloudnumberregistryOrganizationsLocationsOperationsListRequest',
