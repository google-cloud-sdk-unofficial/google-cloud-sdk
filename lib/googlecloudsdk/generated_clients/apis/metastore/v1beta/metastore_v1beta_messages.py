...
class MigrationExecution(_messages.Message):
  ...
  Enums:
    PhaseValueValuesEnum: Output only. Deprecated: Phase was designed for
      incoming migrations to Dataproc Metastore, not applicable when migrating
      away from it. The current phase of the migration execution.
  ...
  class PhaseValueValuesEnum(_messages.Enum):
    r"""Output only. Deprecated: Phase was designed for incoming migrations to
    Dataproc Metastore, not applicable when migrating away from it. The
    current phase of the migration execution.
