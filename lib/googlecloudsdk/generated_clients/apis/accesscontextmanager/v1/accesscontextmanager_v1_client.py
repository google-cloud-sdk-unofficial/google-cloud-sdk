...
class AccesscontextmanagerV1(base_api.BaseApiClient):
  ...
  class AccessPoliciesAccessLevelsService(base_api.BaseApiService):
    ...
    def TestIamPermissions(self, request, global_params=None):
      r"""Returns the IAM permissions that the caller has on the specified Access Context Manager resource. The resource can be an AccessPolicy, AccessLevel, or ServicePerimeter. This method does not support other resources. **IAM Permissions**: No specific IAM permission is required to call this method. It returns the subset of the requested permissions that the caller possesses.
  ...
  class AccessPoliciesServicePerimetersService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['deletedPrincipalSyntax'],
        relative_path='v1/{+name}',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['deletedPrincipalSyntax', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/servicePerimeters',
        request_field='',
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['deletedPrincipalSyntax', 'updateMask'],
        relative_path='v1/{+name}',
        request_field='servicePerimeter',
  ...
  class ServicesService(base_api.BaseApiService):
    ...
    def Get(self, request, global_params=None):
      r"""Returns a VPC-SC supported service based on the service name. **IAM Permissions**: Requires the following IAM permissions to use this method: - `serviceusage.services.use` on the project.
    ...
    def List(self, request, global_params=None):
      r"""Lists all VPC-SC supported services. **IAM Permissions**: Requires the following IAM permissions to use this method: - `serviceusage.services.use` on the project.
