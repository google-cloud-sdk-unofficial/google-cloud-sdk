...
class AccesscontextmanagerV1alpha(base_api.BaseApiClient):
  ...
  class FoldersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AccesscontextmanagerV1alpha.FoldersService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    LookupConfiguredServicePerimeter.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}:lookupConfiguredServicePerimeter',
        http_method='GET',
        method_id='accesscontextmanager.folders.lookupConfiguredServicePerimeter',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha/{+resource}:lookupConfiguredServicePerimeter',
        request_field='',
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AccesscontextmanagerV1alpha.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    LookupConfiguredServicePerimeter.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}:lookupConfiguredServicePerimeter',
        http_method='GET',
