  ...
  class MethodValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      RELAXED_EXTRACT: Attempts to extract the position and value as-is from
        the document text. If the value cannot be grounded in the text, it
        falls back to derivation through inference, for both position and
        value. Note: The inference fallback is currently only supported for
        boolean entities.
    """
...
class GoogleCloudDocumentaiV1DocumentShardInfo(_messages.Message):
  ...
  Fields:
    pageOffset: The index of the first page in Document.pages in the overall
      document global pages. Available for document shards created by the
      document splitter.
  ...
  pageOffset = _messages.IntegerField(1, variant=_messages.Variant.INT32)
  shardCount = _messages.IntegerField(2)
  shardIndex = _messages.IntegerField(3)
  textOffset = _messages.IntegerField(4)
