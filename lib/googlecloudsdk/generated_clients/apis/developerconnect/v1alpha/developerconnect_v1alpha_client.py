...
class DeveloperconnectV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsAccountConnectorsService(base_api.BaseApiService):
    ...
    FetchUserRepositories.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/accountConnectors/{accountConnectorsId}:fetchUserRepositories',
        http_method='GET',
        ...
        relative_path='v1alpha/{+accountConnector}:fetchUserRepositories',
        request_field='',
