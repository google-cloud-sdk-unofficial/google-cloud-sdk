...
class ServiceusageV2beta(base_api.BaseApiClient):
  ...
  class CatalogsMembersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ServiceusageV2beta.CatalogsMembersService, self).__init__(client)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta/{v2betaId}/{v2betaId1}/catalogs/{catalogsId}/members',
        http_method='GET',
  ...
  class CatalogsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ServiceusageV2beta.CatalogsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class McpPoliciesService(base_api.BaseApiService):
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleApiServiceusageV2betaMcpPolicy) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        response_type_name='GoogleApiServiceusageV2betaMcpPolicy',
        supports_download=False,
    )
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=['force', 'validateOnly'],
        relative_path='v2beta/{+name}',
        request_field='googleApiServiceusageV2betaMcpPolicy',
  ...
  class ServicesDependentServicesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ServiceusageV2beta.ServicesDependentServicesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta/{v2betaId}/{v2betaId1}/services/{servicesId}/dependentServices',
        http_method='GET',
        method_id='serviceusage.services.dependentServices.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v2beta/{+parent}/dependentServices',
        request_field='',
