...
class FieldViolation(_messages.Message):
  ...
  Fields:
    ...
    field: A path that leads to a field in the request body. The value will be
      ...
      first `email_addresses` message * `email_addresses[2].type[1]` for a
      ...
      violation in the `fullName` value * `emailAddresses[0].email` for a
      violation in the `email` field of the first `emailAddresses` message *
      `emailAddresses[2].type[1]` for a violation in the second `type` value
...
class PostgresHomogeneousConfig(_messages.Message):
  ...
  maxAdditionalSubscriptions = _messages.IntegerField(2, variant=_messages.Variant.INT32)
