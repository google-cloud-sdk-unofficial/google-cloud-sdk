...
class EdgecontainerV1(base_api.BaseApiClient):
  ...
  class OrganizationsLocationsZonesZonalProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.OrganizationsLocationsZonesZonalProjectsService, self).__init__(client)
    ...
    Enable.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/zones/{zonesId}/zonalProjects:enable',
        http_method='POST',
        method_id='edgecontainer.organizations.locations.zones.zonalProjects.enable',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'zonalProjectId'],
        relative_path='v1/{+parent}/zonalProjects:enable',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/zones/{zonesId}/zonalProjects/{zonalProjectsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/zones/{zonesId}/zonalProjects',
        http_method='GET',
        method_id='edgecontainer.organizations.locations.zones.zonalProjects.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/zonalProjects',
        request_field='',
  ...
  class OrganizationsLocationsZonesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.OrganizationsLocationsZonesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/zones/{zonesId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/zones',
        http_method='GET',
  ...
  class OrganizationsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.OrganizationsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class OrganizationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.OrganizationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsApiKeysService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsApiKeysService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/apiKeys',
        http_method='POST',
        method_id='edgecontainer.projects.locations.apiKeys.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['apiKeyId', 'requestId'],
        relative_path='v1/{+parent}/apiKeys',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/apiKeys/{apiKeysId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsServiceAccountsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsServiceAccountsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    DescribeKey.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/serviceAccounts/{serviceAccountsId}:describeKey',
        http_method='POST',
        method_id='edgecontainer.projects.locations.serviceAccounts.describeKey',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}:describeKey',
    ...
    DisableKey.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/serviceAccounts/{serviceAccountsId}:disableKey',
        http_method='POST',
        method_id='edgecontainer.projects.locations.serviceAccounts.disableKey',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}:disableKey',
    ...
    GenerateKey.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/serviceAccounts/{serviceAccountsId}:generateKey',
        http_method='POST',
        method_id='edgecontainer.projects.locations.serviceAccounts.generateKey',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:generateKey',
    ...
    ListKeys.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/serviceAccounts/{serviceAccountsId}:listKeys',
        http_method='GET',
        method_id='edgecontainer.projects.locations.serviceAccounts.listKeys',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1/{+parent}:listKeys',
        request_field='',
  ...
  class ProjectsLocationsZonalServicesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsZonalServicesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Enable.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/zonalServices:enable',
        http_method='POST',
        method_id='edgecontainer.projects.locations.zonalServices.enable',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/zonalServices:enable',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/zonalServices/{zonalServicesId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/zonalServices',
        http_method='GET',
        method_id='edgecontainer.projects.locations.zonalServices.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/zonalServices',
        request_field='',
  ...
  class ProjectsLocationsZonesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsZonesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/zones/{zonesId}:getIamPolicy',
        http_method='GET',
        method_id='edgecontainer.projects.locations.zones.getIamPolicy',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:getIamPolicy',
        request_field='',
    ...
    ListRoles.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/zones/{zonesId}:roles',
        http_method='GET',
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/zones/{zonesId}:setIamPolicy',
        http_method='POST',
        method_id='edgecontainer.projects.locations.zones.setIamPolicy',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setIamPolicy',
