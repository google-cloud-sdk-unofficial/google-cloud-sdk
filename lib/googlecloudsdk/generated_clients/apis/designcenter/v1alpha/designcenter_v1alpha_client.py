...
class DesigncenterV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsSpacesApplicationTemplatesRevisionsService(base_api.BaseApiService):
    ...
    Export.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/revisions/{revisionsId}:export',
        http_method='POST',
  ...
  class ProjectsLocationsSpacesApplicationTemplatesSystemRevisionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DesigncenterV1alpha.ProjectsLocationsSpacesApplicationTemplatesSystemRevisionsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/systemRevisions/{systemRevisionsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/systemRevisions',
        http_method='GET',
        method_id='designcenter.projects.locations.spaces.applicationTemplates.systemRevisions.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/systemRevisions',
        request_field='',
  ...
  class ProjectsLocationsSpacesApplicationTemplatesService(base_api.BaseApiService):
    ...
    Export.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}:export',
        http_method='POST',
  ...
  class ProjectsLocationsSpacesApplicationsService(base_api.BaseApiService):
    ...
    FetchAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applications/{applicationsId}:fetchAssessmentReport',
        http_method='GET',
    ...
    GenerateAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applications/{applicationsId}:generateAssessmentReport',
        http_method='POST',
  ...
  class ProjectsLocationsSpacesService(base_api.BaseApiService):
    ...
    GenerateTerraformPlanAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}:generateTerraformPlanAssessmentReport',
        http_method='POST',
        method_id='designcenter.projects.locations.spaces.generateTerraformPlanAssessmentReport',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}:generateTerraformPlanAssessmentReport',
    ...
    RegisterAppHubApplicationResources.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/spaces:registerAppHubApplicationResources',
        http_method='POST',
        method_id='designcenter.projects.locations.spaces.registerAppHubApplicationResources',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1alpha/{+parent}/spaces:registerAppHubApplicationResources',
