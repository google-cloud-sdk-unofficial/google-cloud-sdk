...
class DesigncenterV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsSpacesApplicationTemplatesPoliciesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DesigncenterV1.ProjectsLocationsSpacesApplicationTemplatesPoliciesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/policies',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/policies/{policiesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsSpacesApplicationTemplatesSystemRevisionsService(base_api.BaseApiService):
    """Service class for the projects_locations_spaces_applicationTemplates_systemRevisions resource."""

    _NAME = 'projects_locations_spaces_applicationTemplates_systemRevisions'

    def __init__(self, client):
      super(DesigncenterV1.ProjectsLocationsSpacesApplicationTemplatesSystemRevisionsService, self).__init__(client)
      self._upload_configs = {
          }

    def Get(self, request, global_params=None):
      r"""Gets the given application template system revision.

      Args:
        request: (DesigncenterProjectsLocationsSpacesApplicationTemplatesSystemRevisionsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ApplicationTemplateSystemRevision) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/systemRevisions/{systemRevisionsId}',
        http_method='GET',
        method_id='designcenter.projects.locations.spaces.applicationTemplates.systemRevisions.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='DesigncenterProjectsLocationsSpacesApplicationTemplatesSystemRevisionsGetRequest',
        response_type_name='ApplicationTemplateSystemRevision',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists application template system revisions in a given application template.

      Args:
        request: (DesigncenterProjectsLocationsSpacesApplicationTemplatesSystemRevisionsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListApplicationTemplateSystemRevisionsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}/systemRevisions',
        http_method='GET',
        method_id='designcenter.projects.locations.spaces.applicationTemplates.systemRevisions.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/systemRevisions',
        request_field='',
        request_type_name='DesigncenterProjectsLocationsSpacesApplicationTemplatesSystemRevisionsListRequest',
        response_type_name='ListApplicationTemplateSystemRevisionsResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsSpacesApplicationTemplatesService(base_api.BaseApiService):
    ...
    GenerateAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}:generateAssessmentReport',
        http_method='POST',
    ...
    Snapshot.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/applicationTemplates/{applicationTemplatesId}:snapshot',
        http_method='POST',
  ...
  class ProjectsLocationsSpacesCatalogsTemplatesRevisionsService(base_api.BaseApiService):
    ...
    FetchAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/catalogs/{catalogsId}/templates/{templatesId}/revisions/{revisionsId}:fetchAssessmentReport',
        http_method='GET',
  ...
  class ProjectsLocationsSpacesSharedTemplatesRevisionsService(base_api.BaseApiService):
    ...
    FetchAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}/sharedTemplates/{sharedTemplatesId}/revisions/{revisionsId}:fetchAssessmentReport',
        http_method='GET',
  ...
  class ProjectsLocationsSpacesService(base_api.BaseApiService):
    ...
    GenerateAssessmentReport.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces/{spacesId}:generateAssessmentReport',
        http_method='POST',
    ...
    def RegisterAppHubApplicationResources(self, request, global_params=None):
      r"""Register deployed resources from terraform state file with App Hub without needing a space.

      Args:
        request: (DesigncenterProjectsLocationsSpacesRegisterAppHubApplicationResourcesRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
      config = self.GetMethodConfig('RegisterAppHubApplicationResources')
      return self._RunMethod(
          config, request, global_params=global_params)

    RegisterAppHubApplicationResources.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/spaces:registerAppHubApplicationResources',
        http_method='POST',
        method_id='designcenter.projects.locations.spaces.registerAppHubApplicationResources',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/spaces:registerAppHubApplicationResources',
        request_field='registerAppHubApplicationResourcesRequest',
        request_type_name='DesigncenterProjectsLocationsSpacesRegisterAppHubApplicationResourcesRequest',
        response_type_name='Operation',
        supports_download=False,
    )
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    FetchFrameworks.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}:fetchFrameworks',
        http_method='GET',
        method_id='designcenter.projects.locations.fetchFrameworks',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken', 'projects'],
        relative_path='v1/{+parent}:fetchFrameworks',
        request_field='',
