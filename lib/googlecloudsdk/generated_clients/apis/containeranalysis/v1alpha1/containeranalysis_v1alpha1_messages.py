...
class AISkillAnalysisOccurrence(_messages.Message):
  ...
  Fields:
    ...
    perScannerVerdict: Optional. Per scanner verdict.
...
class CVSS(_messages.Message):
  ...
  Enums:
    ...
    ExploitMaturityValueValuesEnum: Optional. Exploit Maturity (E). Defined in
      CVSS v4.
  ...
  Fields:
    ...
    confidentialityImpact: Optional. Confidentiality Impact (C). Defined in
      CVSS v2, v3.
    exploitMaturity: Optional. Exploit Maturity (E). Defined in CVSS v4.
  ...
  class ExploitMaturityValueValuesEnum(_messages.Enum):
    r"""Optional. Exploit Maturity (E). Defined in CVSS v4.
...
class MaliciousContentLLMResult(_messages.Message):
  ...
  Enums:
    MaxSeverityValueValuesEnum: Optional. Tracks max severity found.
    ScanStateValueValuesEnum: Output only. State of the scan.

  Fields:
    maxSeverity: Optional. Tracks max severity found.
  ...
  class MaxSeverityValueValuesEnum(_messages.Enum):
    r"""Optional. Tracks max severity found.
  ...
  class ScanStateValueValuesEnum(_messages.Enum):
    r"""Output only. State of the scan.

    Values:
      SCAN_STATE_UNSPECIFIED: Unspecified scan state.
  ...
  scanState = _messages.EnumField('ScanStateValueValuesEnum', 3)
...
class MaliciousContentStaticResult(_messages.Message):
  ...
  maxSeverity = _messages.EnumField('MaxSeverityValueValuesEnum', 1)
  scanState = _messages.EnumField('ScanStateValueValuesEnum', 2)
...
class MalwareScanResult(_messages.Message):
  ...
  Enums:
    ScanStateValueValuesEnum: Output only. State of the scan.
    VerdictValueValuesEnum: Optional. Verdict of the scan.

  Fields:
    scanState: Output only. State of the scan.
    verdict: Optional. Verdict of the scan.
  """
  ...
  class VerdictValueValuesEnum(_messages.Enum):
    r"""Optional. Verdict of the scan.
  ...
  scanState = _messages.EnumField('ScanStateValueValuesEnum', 1)
...
class Note(_messages.Message):
  ...
  attestationAuthority = _messages.MessageField('AttestationAuthority', 2)
  baseImage = _messages.MessageField('Basis', 3)
  buildType = _messages.MessageField('BuildType', 4)
  compliance = _messages.MessageField('ComplianceNote', 5)
  createTime = _messages.StringField(6)
  deployable = _messages.MessageField('Deployable', 7)
  discovery = _messages.MessageField('Discovery', 8)
  dsseAttestation = _messages.MessageField('DSSEAttestationNote', 9)
  ...
  package = _messages.MessageField('Package', 14)
  ...
  upgrade = _messages.MessageField('UpgradeNote', 24)
  vulnerabilityAssessment = _messages.MessageField('VulnerabilityAssessmentNote', 25)
  vulnerabilityType = _messages.MessageField('VulnerabilityType', 26)
...
class Occurrence(_messages.Message):
  ...
  attestation = _messages.MessageField('Attestation', 2)
  buildDetails = _messages.MessageField('BuildDetails', 3)
  compliance = _messages.MessageField('ComplianceOccurrence', 4)
  createTime = _messages.StringField(5)
  deployment = _messages.MessageField('Deployment', 6)
  derivedImage = _messages.MessageField('Derived', 7)
  discovered = _messages.MessageField('Discovered', 8)
  dsseAttestation = _messages.MessageField('DSSEAttestationOccurrence', 9)
  envelope = _messages.MessageField('Envelope', 10)
  installation = _messages.MessageField('Installation', 11)
  kind = _messages.EnumField('KindValueValuesEnum', 12)
  name = _messages.StringField(13)
  noteName = _messages.StringField(14)
  remediation = _messages.StringField(15)
  resource = _messages.MessageField('Resource', 16)
  resourceUrl = _messages.StringField(17)
  sbom = _messages.MessageField('DocumentOccurrence', 18)
  sbomReference = _messages.MessageField('SBOMReferenceOccurrence', 19)
  secret = _messages.MessageField('SecretOccurrence', 20)
  spdxFile = _messages.MessageField('FileOccurrence', 21)
  spdxPackage = _messages.MessageField('PackageInfoOccurrence', 22)
  spdxRelationship = _messages.MessageField('RelationshipOccurrence', 23)
  updateTime = _messages.StringField(24)
  upgrade = _messages.MessageField('UpgradeOccurrence', 25)
  vulnerabilityDetails = _messages.MessageField('VulnerabilityDetails', 26)
...
class PerScannerVerdict(_messages.Message):
  r"""Per scanner verdict details.

  Fields:
    maliciousContentLlmResult: Optional. Malicious Content LLM scan result.
    maliciousContentStaticResult: Optional. Malicious Content Static scan
      result.
    malwareScan: Optional. Malware scan result.
    workspacePolicy: Optional. Workspace Policy scan result.
  """
