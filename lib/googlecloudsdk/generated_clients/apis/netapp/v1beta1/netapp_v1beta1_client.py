...
class NetappV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsStoragePoolsOntapService(base_api.BaseApiService):
    ...
    ExecuteOntapDelete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['ontapPath'],
        path_params=['ontapPath'],
        query_params=[],
        relative_path='v1beta1/{+ontapPath}',
        request_field='',
    ...
    def ExecuteOntapGet(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ExecuteOntapGetResponse) The response message.
      """
      config = self.GetMethodConfig('ExecuteOntapGet')
      return self._RunMethod(
          config, request, global_params=global_params)

    ExecuteOntapGet.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/storagePools/{storagePoolsId}/ontap/{ontapId}',
        http_method='GET',
        method_id='netapp.projects.locations.storagePools.ontap.executeOntapGet',
        ordered_params=['ontapPath'],
        path_params=['ontapPath'],
        query_params=[],
        relative_path='v1beta1/{+ontapPath}',
        request_field='',
        request_type_name='NetappProjectsLocationsStoragePoolsOntapExecuteOntapGetRequest',
        response_type_name='ExecuteOntapGetResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsStoragePoolsVolumePerformanceGroupsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetappV1beta1.ProjectsLocationsStoragePoolsVolumePerformanceGroupsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/storagePools/{storagePoolsId}/volumePerformanceGroups',
        http_method='POST',
        method_id='netapp.projects.locations.storagePools.volumePerformanceGroups.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['volumePerformanceGroupId'],
        relative_path='v1beta1/{+parent}/volumePerformanceGroups',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/storagePools/{storagePoolsId}/volumePerformanceGroups/{volumePerformanceGroupsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsTrialService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetappV1beta1.ProjectsLocationsTrialService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    EndTrial.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/trial:endTrial',
        http_method='POST',
        method_id='netapp.projects.locations.trial.endTrial',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:endTrial',
    ...
    SubscribeTrial.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/trial:subscribeTrial',
        http_method='POST',
        method_id='netapp.projects.locations.trial.subscribeTrial',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1beta1/{+parent}:subscribeTrial',
  ...
  class ProjectsLocationsVolumesService(base_api.BaseApiService):
    ...
    GetSplitStatus.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/volumes/{volumesId}:getSplitStatus',
        http_method='GET',
        method_id='netapp.projects.locations.volumes.getSplitStatus',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:getSplitStatus',
        request_field='',
    ...
    StartSplit.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/volumes/{volumesId}:startSplit',
        http_method='POST',
        method_id='netapp.projects.locations.volumes.startSplit',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:startSplit',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    GetTrial.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/trial',
        http_method='GET',
