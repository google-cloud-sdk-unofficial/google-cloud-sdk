...
class NetappV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsTrialService(base_api.BaseApiService):
    ...
    End.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/trial:end',
        http_method='POST',
        method_id='netapp.projects.locations.trial.end',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:end',
    ...
    Subscribe.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/trial:subscribe',
        http_method='POST',
        method_id='netapp.projects.locations.trial.subscribe',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1beta1/{+parent}/trial:subscribe',
