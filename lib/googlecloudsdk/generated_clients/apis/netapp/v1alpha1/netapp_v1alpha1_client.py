...
class NetappV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsStoragePoolsBackupConfigsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetappV1alpha1.ProjectsLocationsStoragePoolsBackupConfigsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/storagePools/{storagePoolsId}/backupConfigs',
        http_method='GET',
        method_id='netapp.projects.locations.storagePools.backupConfigs.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/backupConfigs',
        request_field='',
  ...
  class ProjectsLocationsStoragePoolsOntapService(base_api.BaseApiService):
    ...
    ExecuteOntapDelete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path='v1alpha1/{+ontapPath}',
        request_field='',
  ...
  class ProjectsLocationsStoragePoolsService(base_api.BaseApiService):
    ...
    RestoreVolume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/storagePools/{storagePoolsId}:restoreVolume',
        http_method='POST',
        method_id='netapp.projects.locations.storagePools.restoreVolume',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:restoreVolume',
    ...
    UpdateBackupConfig.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/storagePools/{storagePoolsId}:updateBackupConfig',
        http_method='POST',
        method_id='netapp.projects.locations.storagePools.updateBackupConfig',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:updateBackupConfig',
