...
class CloudsecuritycomplianceV1(base_api.BaseApiClient):
  ...
  class OrganizationsLocationsCloudControlDeploymentsService(base_api.BaseApiService):
    ...
    def List(self, request, global_params=None):
      r"""Lists the cloud control deployments in a given parent resource.
  ...
  class ProjectsLocationsCloudControlDeploymentsService(base_api.BaseApiService):
    """Service class for the projects_locations_cloudControlDeployments resource."""

    _NAME = 'projects_locations_cloudControlDeployments'

    def __init__(self, client):
      super(CloudsecuritycomplianceV1.ProjectsLocationsCloudControlDeploymentsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsCloudControlDeploymentsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (CloudControlDeployment) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/cloudControlDeployments/{cloudControlDeploymentsId}',
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.cloudControlDeployments.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsCloudControlDeploymentsGetRequest',
        response_type_name='CloudControlDeployment',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsCloudControlDeploymentsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListCloudControlDeploymentsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/cloudControlDeployments',
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.cloudControlDeployments.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/cloudControlDeployments',
  ...
  class ProjectsLocationsFrameworkDeploymentsService(base_api.BaseApiService):
    """Service class for the projects_locations_frameworkDeployments resource."""

    _NAME = 'projects_locations_frameworkDeployments'

    def __init__(self, client):
      super(CloudsecuritycomplianceV1.ProjectsLocationsFrameworkDeploymentsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Create(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/frameworkDeployments',
        http_method='POST',
        method_id='cloudsecuritycompliance.projects.locations.frameworkDeployments.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['frameworkDeploymentId'],
        relative_path='v1/{+parent}/frameworkDeployments',
        request_field='frameworkDeployment',
        request_type_name='CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='cloudsecuritycompliance.projects.locations.frameworkDeployments.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['etag'],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (FrameworkDeployment) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/frameworkDeployments/{frameworkDeploymentsId}',
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.frameworkDeployments.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsGetRequest',
        response_type_name='FrameworkDeployment',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsFrameworkDeploymentsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListFrameworkDeploymentsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/frameworkDeployments',
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.frameworkDeployments.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/frameworkDeployments',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudsecuritycomplianceV1.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Cancel(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsOperationsCancelRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='POST',
        method_id='cloudsecuritycompliance.projects.locations.operations.cancel',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:cancel',
        request_field='cancelOperationRequest',
        request_type_name='CloudsecuritycomplianceProjectsLocationsOperationsCancelRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsOperationsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='cloudsecuritycompliance.projects.locations.operations.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsOperationsDeleteRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsOperationsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}',
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.operations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsOperationsGetRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsOperationsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListOperationsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.operations.list',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['filter', 'pageSize', 'pageToken', 'returnPartialSuccess'],
        relative_path='v1/{+name}/operations',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsOperationsListRequest',
        response_type_name='ListOperationsResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (CloudsecuritycomplianceProjectsLocationsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Location) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsGetRequest',
        response_type_name='Location',
        supports_download=False,
    )
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='GET',
        method_id='cloudsecuritycompliance.projects.locations.list',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['extraLocationTypes', 'filter', 'pageSize', 'pageToken'],
        relative_path='v1/{+name}/locations',
        request_field='',
        request_type_name='CloudsecuritycomplianceProjectsLocationsListRequest',
        response_type_name='ListLocationsResponse',
        supports_download=False,
    )
