...
class HypercomputeclusterV1beta(base_api.BaseApiClient):
  ...
  class ProjectsLocationsClustersNodesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(HypercomputeclusterV1beta.ProjectsLocationsClustersNodesService, self).__init__(client)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodes',
        http_method='GET',
        method_id='hypercomputecluster.projects.locations.clusters.nodes.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1beta/{+parent}/nodes',
        request_field='',
