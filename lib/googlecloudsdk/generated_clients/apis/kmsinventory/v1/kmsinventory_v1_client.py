...
class KmsinventoryV1(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_protectedResources = self.ProjectsProtectedResourcesService(self)
  ...
  class OrganizationsProtectedResourcesService(base_api.BaseApiService):
    ...
    def Search(self, request, global_params=None):
      r"""Returns metadata about the resources protected by the given Cloud KMS CryptoKey in the given Cloud organization/project.
  ...
  class ProjectsProtectedResourcesService(base_api.BaseApiService):
    """Service class for the projects_protectedResources resource."""

    _NAME = 'projects_protectedResources'

    def __init__(self, client):
      super(KmsinventoryV1.ProjectsProtectedResourcesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Search(self, request, global_params=None):
      ...
      Args:
        request: (KmsinventoryProjectsProtectedResourcesSearchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (SearchProtectedResourcesResponse) The response message.
      """
    ...
    Search.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/protectedResources:search',
        http_method='GET',
        method_id='kmsinventory.projects.protectedResources.search',
        ordered_params=['scope'],
        path_params=['scope'],
        query_params=['cryptoKey', 'pageSize', 'pageToken', 'resourceTypes'],
        relative_path='v1/{+scope}/protectedResources:search',
        request_field='',
        request_type_name='KmsinventoryProjectsProtectedResourcesSearchRequest',
        response_type_name='SearchProtectedResourcesResponse',
        supports_download=False,
    )
