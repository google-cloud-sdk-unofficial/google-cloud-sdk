...
class _Attribute(object):
  ...
  Attributes:
    ...
    is_regional_endpoint_flag: bool, whether the attribute is used to determine
  ...
  def __init__(self, name, param_name, help_text=None, required=False,
               ...
               is_regional_endpoint_flag=False):
    """Initializes."""
    ...
    self.is_regional_endpoint_flag = is_regional_endpoint_flag
  ...
  def __eq__(self, other):
    ...
    return (self.name == other.name and self.param_name == other.param_name
            ...
            and (self.is_regional_endpoint_flag ==
                 other.is_regional_endpoint_flag))
  ...
  def __init__(self, resource_collection, resource_name='resource',
    ...
    for i, param_name in enumerate(collection_params):
      ...
      new_attribute = Attribute(
          ...
          is_regional_endpoint_flag=attribute_config.is_regional_endpoint_flag)
...
class ResourceParameterAttributeConfig(object):
  ...
  def FromData(cls, data):
    ...
    help_text = data['help']
    is_regional_endpoint_flag = data.get('is_regional_endpoint_flag', False)
    ...
    return cls(
        name=attribute_name,
        help_text=help_text,
        is_regional_endpoint_flag=is_regional_endpoint_flag,
  ...
  def __init__(self,
    ...
    Args:
      ...
      help_text: str, generic help text for any flag based on the attribute. One
        ...
        the resource.
      is_regional_endpoint_flag: bool, whether the attribute can be used to set
